...
pushDashboard({
  ...
  contentArea: {
    intent:
      "Help every reader choose the correct business or technical documentation journey before opening detailed topic pages.",
  },
...
sourcePages.forEach((document, index) => {
  ...
  nodeRecords.push({
    ...
    relatedNodes: (document.relatedPages || []).map((relatedPage) =>
      boundedCode("nodicsDocsNodeTopic", [relatedPage]),
    ),
