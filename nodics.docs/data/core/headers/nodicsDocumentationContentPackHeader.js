...
module.exports = {
  cms: {
    ...
    nodicsDocumentationLegacyNavigationCleanupData: { options: { enabled: true, schemaName: 'cmsDocumentationNode', operation: 'remove', dataFilePrefix: 'nodicsDocumentationLegacyNavigationCleanupData' }, query: { product: 'nodicsDocumentationProduct', navigation: 'nodicsDocumentationNavigation', $or: [{ nodeLevel: { $in: ['GROUP', 'SUBGROUP'] } }, { code: 'nodicsDocsNodeTopicsolutionsTeeDeapSolutionUseCases' }] } },
