...
module.exports = { editorial: { editorialAuthoring: {
    ...
    targetDeploy: { secured: true, authTokenTypes: ['service'], accessGroups: ['userGroup'], permissionConfig: 'authSecurity.internalToken.routePermission', apiExposure: 'moduleInternal', key: '/publication/target/deploy', method: 'POST', controller: 'DefaultEditorialPublicationTargetController', operation: 'deploy', cache: { enabled: false } },
    targetStatus: { secured: true, authTokenTypes: ['service'], accessGroups: ['userGroup'], permissionConfig: 'authSecurity.internalToken.routePermission', apiExposure: 'moduleInternal', key: '/publication/target/status', method: 'POST', controller: 'DefaultEditorialPublicationTargetController', operation: 'status', cache: { enabled: false } },
    targetRollback: { secured: true, authTokenTypes: ['service'], accessGroups: ['userGroup'], permissionConfig: 'authSecurity.internalToken.routePermission', apiExposure: 'moduleInternal', key: '/publication/target/rollback', method: 'POST', controller: 'DefaultEditorialPublicationTargetController', operation: 'rollback', cache: { enabled: false } },
    targetWithdraw: { secured: true, authTokenTypes: ['service'], accessGroups: ['userGroup'], permissionConfig: 'authSecurity.internalToken.routePermission', apiExposure: 'moduleInternal', key: '/publication/target/withdraw', method: 'POST', controller: 'DefaultEditorialPublicationTargetController', operation: 'withdraw', cache: { enabled: false } }
}}};
