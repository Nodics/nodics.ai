 ...
 */
const governed = policy => ({ super: 'base', model: true, schemaPolicies: [policy], service: { enabled: true }, router: { enabled: true }, cache: { enabled: false }, event: { enabled: false }, search: { enabled: false } });
const operational = () => governed('operational');
const tenantOwned = () => governed('tenantOwned');

module.exports = { editorial: {
    editorialContentType: Object.assign(tenantOwned(), { definition: {
    ...
    editorialArticle: Object.assign(tenantOwned(), { definition: {
    ...
    editorialTaxonomyTerm: Object.assign(tenantOwned(), { definition: {
    ...
    editorialArticleTaxonomy: Object.assign(tenantOwned(), { definition: {
    ...
    editorialSeries: Object.assign(tenantOwned(), { definition: {
    ...
    editorialCorrection: Object.assign(tenantOwned(), { definition: {
    ...
    editorialOnlineArticle: Object.assign(operational(), { router: { enabled: false }, search: { enabled: true, idPropertyName: 'code' }, definition: {
    ...
    editorialPublicationReceipt: Object.assign(operational(), { router: { enabled: false }, definition: {
