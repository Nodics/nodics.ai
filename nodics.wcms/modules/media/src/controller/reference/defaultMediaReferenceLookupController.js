...
/**
 * @module nodics.wcms/media/src/controller/reference/defaultMediaReferenceLookupController
 * @description Maps secured internal media reference lookup requests to the media facade.
 * @layer controller
 * @owner media
