...
/**
 * @module nodics.wcms/media/src/service/set/defaultMediaSetEntryManagementService
 * @description Provides media-owned operations for media set entry lifecycle.
 * @layer service
 * @owner media
