...
/**
 * @module nodics.wcms/media/src/service/reference/defaultMediaReferenceLookupService
 * @description Provides a bounded media-owned reference validation contract for domain modules.
 * @layer service
 * @owner media
 * @override Later layers may extend projection details while preserving media ownership of media item and media set lifecycle.
 */
module.exports = {
    ...
    /** Loads one active media-owned reference without exposing generated CRUD authority. */
