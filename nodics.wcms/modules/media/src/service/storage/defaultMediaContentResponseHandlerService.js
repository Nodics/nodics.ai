...
/**
 * @module nodics.wcms/media/src/service/storage/defaultMediaContentResponseHandlerService
 * @description Sends media-authorized binary content inline or as a download
 * without exposing provider paths to callers.
 * @layer service
 * @owner media
 * @override Projects may customize headers or streaming behavior while
 * preserving media delivery authorization.
 */
module.exports = {
