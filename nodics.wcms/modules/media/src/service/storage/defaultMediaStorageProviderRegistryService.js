...
/**
 * @module nodics.wcms/media/src/service/storage/defaultMediaStorageProviderRegistryService
 * @description Selects and invokes the configured media storage provider.
 * @layer service
 * @owner media
