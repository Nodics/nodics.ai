...
/**
 * @module nodics.wcms/media/src/service/storage/DefaultMediaMultipartUploadBodyParserHandlerService
 * @description media-owned multipart intake handler for governed media upload
 * routes. nRouter invokes this handler through the route's configured
 * `bodyParserHandler`, but media owns the upload format, limits, validation
 ...
 * preserving media as the file/media lifecycle authority.
 */
module.exports = {
    ...
    /**
     * Returns Express middleware for media upload requests.
     *
    ...
    /**
     * Resolves media upload parser limits from media configuration.
     *
