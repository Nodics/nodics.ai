...
/**
 * @module nodics.wcms/media/src/service/storage/provider/defaultLocalMediaStorageProviderService
...
module.exports = {
     ...
     * Root ownership belongs to the media root resolver so provider services
