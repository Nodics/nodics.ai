...
/**
 * @module nodics.wcms/media/src/service/storage/defaultMediaImportSourceResolverService
 * @description Resolves backend-only media descriptors that nImport can stage as governed import sources.
 * @layer service
 * @owner media
 * @override Later storage providers may override readable-source resolution while preserving media upload and storage authority.
 */
module.exports = {
