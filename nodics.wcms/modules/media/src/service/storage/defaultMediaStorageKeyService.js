...
/**
 * @module nodics.wcms/media/src/service/storage/defaultMediaStorageKeyService
 * @description Delegates provider-relative media storage key generation to the configured media strategy.
 * @layer service
 * @owner media
