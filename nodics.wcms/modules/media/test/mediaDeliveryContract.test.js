...
/**
 * @module nodics.wcms/media/test/mediaDeliveryContract
 * @description Validates media-code based content delivery access policy.
 * @layer test
 * @owner media
 * @override Delivery extensions must preserve media-owned access validation
...
(async function () {
    ...
    console.log('media delivery contract validated');
})().catch(error => {
    console.error(error);
    process.exit(1);
});
