...
/**
 * @module nodics.wcms/media/test/mediaSchemaContract
 * @description Validates media schema ownership and required lifecycle fields.
 * @layer test
 * @owner media
...
assert(!mediaSchemas.mediaContainer, 'media must use mediaSet naming instead of copied mediaContainer terminology');
assert(!mediaSchemas.mediaContainerEntry, 'media must use mediaSetEntry naming instead of copied mediaContainerEntry terminology');
...
console.log('media schema contract validated');
