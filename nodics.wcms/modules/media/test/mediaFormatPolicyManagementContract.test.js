...
/**
 * @module nodics.wcms/media/test/mediaFormatPolicyManagementContract
 * @description Validates media-owned media format policy management and upload-policy enforcement.
 * @layer test
 * @owner media
...
(async function () {
    ...
    console.log('media format policy management contract validated');
})().catch(error => {
    console.error(error);
    process.exit(1);
});
