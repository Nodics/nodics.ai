...
/**
 * @module nodics.wcms/media/test/mediaReferenceLookupContract
 * @description Validates secured media media item and media set reference lookup boundaries.
 * @layer test
 * @owner media
...
(async () => {
    ...
    console.log('media reference lookup contract validated');
