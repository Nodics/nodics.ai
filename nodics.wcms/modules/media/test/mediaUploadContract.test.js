...
/**
 * @module nodics.wcms/media/test/MediaUploadContract
 * @description Validates media upload ownership after media has parsed multipart data.
 * @layer test
 * @owner media
...
(async function () {
    ...
    console.log('media upload contract validated');
})().catch(error => {
    console.error(error);
    process.exit(1);
});
