...
/**
 * @module nodics.wcms/media/test/mediaSchemaWorkbenchContract
 * @description Validates that media exposes safe Schema Workbench search and
...
(async function () {
    ...
    console.log('media Schema Workbench contract validated');
})().catch((error) => {
    console.error(error);
    process.exit(1);
});
