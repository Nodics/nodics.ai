...
/**
 * @module nodics.wcms/media/test/mediaFolderPolicyManagementContract
 * @description Validates media-owned media folder policy management, runtime
 ...
 * layered configuration or media-owned policy services, but must preserve
...
(async function () {
    ...
    console.log('media folder policy management contract validated');
})().catch(error => {
    console.error(error);
    process.exit(1);
});
