...
/**
 * @module nodics.wcms/media/test/MediaMultipartUploadBodyParserContract
 * @description Validates media ownership of multipart upload parsing and
 ...
 * file descriptor semantics under media-owned configuration.
 */
...
(async function () {
    ...
    console.log('media multipart upload body parser contract validated');
})().catch(error => {
    console.error(error);
    process.exit(1);
});
