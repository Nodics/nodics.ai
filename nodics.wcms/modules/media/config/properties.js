...
/**
 * @module nodics.wcms/media/config/properties
            ...
            navigation: [
                {
                    ...
                    help: { summary: 'Manage governed media files, folders, formats, sets, usage references, and delivery through media-owned lifecycle policies.', documentationRoute: '/docs/reference/media', documentationFragment: 'what-media-means-in-nodics' },
                    featureState: 'ACTIVE',
                    requiredPermissions: ['media.storage.policy.view']
                },
                {
                    ...
                    perspectives: ['operations'],
                    contexts: ['environment', 'tenant', 'enterprise'],
                    help: { summary: 'Upload, preview, search, select, and inspect media records while media owns storage, metadata, and delivery policy.', documentationRoute: '/docs/reference/media', documentationFragment: 'current-implementation-scope' },
                ...
                },
                {
                    ...
                    perspectives: ['operations'],
                    contexts: ['environment', 'tenant', 'enterprise'],
                    help: { summary: 'Review and manage purpose-based media folder policy, upload constraints, storage routing, and lifecycle boundaries.', documentationRoute: '/docs/reference/media', documentationFragment: 'storage-provider-configuration' },
                    featureState: 'PREVIEW',
                    requiredPermissions: ['media.storage.policy.view']
                },
                {
                    ...
                    perspectives: ['operations'],
                    contexts: ['environment', 'tenant', 'enterprise'],
                    help: { summary: 'Manage ordered media sets such as galleries while callers reference media-set identity instead of duplicating file metadata.', documentationRoute: '/docs/reference/media', documentationFragment: 'how-product-galleries-should-use-media-sets' },
                    featureState: 'PREVIEW',
                    requiredPermissions: ['media.storage.policy.view']
                },
                {
                    ...
                    perspectives: ['operations'],
                    contexts: ['environment', 'tenant', 'enterprise'],
                    help: { summary: 'Manage allowed media formats, MIME policy, extensions, and conversion or delivery expectations through media configuration.', documentationRoute: '/docs/reference/media', documentationFragment: 'core-schemas' },
                    featureState: 'PREVIEW',
                    requiredPermissions: ['media.storage.policy.view']
                },
                {
                    ...
                    perspectives: ['operations'],
                    contexts: ['environment', 'tenant', 'enterprise'],
                    help: { summary: 'Inspect which business records reference media items or media sets without transferring ownership away from the caller module.', documentationRoute: '/docs/reference/media', documentationFragment: 'reference-lookup-for-caller-modules' },
                    featureState: 'PREVIEW',
                    requiredPermissions: ['media.storage.policy.view']
                },
                {
                    ...
                    perspectives: ['operations'],
                    contexts: ['environment', 'tenant', 'enterprise'],
                    help: { summary: 'Review storage providers, access URLs, delivery, downloads, and private/public media behavior without exposing provider secrets or raw paths.', documentationRoute: '/docs/reference/media', documentationFragment: 'delivering-media-safely' },
                    featureState: 'PREVIEW',
                    requiredPermissions: ['media.storage.policy.view']
                }
            ]
