...
const expected = {
    ...
    "alias": "cmsdocumentationpublicationstate",
    "controller": "DefaultCmsDocumentationPublicationStateController",
    "destructive": true,
    ...
    "scenarios": [
        {
            ...
            "route": {
                "routerName": "remove",
                "key": "/cmsdocumentationpublicationstate",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationPublicationStateController",
                "operation": "remove",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "query": {
                        "code": "ntest_cmsdocumentationpublicationstate_<runId>"
                    }
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationpublicationstate/id/:id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationPublicationStateController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationpublicationstate/id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationPublicationStateController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationpublicationstate/code/:code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationPublicationStateController",
                "operation": "removeByCode",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationpublicationstate/code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationPublicationStateController",
                "operation": "removeByCode",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "codes": [
                        "ntest_cmsdocumentationpublicationstate_<runId>"
                    ]
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "request": {
                ...
                "body": {
                    "code": "ntest_cmsdocumentationpublicationstate_<runId>",
                    "active": true,
                    "description": "Generated create CRUD test fixture for cmsdocumentationpublicationstate",
                    "targetType": "PRODUCT",
        ...
        },
        {
            ...
            "route": {
                "routerName": "saveAll",
                "key": "/cmsdocumentationpublicationstate/all",
                "method": "put",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationPublicationStateController",
                "operation": "saveAll",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "model": {
                        "code": "ntest_cmsdocumentationpublicationstate_<runId>",
                        "active": true,
                        "description": "Generated updated CRUD test fixture for cmsdocumentationpublicationstate",
                        "targetType": "PRODUCT",
                        "targetCode": "ntest_targetCode_<runId>"
                    }
                }
