...
const expected = {
    ...
    "alias": "cmsdocumentationnavigation",
    "controller": "DefaultCmsDocumentationNavigationController",
    "destructive": true,
    ...
    "scenarios": [
        {
            ...
            "route": {
                "routerName": "remove",
                "key": "/cmsdocumentationnavigation",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationNavigationController",
                "operation": "remove",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "query": {
                        "code": "ntest_cmsdocumentationnavigation_<runId>"
                    }
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationnavigation/id/:id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationNavigationController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationnavigation/id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationNavigationController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationnavigation/code/:code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationNavigationController",
                "operation": "removeByCode",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationnavigation/code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationNavigationController",
                "operation": "removeByCode",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "codes": [
                        "ntest_cmsdocumentationnavigation_<runId>"
                    ]
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "request": {
                ...
                "body": {
                    "code": "ntest_cmsdocumentationnavigation_<runId>",
                    "active": true,
                    "description": "Generated create CRUD test fixture for cmsdocumentationnavigation",
                    "product": {
                        "code": "ntest_product_cmsdocumentationnavigation_<runId>",
                        "active": true,
        ...
        },
        {
            ...
            "route": {
                "routerName": "saveAll",
                "key": "/cmsdocumentationnavigation/all",
                "method": "put",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationNavigationController",
                "operation": "saveAll",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "model": {
                        "code": "ntest_cmsdocumentationnavigation_<runId>",
                        "active": true,
                        "description": "Generated updated CRUD test fixture for cmsdocumentationnavigation",
                        "product": {
                            "code": "ntest_product_cmsdocumentationnavigation_<runId>",
                            "active": true,
