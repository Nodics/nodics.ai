...
const expected = {
    ...
    "alias": "cmsdocumentationaccesspolicy",
    "controller": "DefaultCmsDocumentationAccessPolicyController",
    "destructive": true,
    ...
    "scenarios": [
        {
            ...
            "route": {
                "routerName": "remove",
                "key": "/cmsdocumentationaccesspolicy",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationAccessPolicyController",
                "operation": "remove",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "query": {
                        "code": "ntest_cmsdocumentationaccesspolicy_<runId>"
                    }
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationaccesspolicy/id/:id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationAccessPolicyController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationaccesspolicy/id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationAccessPolicyController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationaccesspolicy/code/:code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationAccessPolicyController",
                "operation": "removeByCode",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationaccesspolicy/code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationAccessPolicyController",
                "operation": "removeByCode",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "codes": [
                        "ntest_cmsdocumentationaccesspolicy_<runId>"
                    ]
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "request": {
                ...
                "body": {
                    "code": "ntest_cmsdocumentationaccesspolicy_<runId>",
                    "active": true,
                    "description": "Generated create CRUD test fixture for cmsdocumentationaccesspolicy",
        ...
        },
        {
            ...
            "route": {
                "routerName": "saveAll",
                "key": "/cmsdocumentationaccesspolicy/all",
                "method": "put",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationAccessPolicyController",
                "operation": "saveAll",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "model": {
                        "code": "ntest_cmsdocumentationaccesspolicy_<runId>",
                        "active": true,
                        "description": "Generated updated CRUD test fixture for cmsdocumentationaccesspolicy",
                        "name": "ntest_name_<runId>",
                        "targetType": "PRODUCT",
                        "targetCode": "ntest_targetCode_<runId>"
                    }
