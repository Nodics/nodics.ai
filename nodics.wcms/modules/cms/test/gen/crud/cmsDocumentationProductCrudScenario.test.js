...
const expected = {
    ...
    "alias": "cmsdocumentationproduct",
    "controller": "DefaultCmsDocumentationProductController",
    "destructive": true,
    ...
    "scenarios": [
        {
            ...
            "request": {
                ...
                "body": {
                    ...
                    "query": {
                        "code": "ntest_cmsdocumentationproduct_<runId>"
                    }
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationproduct/id/:id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationProductController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationproduct/id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationProductController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationproduct/code/:code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationProductController",
                "operation": "removeByCode",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationproduct/code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationProductController",
                "operation": "removeByCode",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "codes": [
                        "ntest_cmsdocumentationproduct_<runId>"
                    ]
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "request": {
                ...
                "body": {
                    "code": "ntest_cmsdocumentationproduct_<runId>",
                    "active": true,
                    "description": "Generated create CRUD test fixture for cmsdocumentationproduct",
                    "name": "ntest_name_<runId>",
                    "contentCatalog": {
                        "code": "ntest_contentCatalog_cmsdocumentationproduct_<runId>",
                        "active": true,
                        "description": "Generated create referenced fixture for contentCatalog"
                    },
                    "site": {
                        "code": "ntest_site_cmsdocumentationproduct_<runId>",
                        "active": true,
                        "description": "Generated create referenced fixture for site"
                    },
                    "publicRootPath": "ntest_publicRootPath_<runId>",
        ...
        },
        {
            ...
            "route": {
                "routerName": "saveAll",
                "key": "/cmsdocumentationproduct/all",
                "method": "put",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationProductController",
                "operation": "saveAll",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "model": {
                        "code": "ntest_cmsdocumentationproduct_<runId>",
                        "active": true,
                        "description": "Generated updated CRUD test fixture for cmsdocumentationproduct",
                        "name": "ntest_name_<runId>",
                        "contentCatalog": {
                            "code": "ntest_contentCatalog_cmsdocumentationproduct_<runId>",
                            "active": true,
                            "description": "Generated update referenced fixture for contentCatalog"
                        },
                        "site": {
                            "code": "ntest_site_cmsdocumentationproduct_<runId>",
                            "active": true,
                            "description": "Generated update referenced fixture for site"
                        },
                        "publicRootPath": "ntest_publicRootPath_<runId>",
                        "ownerFunctionalModule": "ntest_ownerFunctionalModule_<runId>"
                    }
