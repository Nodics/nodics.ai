...
const expected = {
    "moduleName": "cms",
    "urlPrefix": "cms",
    "schemaName": "cmsDocumentationTemplate",
    "alias": "cmsdocumentationtemplate",
    "controller": "DefaultCmsDocumentationTemplateController",
    "destructive": true,
    ...
    "scenarios": [
        {
            ...
            "request": {
                ...
                "body": {
                    ...
                    "query": {
                        "code": "ntest_cmsdocumentationtemplate_<runId>"
                    }
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationtemplate/id/:id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationTemplateController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationtemplate/id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationTemplateController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationtemplate/code/:code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationTemplateController",
                "operation": "removeByCode",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationtemplate/code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationTemplateController",
                "operation": "removeByCode",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "codes": [
                        "ntest_cmsdocumentationtemplate_<runId>"
                    ]
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "request": {
                ...
                "body": {
                    "code": "ntest_cmsdocumentationtemplate_<runId>",
                    "active": true,
                    "description": "Generated create CRUD test fixture for cmsdocumentationtemplate",
                    "name": "ntest_name_<runId>",
                    "renderer": "ntest_renderer_<runId>"
                }
            },
            "mutation": true,
            "cleanup": true
        },
        {
            ...
            "route": {
                "routerName": "saveAll",
                "key": "/cmsdocumentationtemplate/all",
                "method": "put",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationTemplateController",
                "operation": "saveAll",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "model": {
                        "code": "ntest_cmsdocumentationtemplate_<runId>",
                        "active": true,
                        "description": "Generated updated CRUD test fixture for cmsdocumentationtemplate",
                        "name": "ntest_name_<runId>",
                        "renderer": "ntest_renderer_<runId>"
                    }
                }
