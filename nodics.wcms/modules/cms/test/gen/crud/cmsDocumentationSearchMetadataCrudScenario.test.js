...
const expected = {
    ...
    "alias": "cmsdocumentationsearchmetadata",
    "controller": "DefaultCmsDocumentationSearchMetadataController",
    "destructive": true,
    ...
    "scenarios": [
        {
            ...
            "route": {
                "routerName": "remove",
                "key": "/cmsdocumentationsearchmetadata",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationSearchMetadataController",
                "operation": "remove",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "query": {
                        "code": "ntest_cmsdocumentationsearchmetadata_<runId>"
                    }
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationsearchmetadata/id/:id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationSearchMetadataController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationsearchmetadata/id",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationSearchMetadataController",
                "operation": "removeById",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationsearchmetadata/code/:code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationSearchMetadataController",
                "operation": "removeByCode",
        ...
        },
        {
            ...
            "route": {
                ...
                "key": "/cmsdocumentationsearchmetadata/code",
                "method": "delete",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationSearchMetadataController",
                "operation": "removeByCode",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "codes": [
                        "ntest_cmsdocumentationsearchmetadata_<runId>"
                    ]
                }
            },
            "mutation": true,
        ...
        },
        {
            ...
            "request": {
                ...
                "body": {
                    "code": "ntest_cmsdocumentationsearchmetadata_<runId>",
                    "active": true,
                    "description": "Generated create CRUD test fixture for cmsdocumentationsearchmetadata",
                    "product": {
                        "code": "ntest_product_cmsdocumentationsearchmetadata_<runId>",
                        "active": true,
                        "description": "Generated create referenced fixture for product"
                    },
                    "targetType": "PRODUCT",
                    "targetCode": "ntest_targetCode_<runId>",
                    "title": "ntest_title_<runId>",
                    "summary": "ntest_summary_<runId>",
                    "searchText": "ntest_searchText_<runId>"
                }
            },
            "mutation": true,
            "cleanup": true
        },
        {
            ...
            "route": {
                "routerName": "saveAll",
                "key": "/cmsdocumentationsearchmetadata/all",
                "method": "put",
                "apiVersion": "v0",
                "controller": "DefaultCmsDocumentationSearchMetadataController",
                "operation": "saveAll",
            ...
            "request": {
                ...
                "body": {
                    ...
                    "model": {
                        "code": "ntest_cmsdocumentationsearchmetadata_<runId>",
                        "active": true,
                        "description": "Generated updated CRUD test fixture for cmsdocumentationsearchmetadata",
                        "product": {
                            "code": "ntest_product_cmsdocumentationsearchmetadata_<runId>",
                            "active": true,
