...
/** @module cms/data/sample-v001/sampleCmsComponentLocalizationData @description Provides bilingual property variants for the representative localized banner sample. @layer data @owner cms */
module.exports = {
    record0: {
