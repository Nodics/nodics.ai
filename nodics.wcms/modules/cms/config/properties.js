...
module.exports = {
    backofficeCapabilities: {
        cms: {
            ...
            { id: 'content-designer', parentId: 'cms', label: 'Page Designer', route: '/content/designer', icon: 'layout', order: 202,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                help: { summary: 'Guide business users through site, page, template, slot, component, media, route, and publishing composition without bypassing WCMS ownership.', documentationRoute: '/docs/capabilities/content-publishing/wcms-authoring-model', documentationFragment: 'page-designer' },
                featureState: 'PREVIEW', requiredPermissions: ['cms.backoffice.view'] },
