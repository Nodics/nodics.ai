...
module.exports = {
    backofficeCapabilities: {
        cms: {
            ...
            { id: 'cms-sites-catalogs', parentId: 'cms', label: 'Sites & Catalogs', route: '/content#sites-catalogs', icon: 'catalog', order: 205,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                help: { summary: 'Manage the website and content catalog containers that establish WCMS authoring scope.', documentationRoute: '/docs/capabilities/content-publishing/wcms-authoring-model', documentationFragment: 'websites' },
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'cms-page-composition', parentId: 'cms', label: 'Page Composition', route: '/content#page-composition', icon: 'template', order: 220,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                help: { summary: 'Manage the type, renderer, template, and slot contracts that govern how pages and components are composed.', documentationRoute: '/docs/capabilities/content-publishing/wcms-authoring-model', documentationFragment: 'page-and-component-types' },
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'cms-content-operations', parentId: 'cms', label: 'Content Operations', route: '/content#content-operations', icon: 'content', order: 240,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                help: { summary: 'Manage authorable pages, reusable components, route/navigation records, media references, and visibility restrictions.', documentationRoute: '/docs/capabilities/content-publishing/wcms-authoring-model', documentationFragment: 'pages' },
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'sites', parentId: 'cms-sites-catalogs', label: 'Websites', route: '/content/sites', icon: 'cms', order: 206,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'content-catalogs', parentId: 'cms-sites-catalogs', label: 'Content Catalogs', route: '/content/catalogs', icon: 'cms', order: 207,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
            ...
            { id: 'type-codes', parentId: 'cms-page-composition', label: 'Page and Component Types', route: '/content/type-codes', icon: 'cms', order: 221,
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'component-type-groups', parentId: 'cms-page-composition', label: 'Component Type Groups', route: '/content/component-type-groups', icon: 'cms', order: 222,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'renderer-mappings', parentId: 'cms-page-composition', label: 'Renderer Mappings', route: '/content/renderer-mappings', icon: 'cms', order: 223,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'page-templates', parentId: 'cms-page-composition', label: 'Page Templates', route: '/content/page-templates', icon: 'cms', order: 224,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'slot-definitions', parentId: 'cms-page-composition', label: 'Slot Definitions', route: '/content/slot-definitions', icon: 'cms', order: 225,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'pages', parentId: 'cms-content-operations', label: 'Pages', route: '/content/pages', icon: 'cms', order: 241,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                workbenchTarget: { moduleName: 'cms', schemaName: 'cmsPage' },
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'components', parentId: 'cms-content-operations', label: 'Components', route: '/content/components', icon: 'cms', order: 242,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'component-media', parentId: 'cms-content-operations', label: 'Component Media', route: '/content/component-media', icon: 'cms', order: 243,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                workbenchTarget: { moduleName: 'cms', schemaName: 'cmsComponentMedia' },
                help: { summary: 'Manage references between CMS components and governed media assets owned by media.', documentationRoute: '/docs/capabilities/content-publishing/wcms-authoring-model', documentationFragment: 'component-media' },
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'routes', parentId: 'cms-content-operations', label: 'Page Routes', route: '/content/routes', icon: 'cms', order: 244,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'navigation', parentId: 'cms-content-operations', label: 'Navigation Nodes', route: '/content/navigation', icon: 'cms', order: 245,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'restriction-types', parentId: 'cms-content-operations', label: 'Restriction Types', route: '/content/restriction-types', icon: 'cms', order: 246,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
                ...
                featureState: 'ACTIVE', requiredPermissions: ['cms.backoffice.view'] },
            { id: 'restrictions', parentId: 'cms-content-operations', label: 'Restrictions', route: '/content/restrictions', icon: 'cms', order: 247,
                group: { id: 'content', label: 'Content and Experience', order: 200 },
                perspectives: ['operations', 'content'], contexts: ['environment', 'tenant', 'enterprise', 'site', 'catalog'],
