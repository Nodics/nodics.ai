    ...
    cms: {
        ...
        cmsDocumentationProduct: {
            ...
            definition: {
                ...
                accessMode: { type: 'string', required: true, default: 'PUBLIC', enum: ['PUBLIC', 'AUTHENTICATED', 'ROLE_BASED', 'GROUP_BASED', 'PERMISSION_BASED', 'RESTRICTED'], description: 'Default access boundary for the documentation product' },
        ...
        cmsDocumentationNavigation: {
            ...
            definition: {
                ...
                managedInAxis: { type: 'bool', required: true, default: true, description: 'Whether Axis may administer labels, ordering, search copy, and hierarchy metadata for this navigation tree' },
                axisAuthoringPermissions: { type: 'array', required: false, description: 'Permission codes Axis checks before allowing navigation edits' },
                workflowRequired: { type: 'bool', required: true, default: true, description: 'Whether navigation changes must enter documentation review and publication workflow' },
                workflowTriggers: { type: 'array', required: true, default: ['NAVIGATION_CHANGE'], description: 'Change categories that trigger Staged review and Online publication' },
        ...
        cmsDocumentationNode: {
            ...
            definition: {
                ...
                nodeLevel: { type: 'string', required: true, enum: ['SECTION', 'PAGE_LINK'], description: 'Two-level documentation navigation item: section container or page link', searchOptions: { enabled: true } },
                ...
                nodeContentArea: { type: 'object', required: false, description: 'Structured landing/dashboard content for section and page-link nodes' },
                ...
                managedInAxis: { type: 'bool', required: true, default: true, description: 'Whether Axis may administer this hierarchy node as backend content-catalog data' },
                axisAuthoringPermissions: { type: 'array', required: false, description: 'Permission codes Axis checks before allowing node edits' },
                workflowRequired: { type: 'bool', required: true, default: true, description: 'Whether node changes must enter documentation review and publication workflow' },
                workflowTriggers: { type: 'array', required: true, default: ['NAVIGATION_CHANGE', 'DASHBOARD_CHANGE', 'ACCESS_POLICY_CHANGE'], description: 'Change categories that trigger review because node labels, ordering, content areas, or visibility changed' },
                accessPolicy: { type: 'string', required: false, description: 'Optional documentation access policy override' },
                accessMode: { type: 'string', required: true, default: 'AUTHENTICATED', enum: ['PUBLIC', 'AUTHENTICATED', 'ROLE_BASED', 'GROUP_BASED', 'PERMISSION_BASED', 'RESTRICTED'], description: 'Node visibility boundary for Axis and Nexus rendering' },
                ...
                maturityState: { type: 'string', required: true, default: 'IMPLEMENTED', enum: ['IMPLEMENTED', 'REFERENCE', 'PLANNED', 'ROADMAP'], description: 'Truth-in-documentation maturity label' },
                searchKeywords: { type: 'array', required: false, description: 'Keywords used by current metadata search and external indexing' },
        ...
        cmsDocumentationPage: {
            ...
            definition: {
                ...
                visualRequirements: { type: 'array', required: true, default: [], description: 'Declared page-specific visual authoring requirements that generated metadata and renderers must preserve' },
                relatedPages: { type: 'array', required: false, description: 'Related documentation page document IDs' },
                managedInAxis: { type: 'bool', required: true, default: true, description: 'Whether Axis may administer page metadata, content references, visual requirements, and visibility' },
                axisAuthoringPermissions: { type: 'array', required: false, description: 'Permission codes Axis checks before allowing page edits' },
                workflowRequired: { type: 'bool', required: true, default: true, description: 'Whether page changes must enter documentation review and publication workflow' },
                workflowTriggers: { type: 'array', required: true, default: ['CONTENT_CHANGE', 'ACCESS_POLICY_CHANGE', 'SOURCE_EVIDENCE_CHANGE'], description: 'Change categories that trigger review because page content, visibility, or source evidence changed' },
                ...
                accessPolicy: { type: 'string', required: false, description: 'Optional documentation access policy override' },
                accessMode: { type: 'string', required: true, default: 'AUTHENTICATED', enum: ['PUBLIC', 'AUTHENTICATED', 'ROLE_BASED', 'GROUP_BASED', 'PERMISSION_BASED', 'RESTRICTED'], description: 'Page visibility boundary for Axis and Nexus rendering' },
                ...
                maturityState: { type: 'string', required: true, default: 'IMPLEMENTED', enum: ['IMPLEMENTED', 'REFERENCE', 'PLANNED', 'ROADMAP'], description: 'Truth-in-documentation maturity label' },
                searchMetadata: { type: 'string', required: false, description: 'Documentation search metadata record for current search and external index projection' },
        ...
        cmsDocumentationDashboard: {
            ...
            definition: {
                product: { type: 'string', required: true, description: 'Owning documentation product code', searchOptions: { enabled: true } },
                ownerType: { type: 'string', required: true, enum: ['PRODUCT', 'NAVIGATION', 'SECTION', 'PAGE_LINK'], description: 'Documentation product, navigation, section, or page-link owner for landing dashboard content' },
                ...
                cards: { type: 'array', required: false, description: 'Summary cards for child sections or pages' },
                ...
                managedInAxis: { type: 'bool', required: true, default: true, description: 'Whether Axis may administer dashboard summary, cards, and child journey links' },
                axisAuthoringPermissions: { type: 'array', required: false, description: 'Permission codes Axis checks before allowing dashboard edits' },
                workflowRequired: { type: 'bool', required: true, default: true, description: 'Whether dashboard changes must enter documentation review and publication workflow' },
                workflowTriggers: { type: 'array', required: true, default: ['DASHBOARD_CHANGE'], description: 'Change categories that trigger review because landing content or cards changed' },
                accessPolicy: { type: 'string', required: false, description: 'Optional documentation access policy override' },
                accessMode: { type: 'string', required: true, default: 'AUTHENTICATED', enum: ['PUBLIC', 'AUTHENTICATED', 'ROLE_BASED', 'GROUP_BASED', 'PERMISSION_BASED', 'RESTRICTED'], description: 'Dashboard visibility boundary' },
        ...
        cmsDocumentationAccessPolicy: {
            ...
            definition: {
                ...
                accessMode: { type: 'string', required: true, default: 'AUTHENTICATED', enum: ['PUBLIC', 'AUTHENTICATED', 'ROLE_BASED', 'GROUP_BASED', 'PERMISSION_BASED', 'RESTRICTED'], description: 'Visibility boundary applied by Axis, Nexus, and delivery services' },
                ...
                managedInAxis: { type: 'bool', required: true, default: true, description: 'Whether Axis may administer this access policy under documentation governance' },
                axisAuthoringPermissions: { type: 'array', required: false, description: 'Permission codes Axis checks before allowing access-policy edits' },
                workflowRequired: { type: 'bool', required: true, default: true, description: 'Whether visibility changes must enter documentation review and publication workflow' },
                workflowTriggers: { type: 'array', required: true, default: ['ACCESS_POLICY_CHANGE'], description: 'Change categories that trigger review because public, authenticated, role, group, or permission visibility changed' },
        ...
        cmsDocumentationPublicationState: {
            ...
            search: { enabled: false, idPropertyName: 'code' },
            definition: {
                targetType: { type: 'string', required: true, enum: ['PRODUCT', 'NAVIGATION', 'NODE', 'PAGE', 'DASHBOARD', 'ROUTE', 'TEMPLATE', 'ACCESS_POLICY', 'SEARCH_METADATA'], description: 'Documentation item kind governed by this lifecycle record', searchOptions: { enabled: true } },
                ...
                workflowRequired: { type: 'bool', required: true, default: true, description: 'Whether this target must move through the governed documentation publication workflow' },
                workflowTriggers: { type: 'array', required: true, default: ['CONTENT_CHANGE', 'NAVIGATION_CHANGE', 'DASHBOARD_CHANGE', 'ACCESS_POLICY_CHANGE'], description: 'Change categories that reopen Staged review before Online publication' },
                decisionPolicy: { type: 'object', required: false, description: 'Separation-of-duties and admin override audit policy used by review, approval, and activation' },
                actor: { type: 'string', required: false, description: 'Last actor who changed this lifecycle record' },
                author: { type: 'string', required: false, description: 'Author identity for content or metadata changes' },
                submittedBy: { type: 'string', required: false, description: 'Submitter identity for review workflow' },
                submittedAt: { type: 'string', required: false, description: 'Review submission timestamp recorded as an ISO string' },
                reviewer: { type: 'string', required: false, description: 'Reviewer identity where a separate reviewer is used' },
                reviewedAt: { type: 'string', required: false, description: 'Review timestamp recorded as an ISO string' },
                approver: { type: 'string', required: false, description: 'Approver identity for publication evidence' },
                approvedAt: { type: 'string', required: false, description: 'Approval timestamp recorded as an ISO string' },
                publisher: { type: 'string', required: false, description: 'Publisher identity for Online activation evidence' },
                publishedAt: { type: 'string', required: false, description: 'Publication timestamp recorded as an ISO string' },
                auditTrail: { type: 'array', required: false, description: 'Ordered workflow audit events for author, reviewer, approver, publisher, override, rollback, and checksum evidence' },
        ...
        cmsDocumentationSearchMetadata: {
            ...
            definition: {
                ...
                searchText: { type: 'string', required: true, description: 'Normalized searchable text for current keyword search and external index projection', searchOptions: { enabled: true } },
                keywords: { type: 'array', required: false, description: 'Keyword list for page and synonym matching' },
                ...
                managedInAxis: { type: 'bool', required: true, default: true, description: 'Whether Axis may preview this metadata before external index projection' },
                axisAuthoringPermissions: { type: 'array', required: false, description: 'Permission codes Axis checks before allowing search-metadata preview or correction' },
                workflowRequired: { type: 'bool', required: true, default: true, description: 'Whether search metadata changes must enter documentation review and publication workflow' },
                workflowTriggers: { type: 'array', required: true, default: ['SEARCH_METADATA_CHANGE'], description: 'Change categories that trigger review because searchable title, keyword, summary, or facet data changed' },
                ...
                accessMode: { type: 'string', required: true, default: 'AUTHENTICATED', enum: ['PUBLIC', 'AUTHENTICATED', 'ROLE_BASED', 'GROUP_BASED', 'PERMISSION_BASED', 'RESTRICTED'], description: 'Search visibility boundary' },
                ...
                indexState: { type: 'string', required: true, default: 'NOT_INDEXED', enum: ['NOT_INDEXED', 'INDEX_READY', 'INDEXED', 'INDEX_FAILED'], description: 'External-search projection state without making Elasticsearch the source of truth' },
