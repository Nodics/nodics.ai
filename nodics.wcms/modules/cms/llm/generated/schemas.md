...
- `mediaCode` `string` optional: Optional media-owned single media item reference
- `mediaSetCode` `string` optional: Optional media-owned media set reference for responsive, localized, or gallery assets
...
- `mediaSchema` `object` optional: Declarative CMS media-association contract; actual media lifecycle remains owned by media
