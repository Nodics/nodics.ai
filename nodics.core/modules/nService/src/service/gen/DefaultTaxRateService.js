...
/**
 * @generated
 * @module generated/service/DefaultTaxRateService
 * @description Generated service for schema `taxRate` owned by module `tax`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner tax
 * @schema taxRate
 * @model TaxRateModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TaxRateModel;
