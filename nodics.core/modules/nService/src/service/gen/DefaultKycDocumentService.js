...
/**
 * @generated
 * @module generated/service/DefaultKycDocumentService
 * @description Generated service for schema `kycDocument` owned by module `kycSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner kycSchema
 * @schema kycDocument
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KycDocumentModel;
