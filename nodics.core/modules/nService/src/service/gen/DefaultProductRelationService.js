...
/**
 * @generated
 * @module generated/service/DefaultProductRelationService
 * @description Generated service for schema `productRelation` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductRelationModel;
