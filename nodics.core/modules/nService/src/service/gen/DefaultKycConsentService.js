...
/**
 * @generated
 * @module generated/service/DefaultKycConsentService
 * @description Generated service for schema `kycConsent` owned by module `kycSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner kycSchema
 * @schema kycConsent
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KycConsentModel;
