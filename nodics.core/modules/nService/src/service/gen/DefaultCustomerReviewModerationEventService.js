...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewModerationEventService
 * @description Generated service for schema `customerReviewModerationEvent` owned by module `cres`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cres
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewModerationEventModel;
