...
/**
 * @generated
 * @module generated/service/DefaultTaxExemptionService
 * @description Generated service for schema `taxExemption` owned by module `tax`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner tax
 * @schema taxExemption
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TaxExemptionModel;
