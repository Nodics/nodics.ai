...
/**
 * @generated
 * @module generated/service/DefaultProductItemService
 * @description Generated service for schema `productItem` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
 * @schema productItem
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductItemModel;
