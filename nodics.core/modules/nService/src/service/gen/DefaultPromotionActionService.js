...
/**
 * @generated
 * @module generated/service/DefaultPromotionActionService
 * @description Generated service for schema `promotionAction` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PromotionActionModel;
