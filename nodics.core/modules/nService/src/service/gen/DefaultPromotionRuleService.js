...
/**
 * @generated
 * @module generated/service/DefaultPromotionRuleService
 * @description Generated service for schema `promotionRule` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PromotionRuleModel;
