...
/**
 * @generated
 * @module generated/service/DefaultFulfillmentConsignmentCancellationService
 * @description Generated service for schema `fulfillmentConsignmentCancellation` owned by module `fulfillment`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner fulfillment
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'fulfillment';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).FulfillmentConsignmentCancellationModel;
