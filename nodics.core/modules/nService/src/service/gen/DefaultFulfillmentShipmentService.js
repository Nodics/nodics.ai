...
/**
 * @generated
 * @module generated/service/DefaultFulfillmentShipmentService
 * @description Generated service for schema `fulfillmentShipment` owned by module `fulfillment`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner fulfillment
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).FulfillmentShipmentModel;
