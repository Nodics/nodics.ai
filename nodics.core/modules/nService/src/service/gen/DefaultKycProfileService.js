...
/**
 * @generated
 * @module generated/service/DefaultKycProfileService
 * @description Generated service for schema `kycProfile` owned by module `kycSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner kycSchema
 * @schema kycProfile
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KycProfileModel;
