...
/**
 * @generated
 * @module generated/service/DefaultOrderLifecycleRequestItemService
 * @description Generated service for schema `orderLifecycleRequestItem` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderLifecycleRequestItemModel;
