...
/**
 * @generated
 * @module generated/service/DefaultTaxQuoteService
 * @description Generated service for schema `taxQuote` owned by module `tax`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner tax
 * @schema taxQuote
 * @model TaxQuoteModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TaxQuoteModel;
