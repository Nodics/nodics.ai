...
/**
 * @generated
 * @module generated/service/DefaultInternalDataService
 * @description Generated service for schema `internalData` owned by module `dataConsumer`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner dataConsumer
 * @schema internalData
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).InternalDataModel;
