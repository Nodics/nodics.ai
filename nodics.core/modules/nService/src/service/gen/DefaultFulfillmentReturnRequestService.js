...
/**
 * @generated
 * @module generated/service/DefaultFulfillmentReturnRequestService
 * @description Generated service for schema `fulfillmentReturnRequest` owned by module `fulfillment`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner fulfillment
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).FulfillmentReturnRequestModel;
