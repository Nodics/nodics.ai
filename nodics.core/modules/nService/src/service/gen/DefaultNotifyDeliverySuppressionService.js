...
/**
 * @generated
 * @module generated/service/DefaultNotifyDeliverySuppressionService
 * @description Generated service for schema `notifyDeliverySuppression` owned by module `notifySchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner notifySchema
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).NotifyDeliverySuppressionModel;
