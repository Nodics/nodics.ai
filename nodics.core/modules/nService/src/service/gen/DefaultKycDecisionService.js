...
/**
 * @generated
 * @module generated/service/DefaultKycDecisionService
 * @description Generated service for schema `kycDecision` owned by module `kycSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner kycSchema
 * @schema kycDecision
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KycDecisionModel;
