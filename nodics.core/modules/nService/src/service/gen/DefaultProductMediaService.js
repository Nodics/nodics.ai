...
/**
 * @generated
 * @module generated/service/DefaultProductMediaService
 * @description Generated service for schema `productMedia` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
 * @schema productMedia
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductMediaModel;
