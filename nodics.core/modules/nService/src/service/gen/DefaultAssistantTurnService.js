...
/**
 * @generated
 * @module generated/service/DefaultAssistantTurnService
 * @description Generated service for schema `assistantTurn` owned by module `aiAssistant`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner aiAssistant
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).AssistantTurnModel;
