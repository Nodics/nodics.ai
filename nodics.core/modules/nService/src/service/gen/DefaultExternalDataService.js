...
/**
 * @generated
 * @module generated/service/DefaultExternalDataService
 * @description Generated service for schema `externalData` owned by module `dataConsumer`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner dataConsumer
 * @schema externalData
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'dataConsumer';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ExternalDataModel;
