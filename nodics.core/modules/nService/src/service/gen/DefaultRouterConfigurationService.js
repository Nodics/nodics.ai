...
/**
 * @generated
 * @module generated/service/DefaultRouterConfigurationService
 * @description Generated service for schema `routerConfiguration` owned by module `dynamo`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner dynamo
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'dynamo';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).RouterConfigurationModel;
