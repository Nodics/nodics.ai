...
/**
 * @generated
 * @module generated/service/DefaultInventoryPromiseService
 * @description Generated service for schema `inventoryPromise` owned by module `inventory`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner inventory
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).InventoryPromiseModel;
