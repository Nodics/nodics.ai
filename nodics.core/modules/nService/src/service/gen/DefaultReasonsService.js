...
/**
 * @generated
 * @module generated/service/DefaultReasonsService
 * @description Generated service for schema `reasons` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
 * @schema reasons
 * @model ReasonsModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ReasonsModel;
