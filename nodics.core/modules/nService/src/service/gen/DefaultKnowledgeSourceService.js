...
/**
 * @generated
 * @module generated/service/DefaultKnowledgeSourceService
 * @description Generated service for schema `knowledgeSource` owned by module `aiKnowledge`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner aiKnowledge
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KnowledgeSourceModel;
