...
/**
 * @generated
 * @module generated/service/DefaultPromotionConditionService
 * @description Generated service for schema `promotionCondition` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PromotionConditionModel;
