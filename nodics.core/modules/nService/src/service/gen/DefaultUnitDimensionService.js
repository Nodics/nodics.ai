...
/**
 * @generated
 * @module generated/service/DefaultUnitDimensionService
 * @description Generated service for schema `unitDimension` owned by module `units`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner units
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).UnitDimensionModel;
