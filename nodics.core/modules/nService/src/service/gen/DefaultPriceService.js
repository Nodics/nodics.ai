...
/**
 * @generated
 * @module generated/service/DefaultPriceService
 * @description Generated service for schema `price` owned by module `pricing`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner pricing
 * @schema price
 * @model PriceModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PriceModel;
