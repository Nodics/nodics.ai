...
/**
 * @generated
 * @module generated/service/DefaultProductOnlinePointerService
 * @description Generated service for schema `productOnlinePointer` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductOnlinePointerModel;
