...
/**
 * @generated
 * @module generated/service/DefaultStockSourcingRuleService
 * @description Generated service for schema `stockSourcingRule` owned by module `inventory`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner inventory
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).StockSourcingRuleModel;
