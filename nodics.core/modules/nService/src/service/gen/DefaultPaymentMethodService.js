...
/**
 * @generated
 * @module generated/service/DefaultPaymentMethodService
 * @description Generated service for schema `paymentMethod` owned by module `payment`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner payment
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PaymentMethodModel;
