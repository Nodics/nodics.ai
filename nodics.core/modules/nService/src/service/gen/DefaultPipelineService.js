...
/**
 * @generated
 * @module generated/service/DefaultPipelineService
 * @description Generated service for schema `pipeline` owned by module `dynamo`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner dynamo
 * @schema pipeline
 * @model PipelineModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PipelineModel;
