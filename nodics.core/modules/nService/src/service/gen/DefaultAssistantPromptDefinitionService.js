...
/**
 * @generated
 * @module generated/service/DefaultAssistantPromptDefinitionService
 * @description Generated service for schema `assistantPromptDefinition` owned by module `aiAssistant`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner aiAssistant
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'aiAssistant';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).AssistantPromptDefinitionModel;
