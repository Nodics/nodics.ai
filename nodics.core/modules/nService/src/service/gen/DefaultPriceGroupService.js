...
/**
 * @generated
 * @module generated/service/DefaultPriceGroupService
 * @description Generated service for schema `priceGroup` owned by module `pricing`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner pricing
 * @schema priceGroup
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PriceGroupModel;
