...
/**
 * @generated
 * @module generated/service/DefaultPriceListService
 * @description Generated service for schema `priceList` owned by module `pricing`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner pricing
 * @schema priceList
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PriceListModel;
