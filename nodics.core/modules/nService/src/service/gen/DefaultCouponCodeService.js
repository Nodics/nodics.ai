...
/**
 * @generated
 * @module generated/service/DefaultCouponCodeService
 * @description Generated service for schema `couponCode` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
 * @schema couponCode
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CouponCodeModel;
