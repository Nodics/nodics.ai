...
/**
 * @generated
 * @module generated/service/DefaultAiTokenBudgetService
 * @description Generated service for schema `aiTokenBudget` owned by module `aiProviders`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner aiProviders
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).AiTokenBudgetModel;
