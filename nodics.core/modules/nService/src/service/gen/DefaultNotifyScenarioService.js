...
/**
 * @generated
 * @module generated/service/DefaultNotifyScenarioService
 * @description Generated service for schema `notifyScenario` owned by module `notifySchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner notifySchema
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).NotifyScenarioModel;
