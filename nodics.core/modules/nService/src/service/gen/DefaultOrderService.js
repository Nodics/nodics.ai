...
/**
 * @generated
 * @module generated/service/DefaultOrderService
 * @description Generated service for schema `order` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
 * @schema order
 * @model OrderModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderModel;
