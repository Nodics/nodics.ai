...
/**
 * @generated
 * @module generated/service/DefaultCartPaymentGroupService
 * @description Generated service for schema `cartPaymentGroup` owned by module `cart`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cart
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CartPaymentGroupModel;
