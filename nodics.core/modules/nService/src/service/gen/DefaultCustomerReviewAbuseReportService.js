 ...
 * @description Generated service for schema `customerReviewAbuseReport` owned by module `cres`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cres
