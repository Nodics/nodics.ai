...
/**
 * @generated
 * @module generated/service/DefaultTaxJurisdictionService
 * @description Generated service for schema `taxJurisdiction` owned by module `tax`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner tax
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TaxJurisdictionModel;
