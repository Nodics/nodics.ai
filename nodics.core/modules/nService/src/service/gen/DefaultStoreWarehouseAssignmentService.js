...
/**
 * @generated
 * @module generated/service/DefaultStoreWarehouseAssignmentService
 * @description Generated service for schema `storeWarehouseAssignment` owned by module `store`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner store
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).StoreWarehouseAssignmentModel;
