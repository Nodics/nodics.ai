...
/**
 * @generated
 * @module generated/service/DefaultCouponCampaignService
 * @description Generated service for schema `couponCampaign` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CouponCampaignModel;
