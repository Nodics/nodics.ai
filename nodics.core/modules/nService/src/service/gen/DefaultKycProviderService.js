...
/**
 * @generated
 * @module generated/service/DefaultKycProviderService
 * @description Generated service for schema `kycProvider` owned by module `kycSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner kycSchema
 * @schema kycProvider
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KycProviderModel;
