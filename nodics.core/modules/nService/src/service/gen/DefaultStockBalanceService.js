...
/**
 * @generated
 * @module generated/service/DefaultStockBalanceService
 * @description Generated service for schema `stockBalance` owned by module `inventory`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner inventory
 * @schema stockBalance
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).StockBalanceModel;
