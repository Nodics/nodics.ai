...
/**
 * @generated
 * @module generated/service/DefaultConfigurationActivationRequestService
 * @description Generated service for schema `configurationActivationRequest` owned by module `dynamo`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner dynamo
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ConfigurationActivationRequestModel;
