...
/**
 * @generated
 * @module generated/service/DefaultTaxProviderService
 * @description Generated service for schema `taxProvider` owned by module `tax`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner tax
 * @schema taxProvider
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TaxProviderModel;
