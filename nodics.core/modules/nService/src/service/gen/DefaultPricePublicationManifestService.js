...
/**
 * @generated
 * @module generated/service/DefaultPricePublicationManifestService
 * @description Generated service for schema `pricePublicationManifest` owned by module `pricing`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner pricing
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PricePublicationManifestModel;
