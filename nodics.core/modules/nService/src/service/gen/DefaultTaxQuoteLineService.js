...
/**
 * @generated
 * @module generated/service/DefaultTaxQuoteLineService
 * @description Generated service for schema `taxQuoteLine` owned by module `tax`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner tax
 * @schema taxQuoteLine
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TaxQuoteLineModel;
