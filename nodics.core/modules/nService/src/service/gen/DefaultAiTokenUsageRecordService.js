...
/**
 * @generated
 * @module generated/service/DefaultAiTokenUsageRecordService
 * @description Generated service for schema `aiTokenUsageRecord` owned by module `aiProviders`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner aiProviders
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'aiProviders';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).AiTokenUsageRecordModel;
