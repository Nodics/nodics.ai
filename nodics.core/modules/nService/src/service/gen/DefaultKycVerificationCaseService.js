...
/**
 * @generated
 * @module generated/service/DefaultKycVerificationCaseService
 * @description Generated service for schema `kycVerificationCase` owned by module `kycSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner kycSchema
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KycVerificationCaseModel;
