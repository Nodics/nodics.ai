...
/**
 * @generated
 * @module generated/service/DefaultWorkflowItemService
 * @description Generated service for schema `workflowItem` owned by module `workflow`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner workflow
 * @schema workflowItem
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).WorkflowItemModel;
