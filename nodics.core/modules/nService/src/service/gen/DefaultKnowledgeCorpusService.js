...
/**
 * @generated
 * @module generated/service/DefaultKnowledgeCorpusService
 * @description Generated service for schema `knowledgeCorpus` owned by module `aiKnowledge`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner aiKnowledge
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'aiKnowledge';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KnowledgeCorpusModel;
