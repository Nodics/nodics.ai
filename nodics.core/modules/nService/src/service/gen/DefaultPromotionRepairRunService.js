...
/**
 * @generated
 * @module generated/service/DefaultPromotionRepairRunService
 * @description Generated service for schema `promotionRepairRun` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PromotionRepairRunModel;
