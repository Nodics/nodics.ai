...
/**
 * @generated
 * @module generated/service/DefaultAppliedPromotionService
 * @description Generated service for schema `appliedPromotion` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).AppliedPromotionModel;
