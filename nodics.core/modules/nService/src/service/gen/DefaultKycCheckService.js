...
/**
 * @generated
 * @module generated/service/DefaultKycCheckService
 * @description Generated service for schema `kycCheck` owned by module `kycSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner kycSchema
 * @schema kycCheck
 * @model KycCheckModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KycCheckModel;
