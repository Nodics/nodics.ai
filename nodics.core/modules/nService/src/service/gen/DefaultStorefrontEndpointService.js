...
/**
 * @generated
 * @module generated/service/DefaultStorefrontEndpointService
 * @description Generated service for schema `storefrontEndpoint` owned by module `storefront`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner storefront
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'storefront';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).StorefrontEndpointModel;
