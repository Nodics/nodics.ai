...
/**
 * @generated
 * @module generated/service/DefaultEventService
 * @description Generated service for schema `event` owned by module `nems`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner nems
 * @schema event
 * @model EventModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EventModel;
