...
/**
 * @generated
 * @module generated/service/DefaultDeliveryChargeQuoteService
 * @description Generated service for schema `deliveryChargeQuote` owned by module `pricing`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner pricing
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DeliveryChargeQuoteModel;
