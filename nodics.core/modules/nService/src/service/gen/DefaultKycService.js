...
/**
 * @generated
 * @module generated/service/DefaultKycService
 * @description Generated service for schema `kyc` owned by module `kycSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner kycSchema
 * @schema kyc
 * @model KycModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KycModel;
