...
/**
 * @generated
 * @module generated/service/DefaultOrderEntryService
 * @description Generated service for schema `orderEntry` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
 * @schema orderEntry
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderEntryModel;
