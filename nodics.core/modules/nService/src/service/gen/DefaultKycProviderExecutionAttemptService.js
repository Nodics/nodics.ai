...
/**
 * @generated
 * @module generated/service/DefaultKycProviderExecutionAttemptService
 * @description Generated service for schema `kycProviderExecutionAttempt` owned by module `kycSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner kycSchema
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KycProviderExecutionAttemptModel;
