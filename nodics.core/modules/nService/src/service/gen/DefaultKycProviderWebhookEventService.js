...
/**
 * @generated
 * @module generated/service/DefaultKycProviderWebhookEventService
 * @description Generated service for schema `kycProviderWebhookEvent` owned by module `kycSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner kycSchema
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'kycSchema';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).KycProviderWebhookEventModel;
