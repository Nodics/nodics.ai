...
/**
 * @generated
 * @module generated/service/DefaultAssistantDefinitionService
 * @description Generated service for schema `assistantDefinition` owned by module `aiAssistant`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner aiAssistant
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).AssistantDefinitionModel;
