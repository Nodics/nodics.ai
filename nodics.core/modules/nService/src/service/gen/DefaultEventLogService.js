...
/**
 * @generated
 * @module generated/service/DefaultEventLogService
 * @description Generated service for schema `eventLog` owned by module `nems`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner nems
 * @schema eventLog
 * @model EventLogModel
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'nems';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EventLogModel;
