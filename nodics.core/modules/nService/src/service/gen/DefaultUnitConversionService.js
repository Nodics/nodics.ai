...
/**
 * @generated
 * @module generated/service/DefaultUnitConversionService
 * @description Generated service for schema `unitConversion` owned by module `units`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner units
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'units';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).UnitConversionModel;
