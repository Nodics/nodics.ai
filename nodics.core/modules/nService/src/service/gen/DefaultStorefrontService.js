...
/**
 * @generated
 * @module generated/service/DefaultStorefrontService
 * @description Generated service for schema `storefront` owned by module `storefront`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner storefront
 * @schema storefront
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).StorefrontModel;
