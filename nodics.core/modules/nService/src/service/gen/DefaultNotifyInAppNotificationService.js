...
/**
 * @generated
 * @module generated/service/DefaultNotifyInAppNotificationService
 * @description Generated service for schema `notifyInAppNotification` owned by module `notifySchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner notifySchema
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).NotifyInAppNotificationModel;
