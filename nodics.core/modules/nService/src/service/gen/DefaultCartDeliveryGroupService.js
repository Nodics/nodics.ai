...
/**
 * @generated
 * @module generated/service/DefaultCartDeliveryGroupService
 * @description Generated service for schema `cartDeliveryGroup` owned by module `cart`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cart
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CartDeliveryGroupModel;
