...
/**
 * @generated
 * @module generated/service/DefaultWorkflowActionService
 * @description Generated service for schema `workflowAction` owned by module `workflow`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner workflow
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).WorkflowActionModel;
