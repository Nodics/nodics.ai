...
/**
 * @generated
 * @module generated/service/DefaultOrderstatusService
 * @description Generated service for schema `orderstatus` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
 * @schema orderstatus
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderstatusModel;
