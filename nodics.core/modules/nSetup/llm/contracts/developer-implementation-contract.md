...
- relevant `modules/nSetup/llm/contracts`, especially
...
- class-level and function-level comments/JSDoc in the affected capability and
  direct dependencies;
- relevant online/offline the documentation project material when available.
...
If the available documentation, comments, generated context, or the documentation project
...
platform rules belong under `modules/nSetup/llm`.
