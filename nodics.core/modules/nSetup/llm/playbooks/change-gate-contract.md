...
2. relevant module `llm/contracts`, `llm/examples`, and generated context
   studied;
3. relevant `modules/nSetup/llm/contracts` and available the documentation project material studied;
...
3. Apply the change-impact matrix in `standards/artifact-definition-and-change-guide.md`.
...
- Load `playbooks/daily-change-checklist.md` for normal work; load this full contract only at a gate.
