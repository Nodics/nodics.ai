...
6. **Study:** Which root-to-leaf README/AGENTS chain, module LLM guidance,
   ...
   and relevant nodics.docs documentation project material were studied?
...
- properties, schemas, routers, services, or generated functionality:
  `standards/artifact-definition-and-change-guide.md`
- test selection: `playbooks/testing-playbook.md`
...
- commit, merge/release, or periodic audit: `playbooks/change-gate-contract.md`
