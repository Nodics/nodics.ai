...
This folder contains examples that help AI agents and developers work correctly inside the `nodics.core/modules/nData/nImport/csvImport` module boundary.
