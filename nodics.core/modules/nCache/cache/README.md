...
For user-facing cache concepts, configuration examples, invalidation rules, diagnostics, and troubleshooting, read [How Cache Works](https://github.com/Nodics/nodics.docs). This module README is the implementation contract for the shared cache capability.
