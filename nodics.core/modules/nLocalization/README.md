...
Phase 1 deliberately supports only trusted in-process policy fallback. Runtime bundles fail closed until an authority provider is active. Applications customize the provider through `localization.client.providerService`; they do not fork this module.
