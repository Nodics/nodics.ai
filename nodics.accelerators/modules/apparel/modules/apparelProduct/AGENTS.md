...
Extend the `product` schema namespace and Product services rather than creating
a parallel commercial product identity. Keep reusable Apparel defaults here;
keep customer product, price, inventory, content, and renderer-mapping records
in the customer project's Apparel catalogs.
