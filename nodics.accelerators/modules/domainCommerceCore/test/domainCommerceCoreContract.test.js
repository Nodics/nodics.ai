...
'use strict';
const assert = require('node:assert/strict'); const test = require('node:test'); const policy = require('../src/service/defaultDomainCommerceCorePolicyService');
...
test('tenant correlation and idempotency context are mandatory', () => { assert.throws(() => policy.compose({ entries: [] }), /DOMAIN_COMMERCE_CONTEXT_REQUIRED/); });
