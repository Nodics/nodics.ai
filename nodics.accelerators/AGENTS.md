...
Keep this root composition-only. Do not place shared accelerator business
logic here and do not create `acceleratorCore` without evidence from at least
three concrete domains that identical stable behavior has no better standard
