...
- Require active target-scoped consent and approved version evidence before creating a public projection.
- Consent withdrawal and emergency hide must synchronously remove active projections; reconciliation is a repair net, not the primary safety action.
