...
module.exports = { contactSubmission: {
    contactRequest: Object.assign(internal('customerOwned'), { definition: {
    ...
    contactCorrespondence: Object.assign(internal('customerOwned'), { definition: {
    ...
    contactAttempt: Object.assign(internal('operational'), { definition: {
    ...
    contactResolution: Object.assign(internal('operational'), { definition: {
    ...
    contactHandoff: Object.assign(internal('operational'), { definition: {
    ...
    contactVerification: Object.assign(internal('operational'), { definition: {
