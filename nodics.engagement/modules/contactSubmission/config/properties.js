...
module.exports = {
    ...
    localResetProvider: {
        "contributions": {
            "contactSubmission": {
                "serviceNames": {
                    "DefaultContactAttemptService": true,
                    "DefaultContactCorrespondenceService": true,
                    "DefaultContactHandoffService": true,
                    "DefaultContactRequestService": true,
                    "DefaultContactResolutionService": true,
                    "DefaultContactVerificationService": true
                }
            }
        }
    },
