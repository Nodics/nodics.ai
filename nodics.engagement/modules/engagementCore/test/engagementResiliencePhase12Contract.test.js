...
assert.strictEqual(service.compatibility({ tenant: 't1', contractType: 'API', contractCode: 'reviews', version: '0.0.0', evidence: {}, correlationId: 'c1' }, policy).compatibility, 'CURRENT');
