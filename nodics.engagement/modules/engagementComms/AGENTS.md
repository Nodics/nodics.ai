...
- Treat this package as scaffolded until its implementation phase is approved.
- Do not copy archived CRES or gNotify implementation into this package.
- Do not add `src/` or `data/` until exact ownership, security, tenancy, lifecycle, migration, and tests are approved.
