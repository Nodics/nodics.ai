...
module.exports = {
    ...
    /** Delegates SSE delivery. */ streamTurn: request => SERVICE.DefaultCopilotSseService.open(request),
    ...
    /** Delegates confirmed product execution. */ executeProductPlan: function (request) { return this.execute('executeProductPlan', request); },
