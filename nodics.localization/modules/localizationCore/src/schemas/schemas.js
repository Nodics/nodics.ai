...
module.exports = { localizationCore: {
    localizationKey: { super: 'base', model: true, isVersionedEnabled: false, service: { enabled: true }, router: { groups: { schemaOperations: true }, enabled: true }, definition: {
    ...
    localizationValue: { super: 'base', model: true, isVersionedEnabled: false, service: { enabled: true }, router: { groups: { schemaOperations: true }, enabled: true }, definition: {
    ...
    localizationRelease: { super: 'base', model: true, isVersionedEnabled: false, service: { enabled: true }, router: { groups: { schemaOperations: true }, enabled: true }, definition: {
    ...
    localizationOnlinePointer: { super: 'base', model: true, isVersionedEnabled: false, service: { enabled: true }, router: { groups: { schemaOperations: true }, enabled: true }, definition: {
