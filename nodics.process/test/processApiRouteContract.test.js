...
[
    ...
    ['retryInstance', 'POST', '/instances/:instanceCode/retry', 'process.instance.retry'],
    ['compensateInstance', 'POST', '/instances/:instanceCode/compensate', 'process.instance.compensate'],
    ['listIncidents', 'GET', '/incidents', 'process.incident.read'],
    ['getIncident', 'GET', '/incidents/:incidentCode', 'process.incident.read'],
