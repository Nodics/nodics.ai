...
/** @module flowCore/service/DefaultFlowCoreBackofficeCapabilityService @description Publishes the concrete flowCore-owned BackOffice capability projection. @layer service @owner flowCore */
const capability = {
    "enabled": true,
...
module.exports = {
    ...
    init: function () {
        SERVICE.DefaultModuleRegistrationAgentService.registerBackofficeCapabilityProvider('flowCore', this);
