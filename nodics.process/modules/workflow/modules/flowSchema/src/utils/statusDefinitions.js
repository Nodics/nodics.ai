...
module.exports = {
    ...
    ERR_PROCESS_00006: { code: '409', message: 'Published process definitions can only be archived' },
    ERR_PROCESS_00007: { code: '400', message: 'Process designer request is invalid' }
};
