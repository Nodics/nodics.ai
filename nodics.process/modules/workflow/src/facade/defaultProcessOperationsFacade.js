...
module.exports = {
    ...
    listInstances: function (request) {
        return SERVICE.DefaultProcessOperationsInspectionService.listInstances(request);
    },
    ...
    getInstanceDetail: function (request) {
        return SERVICE.DefaultProcessRuntimeLifecycleService.getInstanceDetail(request);
    },
    /** Delegates runtime instance cancellation. */
    cancelInstance: function (request) {
        return SERVICE.DefaultProcessRuntimeLifecycleService.cancelInstance(request);
    },
    ...
    compensateInstance: function (request) {
        return SERVICE.DefaultProcessRuntimeLifecycleService.compensateInstance(request);
    },
    /** Delegates recovery incident listing. */
    listIncidents: function (request) {
        return SERVICE.DefaultProcessOperationsInspectionService.listIncidents(request);
    },
    /** Delegates recovery incident read. */
    getIncident: function (request) {
        return SERVICE.DefaultProcessOperationsInspectionService.getIncident(request);
    },
    ...
    archiveTrigger: function (request) {
        return SERVICE.DefaultProcessRuntimeLifecycleService.archiveTrigger(request);
    },
    /** Delegates active trigger execution into Process-owned runtime start. */
    executeTrigger: function (request) {
        return SERVICE.DefaultProcessRuntimeLifecycleService.executeTrigger(request);
    },
    /** Delegates audit event listing. */
    listAuditEvents: function (request) {
        return SERVICE.DefaultProcessOperationsInspectionService.listAuditEvents(request);
    },
};
