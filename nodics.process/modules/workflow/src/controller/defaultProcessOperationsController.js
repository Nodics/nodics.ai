...
/**
 * @module nodics.process/modules/workflow/src/controller/defaultProcessOperationsController
...
module.exports = {
    ...
    /** Claims one current remote action for its scoped target runtime. */
    claimRemoteAction: function (request, callback) {
        return this.invoke('claimRemoteAction', request, callback);
    },
    /** Lists governed runtime instances. */
    listInstances: function (request, callback) {
        return this.invoke('listInstances', request, callback);
    },
    /** Starts a published process instance. */
    startInstance: function (request, callback) {
        return this.invoke('startInstance', request, callback);
    },
    ...
    getInstanceDetail: function (request, callback) {
        return this.invoke('getInstanceDetail', request, callback);
    },
    /** Cancels a governed runtime instance. */
    cancelInstance: function (request, callback) {
        return this.invoke('cancelInstance', request, callback);
    },
    /** Retries a failed instance ACTION under its incident policy. */
    retryInstance: function (request, callback) {
        return this.invoke('retryInstance', request, callback);
    },
    ...
    getIncident: function (request, callback) {
        return this.invoke('getIncident', request, callback);
    },
    /** Lists governed human tasks. */
    listTasks: function (request, callback) {
        return this.invoke('listTasks', request, callback);
    },
    /** Reads one governed human task. */
    getTask: function (request, callback) {
        return this.invoke('getTask', request, callback);
    },
    /** Claims a governed human task. */
    claimTask: function (request, callback) {
        return this.invoke('claimTask', request, callback);
    },
    /** Assigns a governed human task. */
    assignTask: function (request, callback) {
        return this.invoke('assignTask', request, callback);
    },
    /** Completes a governed human task and advances the instance. */
    completeTask: function (request, callback) {
        return this.invoke('completeTask', request, callback);
    },
    ...
    createTrigger: function (request, callback) {
        return this.invoke('createTrigger', request, callback);
    },
    /** Updates Process-owned scheduled trigger metadata. */
    updateTrigger: function (request, callback) {
        return this.invoke('updateTrigger', request, callback);
    },
    /** Archives Process-owned scheduled trigger metadata. */
    archiveTrigger: function (request, callback) {
        return this.invoke('archiveTrigger', request, callback);
    },
    ...
    listAuditEvents: function (request, callback) {
        return this.invoke('listAuditEvents', request, callback);
    },
};
