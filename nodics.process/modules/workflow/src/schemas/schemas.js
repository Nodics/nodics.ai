    ...
    workflow: {
        ...
        processTrigger: {
            ...
            definition: {
                ...
                cronJobCode: { type: 'string', required: false, description: 'Optional nodics.process job code consumed as schedule metadata' },
                ...
                schedule: { type: 'object', required: false, description: 'Browser-safe schedule summary; authoritative cron execution stays in nodics.process' },
