...
/** @module wasteCore/data/core-v001/records/backoffice/wasteCoreBackofficeCapabilityData @description Waste Axis capability and navigation metadata linked through active module registration. @layer data @owner wasteCore */
module.exports = {
    capability: {
    ...
    defaults: {
        ...
        group: { id: 'sustainability-operations', label: 'Sustainability Operations', order: 1400 },
    ...
    navigation: [{
        ...
        presentation: { defaultColumns: ['code', 'ownerModule', 'lifecycleType', 'status', 'revision'] }
    }, {
        id: 'waste-taxonomy',
        ...
        presentation: { defaultColumns: ['code', 'familyCode', 'name', 'status', 'revision'] }
    }, {
        id: 'waste-families',
        ...
        presentation: { defaultColumns: ['code', 'name', 'status', 'sortOrder', 'revision'] }
    }, {
        id: 'waste-categories',
        parentId: 'waste-taxonomy',
        label: 'Categories',
        ...
        presentation: { defaultColumns: ['code', 'familyCode', 'evidencePolicyCode', 'impactProfileCode', 'status', 'revision'] }
    }, {
        id: 'waste-materials',
        parentId: 'waste-taxonomy',
        ...
        presentation: { defaultColumns: ['code', 'familyCode', 'unitOfMeasure', 'hazardClass', 'status', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'ownerModule', 'categoryCode', 'itemTypeCode', 'status', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'collectionPointType', 'receiptPolicyCode', 'status', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'name', 'collectionPointType', 'locationRef', 'operatorEnterpriseRef', 'operatingStatus', 'publicVisibility', 'status'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'collectionPointCode', 'collectionPointType', 'familyCode', 'categoryCode', 'status', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'submissionChannel', 'categoryCode', 'submissionStatus', 'statusUpdatedAt', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'submissionCode', 'verificationStatus', 'verifiedCategoryCode', 'verifiedAt', 'revision'] }
    }, {
        id: 'waste-receipts',
        parentId: 'waste-management',
        parentModuleName: 'wasteCore',
        ...
        presentation: { defaultColumns: ['code', 'submissionCode', 'collectionPointCode', 'receiptStatus', 'receivedAt', 'revision'] }
    }, {
        id: 'waste-impact',
        parentId: 'waste-management',
        parentModuleName: 'wasteCore',
        ...
        presentation: { defaultColumns: ['code', 'formulaType', 'categoryCode', 'status', 'revision'] }
    }, {
        id: 'waste-assets',
        parentId: 'waste-management',
        parentModuleName: 'wasteCore',
        ...
        presentation: { defaultColumns: ['code', 'assetTypeCode', 'ownerRef', 'assetStatus', 'custodyStatus', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'familyCode', 'categoryCode', 'status', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'assetTypeCode', 'sourceStatusRequired', 'requiresEvidence', 'initialAssetStatus', 'status'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'assetCode', 'transferType', 'transferStatus', 'occurredAt', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'assetCode', 'projectionStatus', 'listingMode', 'visibilityMode', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'transferType', 'ownershipTransferMode', 'rewardTransferMode', 'carbonTransferMode', 'status'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'listingMode', 'visibilityMode', 'productProjectionMode', 'status', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'triggerType', 'settlementMode', 'walletCurrencyCode', 'status', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'triggerType', 'settlementMode', 'carbonUnitCode', 'status', 'revision'] }
    }, {
        ...
        presentation: { defaultColumns: ['code', 'rewardDebitMode', 'carbonReceiverMode', 'entitlementMode', 'status', 'revision'] }
    }, {
        id: 'waste-movement',
        parentId: 'waste-management',
        parentModuleName: 'wasteCore',
        ...
        presentation: { defaultColumns: ['code', 'movementType', 'batchCode', 'movementStatus', 'revision'] }
    }, {
        id: 'waste-compliance',
        parentId: 'waste-management',
        parentModuleName: 'wasteCore',
        ...
        presentation: { defaultColumns: ['code', 'complianceProfileCode', 'decision', 'recordedAt', 'revision'] }
    }]
};
