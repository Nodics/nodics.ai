...
assert.strictEqual(routers.getEffectiveMapConfiguration.permission, 'system.schema.workbench.view');
...
assert.strictEqual(routers.getMapConfiguration.permission, 'system.schema.workbench.view');
...
assert.strictEqual(routers.saveMapConfiguration.permission, 'system.schema.workbench.manage');
...
assert.strictEqual(routers.reverseGeocode.permission, 'system.schema.workbench.view');
...
assert.deepStrictEqual(capability.requiredPermissions, ['system.schema.workbench.view']);
