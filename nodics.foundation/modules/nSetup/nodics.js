...
/*
    ...
    nSetup is intentionally module-shaped for repository consistency, but it is
    excluded from runtime module loading by package metadata.
 */

/**
 * @module modules/nSetup/nodics
 * @description Registers the nSetup module lifecycle hooks and module-level startup behavior.
 * @layer module
 * @owner nSetup
