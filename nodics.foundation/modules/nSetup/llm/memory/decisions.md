...
The LLM enablement pack includes `modules/nSetup/llm/prompts/enterprise-architecture-quality-prompt.md` for significant Nodics design, implementation, security, documentation, generated artifact, and testing work.
...
instead of editing Nodics foundation or overriding the full policy service for every
