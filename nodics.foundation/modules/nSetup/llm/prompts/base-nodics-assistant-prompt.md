...
- Treat the Change Acceptance Contract in modules/nSetup/llm/contracts/nodics-principles.md as mandatory for every modified or new source file.
...
- modules/nSetup/llm/prompts/enterprise-architecture-quality-prompt.md
```
