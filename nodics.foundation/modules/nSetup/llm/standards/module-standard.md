...
- generated module context for every package except `nSetup`
...
package keeps `README.md` as its concise local human entry point, while an
explicit documentation owner authors detailed permanent guidance in its
canonical documentation content pack. The root
...
- canonical documentation identifiers or routes from the module README and
  links from canonical the documentation project capability journeys to the owning module.
