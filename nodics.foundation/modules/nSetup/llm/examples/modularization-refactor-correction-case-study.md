...
2. **Where does it belong?**
   ...
   - `nodics.foundation/modules/nSetup/llm/contracts` for permanent AI/developer
     rules;
   - `nodics.foundation/modules/nSetup/llm/standards` for concrete structure,
     coding, generation, and lifecycle standards;
   - `nodics.foundation/modules/nSetup/llm/playbooks` for repeatable work
     procedures;
   - `nodics.foundation/modules/nSetup/llm/examples` for recommended implementation
