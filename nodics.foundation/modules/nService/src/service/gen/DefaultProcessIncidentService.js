...
/**
 * @generated
 * @module generated/service/DefaultProcessIncidentService
 * @description Generated service for schema `processIncident` owned by module `workflow`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner workflow
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProcessIncidentModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProcessIncidentModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'processIncident';
        request.generatedServiceName = 'DefaultProcessIncidentService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ProcessIncidentModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ProcessIncidentModel');
