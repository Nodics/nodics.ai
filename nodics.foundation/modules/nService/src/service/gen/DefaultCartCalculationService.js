...
/**
 * @generated
 * @module generated/service/DefaultCartCalculationService
 * @description Generated service for schema `cartCalculation` owned by module `cart`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cart
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'cart';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CartCalculationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CartCalculationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cartCalculation';
        request.generatedServiceName = 'DefaultCartCalculationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CartCalculationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CartCalculationModel');
