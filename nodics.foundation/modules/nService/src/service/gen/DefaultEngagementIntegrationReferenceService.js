...
/**
 * @generated
 * @module generated/service/DefaultEngagementIntegrationReferenceService
 * @description Generated service for schema `engagementIntegrationReference` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementIntegrationReferenceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementIntegrationReferenceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementIntegrationReference';
        request.generatedServiceName = 'DefaultEngagementIntegrationReferenceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementIntegrationReferenceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementIntegrationReferenceModel');
