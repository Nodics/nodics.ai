...
/**
 * @generated
 * @module generated/service/DefaultBackofficeFunctionalModuleRegistrationService
 * @description Generated service for schema `backofficeFunctionalModuleRegistration` owned by module `backoffice`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner backoffice
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'backoffice';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).BackofficeFunctionalModuleRegistrationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).BackofficeFunctionalModuleRegistrationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'backofficeFunctionalModuleRegistration';
        request.generatedServiceName = 'DefaultBackofficeFunctionalModuleRegistrationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.BackofficeFunctionalModuleRegistrationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.BackofficeFunctionalModuleRegistrationModel');
