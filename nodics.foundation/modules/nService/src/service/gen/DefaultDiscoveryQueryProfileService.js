...
/**
 * @generated
 * @module generated/service/DefaultDiscoveryQueryProfileService
 * @description Generated service for schema `discoveryQueryProfile` owned by module `discoveryConfig`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DiscoveryQueryProfileModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscoveryQueryProfileModel');
