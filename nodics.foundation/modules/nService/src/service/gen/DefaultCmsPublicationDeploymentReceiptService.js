...
/**
 * @generated
 * @module generated/service/DefaultCmsPublicationDeploymentReceiptService
 * @description Generated service for schema `cmsPublicationDeploymentReceipt` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'cms';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPublicationDeploymentReceiptModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPublicationDeploymentReceiptModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsPublicationDeploymentReceipt';
        request.generatedServiceName = 'DefaultCmsPublicationDeploymentReceiptService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsPublicationDeploymentReceiptModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsPublicationDeploymentReceiptModel');
