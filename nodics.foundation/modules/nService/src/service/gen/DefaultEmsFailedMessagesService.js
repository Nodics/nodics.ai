...
/**
 * @generated
 * @module generated/service/DefaultEmsFailedMessagesService
 * @description Generated service for schema `emsFailedMessages` owned by module `emsClient`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner emsClient
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'emsClient';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EmsFailedMessagesModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EmsFailedMessagesModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'emsFailedMessages';
        request.generatedServiceName = 'DefaultEmsFailedMessagesService';
