...
/**
 * @generated
 * @module generated/service/DefaultFulfillmentExceptionService
 * @description Generated service for schema `fulfillmentException` owned by module `fulfillmentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'fulfillmentCore';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).FulfillmentExceptionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).FulfillmentExceptionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'fulfillmentException';
        request.generatedServiceName = 'DefaultFulfillmentExceptionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.FulfillmentExceptionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.FulfillmentExceptionModel');
