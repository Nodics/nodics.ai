...
/**
 * @generated
 * @module generated/service/DefaultDiscountDecisionService
 * @description Generated service for schema `discountDecision` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'promotion';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscountDecisionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscountDecisionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'discountDecision';
        request.generatedServiceName = 'DefaultDiscountDecisionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DiscountDecisionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscountDecisionModel');
