...
/**
 * @generated
 * @module generated/service/DefaultCmsComponentLocalizationService
 * @description Generated service for schema `cmsComponentLocalization` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsComponentLocalizationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsComponentLocalizationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsComponentLocalization';
        request.generatedServiceName = 'DefaultCmsComponentLocalizationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsComponentLocalizationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsComponentLocalizationModel');
