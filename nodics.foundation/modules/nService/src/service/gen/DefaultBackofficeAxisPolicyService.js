...
/**
 * @generated
 * @module generated/service/DefaultBackofficeAxisPolicyService
 * @description Generated service for schema `backofficeAxisPolicy` owned by module `backoffice`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner backoffice
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).BackofficeAxisPolicyModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).BackofficeAxisPolicyModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'backofficeAxisPolicy';
        request.generatedServiceName = 'DefaultBackofficeAxisPolicyService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.BackofficeAxisPolicyModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.BackofficeAxisPolicyModel');
