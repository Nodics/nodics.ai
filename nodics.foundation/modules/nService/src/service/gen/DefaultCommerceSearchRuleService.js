...
/**
 * @generated
 * @module generated/service/DefaultCommerceSearchRuleService
 * @description Generated service for schema `commerceSearchRule` owned by module `commerceSearchCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceSearchRuleModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceSearchRuleModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commerceSearchRule';
        request.generatedServiceName = 'DefaultCommerceSearchRuleService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommerceSearchRuleModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommerceSearchRuleModel');
