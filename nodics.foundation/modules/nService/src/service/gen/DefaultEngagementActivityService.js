...
/**
 * @generated
 * @module generated/service/DefaultEngagementActivityService
 * @description Generated service for schema `engagementActivity` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementActivityModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementActivityModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementActivity';
        request.generatedServiceName = 'DefaultEngagementActivityService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementActivityModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementActivityModel');
