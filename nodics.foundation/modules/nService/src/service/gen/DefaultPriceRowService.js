...
/**
 * @generated
 * @module generated/service/DefaultPriceRowService
 * @description Generated service for schema `priceRow` owned by module `pricing`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner pricing
 * @schema priceRow
 * @model PriceRowModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PriceRowModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PriceRowModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'priceRow';
        request.generatedServiceName = 'DefaultPriceRowService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PriceRowModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PriceRowModel');
