...
/**
 * @generated
 * @module generated/service/DefaultCmsSiteService
 * @description Generated service for schema `cmsSite` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
 * @schema cmsSite
 * @model CmsSiteModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsSiteModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsSiteModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsSite';
        request.generatedServiceName = 'DefaultCmsSiteService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsSiteModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsSiteModel');
