...
/**
 * @generated
 * @module generated/service/DefaultDiscoveryDocumentProjectionService
 * @description Generated service for schema `discoveryDocumentProjection` owned by module `discoveryProjection`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryDocumentProjectionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryDocumentProjectionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'discoveryDocumentProjection';
        request.generatedServiceName = 'DefaultDiscoveryDocumentProjectionService';
    ...
    remove: function (request) {
        ...
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscoveryDocumentProjectionModel');
