...
/**
 * @generated
 * @module generated/service/DefaultIndexerLogService
 * @description Generated service for schema `indexerLog` owned by module `search`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner search
 * @schema indexerLog
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'search';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).IndexerLogModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).IndexerLogModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'indexerLog';
        request.generatedServiceName = 'DefaultIndexerLogService';
