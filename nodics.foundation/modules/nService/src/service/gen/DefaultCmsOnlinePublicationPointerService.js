...
/**
 * @generated
 * @module generated/service/DefaultCmsOnlinePublicationPointerService
 * @description Generated service for schema `cmsOnlinePublicationPointer` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsOnlinePublicationPointerModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsOnlinePublicationPointerModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsOnlinePublicationPointer';
        request.generatedServiceName = 'DefaultCmsOnlinePublicationPointerService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsOnlinePublicationPointerModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsOnlinePublicationPointerModel');
