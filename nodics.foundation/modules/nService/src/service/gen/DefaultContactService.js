...
/**
 * @generated
 * @module generated/service/DefaultContactService
 * @description Generated service for schema `contact` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
 * @schema contact
 * @model ContactModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'contact';
        request.generatedServiceName = 'DefaultContactService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ContactModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ContactModel');
