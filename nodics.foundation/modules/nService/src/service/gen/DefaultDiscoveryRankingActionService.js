...
/**
 * @generated
 * @module generated/service/DefaultDiscoveryRankingActionService
 * @description Generated service for schema `discoveryRankingAction` owned by module `discoveryRanking`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'discoveryRanking';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryRankingActionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryRankingActionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'discoveryRankingAction';
        request.generatedServiceName = 'DefaultDiscoveryRankingActionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DiscoveryRankingActionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscoveryRankingActionModel');
