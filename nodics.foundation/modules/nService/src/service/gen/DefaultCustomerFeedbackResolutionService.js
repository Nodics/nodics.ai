...
/**
 * @generated
 * @module generated/service/DefaultCustomerFeedbackResolutionService
 * @description Generated service for schema `customerFeedbackResolution` owned by module `customerFeedback`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackResolutionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackResolutionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerFeedbackResolution';
        request.generatedServiceName = 'DefaultCustomerFeedbackResolutionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerFeedbackResolutionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerFeedbackResolutionModel');
