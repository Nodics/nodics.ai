...
/**
 * @generated
 * @module generated/service/DefaultTokenService
 * @description Generated service for schema `token` owned by module `token`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner token
 * @schema token
 * @model TokenModel
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'token';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TokenModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TokenModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'token';
        request.generatedServiceName = 'DefaultTokenService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.TokenModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.TokenModel');
