...
/**
 * @generated
 * @module generated/service/DefaultReturnInspectionService
 * @description Generated service for schema `returnInspection` owned by module `fulfillmentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ReturnInspectionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ReturnInspectionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'returnInspection';
        request.generatedServiceName = 'DefaultReturnInspectionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ReturnInspectionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ReturnInspectionModel');
