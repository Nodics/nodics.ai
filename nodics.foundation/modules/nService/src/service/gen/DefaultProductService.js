...
/**
 * @generated
 * @module generated/service/DefaultProductService
 * @description Generated service for schema `product` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
 * @schema product
 * @model ProductModel
...
module.exports = {
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'product';
        request.generatedServiceName = 'DefaultProductService';
