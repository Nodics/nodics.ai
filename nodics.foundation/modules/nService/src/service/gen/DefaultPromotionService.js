...
/**
 * @generated
 * @module generated/service/DefaultPromotionService
 * @description Generated service for schema `promotion` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
 * @schema promotion
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PromotionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PromotionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'promotion';
        request.generatedServiceName = 'DefaultPromotionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PromotionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PromotionModel');
