...
/**
 * @generated
 * @module generated/service/DefaultContactAttemptService
 * @description Generated service for schema `contactAttempt` owned by module `contactSubmission`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactAttemptModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactAttemptModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'contactAttempt';
        request.generatedServiceName = 'DefaultContactAttemptService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ContactAttemptModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ContactAttemptModel');
