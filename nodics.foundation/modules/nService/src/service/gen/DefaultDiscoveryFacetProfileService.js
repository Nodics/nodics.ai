...
/**
 * @generated
 * @module generated/service/DefaultDiscoveryFacetProfileService
 * @description Generated service for schema `discoveryFacetProfile` owned by module `discoveryConfig`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryFacetProfileModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryFacetProfileModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'discoveryFacetProfile';
        request.generatedServiceName = 'DefaultDiscoveryFacetProfileService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DiscoveryFacetProfileModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscoveryFacetProfileModel');
