...
/**
 * @generated
 * @module generated/service/DefaultSalesChannelService
 * @description Generated service for schema `salesChannel` owned by module `store`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner store
 * @schema salesChannel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).SalesChannelModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).SalesChannelModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'salesChannel';
        request.generatedServiceName = 'DefaultSalesChannelService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.SalesChannelModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.SalesChannelModel');
