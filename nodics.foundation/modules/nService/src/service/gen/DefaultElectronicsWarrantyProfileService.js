...
/**
 * @generated
 * @module generated/service/DefaultElectronicsWarrantyProfileService
 * @description Generated service for schema `electronicsWarrantyProfile` owned by module `electronicsProduct`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'electronicsProduct';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ElectronicsWarrantyProfileModel;
