...
/**
 * @generated
 * @module generated/service/DefaultEditorialSeriesService
 * @description Generated service for schema `editorialSeries` owned by module `editorial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner editorial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialSeriesModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialSeriesModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'editorialSeries';
        request.generatedServiceName = 'DefaultEditorialSeriesService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EditorialSeriesModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EditorialSeriesModel');
