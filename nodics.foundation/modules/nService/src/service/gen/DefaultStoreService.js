...
/**
 * @generated
 * @module generated/service/DefaultStoreService
 * @description Generated service for schema `store` owned by module `store`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner store
 * @schema store
 * @model StoreModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).StoreModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).StoreModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'store';
        request.generatedServiceName = 'DefaultStoreService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.StoreModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.StoreModel');
