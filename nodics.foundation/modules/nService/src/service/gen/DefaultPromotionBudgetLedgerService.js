...
/**
 * @generated
 * @module generated/service/DefaultPromotionBudgetLedgerService
 * @description Generated service for schema `promotionBudgetLedger` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PromotionBudgetLedgerModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PromotionBudgetLedgerModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'promotionBudgetLedger';
        request.generatedServiceName = 'DefaultPromotionBudgetLedgerService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PromotionBudgetLedgerModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PromotionBudgetLedgerModel');
