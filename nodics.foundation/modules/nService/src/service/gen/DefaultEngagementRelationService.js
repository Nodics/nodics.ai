...
/**
 * @generated
 * @module generated/service/DefaultEngagementRelationService
 * @description Generated service for schema `engagementRelation` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementRelationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementRelationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementRelation';
        request.generatedServiceName = 'DefaultEngagementRelationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementRelationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementRelationModel');
