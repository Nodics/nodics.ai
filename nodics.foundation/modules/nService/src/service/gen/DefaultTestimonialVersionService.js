...
/**
 * @generated
 * @module generated/service/DefaultTestimonialVersionService
 * @description Generated service for schema `testimonialVersion` owned by module `testimonial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner testimonial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TestimonialVersionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TestimonialVersionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'testimonialVersion';
        request.generatedServiceName = 'DefaultTestimonialVersionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.TestimonialVersionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.TestimonialVersionModel');
