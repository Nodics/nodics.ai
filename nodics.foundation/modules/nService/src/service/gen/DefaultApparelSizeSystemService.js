...
/**
 * @generated
 * @module generated/service/DefaultApparelSizeSystemService
 * @description Generated service for schema `apparelSizeSystem` owned by module `apparelProduct`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ApparelSizeSystemModel;
