...
/**
 * @generated
 * @module generated/service/DefaultEngagementFormVersionService
 * @description Generated service for schema `engagementFormVersion` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementFormVersionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementFormVersionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementFormVersion';
        request.generatedServiceName = 'DefaultEngagementFormVersionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementFormVersionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementFormVersionModel');
