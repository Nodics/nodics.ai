...
/**
 * @generated
 * @module generated/service/DefaultPublicationAuditService
 * @description Generated service for schema `publicationAudit` owned by module `publish`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner publish
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'publish';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PublicationAuditModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PublicationAuditModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'publicationAudit';
        request.generatedServiceName = 'DefaultPublicationAuditService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PublicationAuditModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PublicationAuditModel');
