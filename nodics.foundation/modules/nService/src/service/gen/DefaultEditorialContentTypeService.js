...
/**
 * @generated
 * @module generated/service/DefaultEditorialContentTypeService
 * @description Generated service for schema `editorialContentType` owned by module `editorial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner editorial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialContentTypeModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialContentTypeModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'editorialContentType';
        request.generatedServiceName = 'DefaultEditorialContentTypeService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EditorialContentTypeModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EditorialContentTypeModel');
