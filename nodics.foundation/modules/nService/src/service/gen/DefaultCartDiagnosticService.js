...
/**
 * @generated
 * @module generated/service/DefaultCartDiagnosticService
 * @description Generated service for schema `cartDiagnostic` owned by module `cart`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cart
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CartDiagnosticModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CartDiagnosticModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cartDiagnostic';
        request.generatedServiceName = 'DefaultCartDiagnosticService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CartDiagnosticModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CartDiagnosticModel');
