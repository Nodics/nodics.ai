...
/**
 * @generated
 * @module generated/service/DefaultEngagementConsentService
 * @description Generated service for schema `engagementConsent` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementConsentModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementConsentModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementConsent';
        request.generatedServiceName = 'DefaultEngagementConsentService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementConsentModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementConsentModel');
