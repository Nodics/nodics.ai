...
/**
 * @generated
 * @module generated/service/DefaultCatalogService
 * @description Generated service for schema `catalog` owned by module `catalog`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner catalog
 * @schema catalog
 * @model CatalogModel
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'catalog';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CatalogModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CatalogModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'catalog';
        request.generatedServiceName = 'DefaultCatalogService';
