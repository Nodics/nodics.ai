...
/**
 * @generated
 * @module generated/service/DefaultPaymentTransactionEntryService
 * @description Generated service for schema `paymentTransactionEntry` owned by module `paymentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner paymentCore
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PaymentTransactionEntryModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PaymentTransactionEntryModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'paymentTransactionEntry';
        request.generatedServiceName = 'DefaultPaymentTransactionEntryService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PaymentTransactionEntryModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PaymentTransactionEntryModel');
