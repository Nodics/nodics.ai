...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewMigrationService
 * @description Generated service for schema `customerReviewMigration` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewMigrationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewMigrationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewMigration';
        request.generatedServiceName = 'DefaultCustomerReviewMigrationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewMigrationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewMigrationModel');
