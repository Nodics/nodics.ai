...
/**
 * @generated
 * @module generated/service/DefaultEditorialArticleService
 * @description Generated service for schema `editorialArticle` owned by module `editorial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner editorial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialArticleModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialArticleModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'editorialArticle';
        request.generatedServiceName = 'DefaultEditorialArticleService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EditorialArticleModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EditorialArticleModel');
