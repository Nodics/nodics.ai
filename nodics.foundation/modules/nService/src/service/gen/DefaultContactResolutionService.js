...
/**
 * @generated
 * @module generated/service/DefaultContactResolutionService
 * @description Generated service for schema `contactResolution` owned by module `contactSubmission`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'contactSubmission';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactResolutionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactResolutionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'contactResolution';
        request.generatedServiceName = 'DefaultContactResolutionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ContactResolutionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ContactResolutionModel');
