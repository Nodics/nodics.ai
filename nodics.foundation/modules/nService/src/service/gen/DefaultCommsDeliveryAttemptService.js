...
/**
 * @generated
 * @module generated/service/DefaultCommsDeliveryAttemptService
 * @description Generated service for schema `commsDeliveryAttempt` owned by module `commsSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner commsSchema
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsDeliveryAttemptModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsDeliveryAttemptModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commsDeliveryAttempt';
        request.generatedServiceName = 'DefaultCommsDeliveryAttemptService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommsDeliveryAttemptModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommsDeliveryAttemptModel');
