...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewAggregateService
 * @description Generated service for schema `customerReviewAggregate` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewAggregateModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewAggregateModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewAggregate';
        request.generatedServiceName = 'DefaultCustomerReviewAggregateService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewAggregateModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewAggregateModel');
