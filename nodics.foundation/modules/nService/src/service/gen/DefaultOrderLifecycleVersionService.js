...
/**
 * @generated
 * @module generated/service/DefaultOrderLifecycleVersionService
 * @description Generated service for schema `orderLifecycleVersion` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderLifecycleVersionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderLifecycleVersionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'orderLifecycleVersion';
        request.generatedServiceName = 'DefaultOrderLifecycleVersionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.OrderLifecycleVersionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.OrderLifecycleVersionModel');
