...
/**
 * @generated
 * @module generated/service/DefaultCommerceOrderEntryService
 * @description Generated service for schema `commerceOrderEntry` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceOrderEntryModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceOrderEntryModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commerceOrderEntry';
        request.generatedServiceName = 'DefaultCommerceOrderEntryService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommerceOrderEntryModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommerceOrderEntryModel');
