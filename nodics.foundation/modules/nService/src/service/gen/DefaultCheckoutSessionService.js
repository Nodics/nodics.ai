...
/**
 * @generated
 * @module generated/service/DefaultCheckoutSessionService
 * @description Generated service for schema `checkoutSession` owned by module `checkoutCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner checkoutCore
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CheckoutSessionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CheckoutSessionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'checkoutSession';
        request.generatedServiceName = 'DefaultCheckoutSessionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CheckoutSessionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CheckoutSessionModel');
