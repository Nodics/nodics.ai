...
/**
 * @generated
 * @module generated/service/DefaultCommsTemplateVersionService
 * @description Generated service for schema `commsTemplateVersion` owned by module `commsSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner commsSchema
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsTemplateVersionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsTemplateVersionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commsTemplateVersion';
        request.generatedServiceName = 'DefaultCommsTemplateVersionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommsTemplateVersionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommsTemplateVersionModel');
