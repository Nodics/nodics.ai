...
/**
 * @generated
 * @module generated/service/DefaultProcessAuditEventService
 * @description Generated service for schema `processAuditEvent` owned by module `workflow`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner workflow
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProcessAuditEventModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProcessAuditEventModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'processAuditEvent';
        request.generatedServiceName = 'DefaultProcessAuditEventService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ProcessAuditEventModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ProcessAuditEventModel');
