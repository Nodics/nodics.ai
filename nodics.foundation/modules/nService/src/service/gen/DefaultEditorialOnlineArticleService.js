...
/**
 * @generated
 * @module generated/service/DefaultEditorialOnlineArticleService
 * @description Generated service for schema `editorialOnlineArticle` owned by module `editorial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner editorial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialOnlineArticleModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialOnlineArticleModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'editorialOnlineArticle';
        request.generatedServiceName = 'DefaultEditorialOnlineArticleService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EditorialOnlineArticleModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EditorialOnlineArticleModel');
