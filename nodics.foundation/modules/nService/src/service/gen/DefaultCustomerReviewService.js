...
module.exports = {
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReview';
        request.generatedServiceName = 'DefaultCustomerReviewService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewModel');
