...
/**
 * @generated
 * @module generated/service/DefaultEngagementPrivacyCaseService
 * @description Generated service for schema `engagementPrivacyCase` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementPrivacyCaseModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementPrivacyCaseModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementPrivacyCase';
        request.generatedServiceName = 'DefaultEngagementPrivacyCaseService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementPrivacyCaseModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementPrivacyCaseModel');
