...
/**
 * @generated
 * @module generated/service/DefaultCommerceRecoveryCheckpointService
 * @description Generated service for schema `commerceRecoveryCheckpoint` owned by module `checkoutCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner checkoutCore
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceRecoveryCheckpointModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceRecoveryCheckpointModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commerceRecoveryCheckpoint';
        request.generatedServiceName = 'DefaultCommerceRecoveryCheckpointService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommerceRecoveryCheckpointModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommerceRecoveryCheckpointModel');
