...
/**
 * @generated
 * @module generated/service/DefaultProcessTriggerService
 * @description Generated service for schema `processTrigger` owned by module `workflow`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner workflow
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProcessTriggerModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProcessTriggerModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'processTrigger';
        request.generatedServiceName = 'DefaultProcessTriggerService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ProcessTriggerModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ProcessTriggerModel');
