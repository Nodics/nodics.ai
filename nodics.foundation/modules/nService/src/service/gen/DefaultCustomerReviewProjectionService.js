...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewProjectionService
 * @description Generated service for schema `customerReviewProjection` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewProjectionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewProjectionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewProjection';
        request.generatedServiceName = 'DefaultCustomerReviewProjectionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewProjectionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewProjectionModel');
