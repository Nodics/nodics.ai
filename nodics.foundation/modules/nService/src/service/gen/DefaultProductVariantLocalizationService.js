...
/**
 * @generated
 * @module generated/service/DefaultProductVariantLocalizationService
 * @description Generated service for schema `productVariantLocalization` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductVariantLocalizationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductVariantLocalizationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'productVariantLocalization';
        request.generatedServiceName = 'DefaultProductVariantLocalizationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ProductVariantLocalizationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ProductVariantLocalizationModel');
