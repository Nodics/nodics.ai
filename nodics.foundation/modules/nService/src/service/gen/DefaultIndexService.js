...
/**
 * @generated
 * @module generated/service/DefaultIndexService
 * @description Generated service for schema `index` owned by module `search`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner search
 * @schema index
 * @model IndexModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).IndexModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).IndexModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'index';
        request.generatedServiceName = 'DefaultIndexService';
