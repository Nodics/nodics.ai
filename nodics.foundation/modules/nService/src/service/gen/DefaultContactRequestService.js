...
/**
 * @generated
 * @module generated/service/DefaultContactRequestService
 * @description Generated service for schema `contactRequest` owned by module `contactSubmission`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactRequestModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactRequestModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'contactRequest';
        request.generatedServiceName = 'DefaultContactRequestService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ContactRequestModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ContactRequestModel');
