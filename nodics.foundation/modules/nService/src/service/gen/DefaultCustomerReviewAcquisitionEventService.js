...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewAcquisitionEventService
 * @description Generated service for schema `customerReviewAcquisitionEvent` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewAcquisitionEventModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewAcquisitionEventModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewAcquisitionEvent';
        request.generatedServiceName = 'DefaultCustomerReviewAcquisitionEventService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewAcquisitionEventModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewAcquisitionEventModel');
