...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewAppealService
 * @description Generated service for schema `customerReviewAppeal` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewAppealModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewAppealModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewAppeal';
        request.generatedServiceName = 'DefaultCustomerReviewAppealService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewAppealModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewAppealModel');
