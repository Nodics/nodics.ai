...
/**
 * @generated
 * @module generated/service/DefaultCartService
 * @description Generated service for schema `cart` owned by module `cart`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cart
 * @schema cart
 * @model CartModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CartModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CartModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cart';
        request.generatedServiceName = 'DefaultCartService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CartModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CartModel');
