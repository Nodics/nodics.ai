...
/**
 * @generated
 * @module generated/service/DefaultDiscoverySourceProviderService
 * @description Generated service for schema `discoverySourceProvider` owned by module `discoverySource`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'discoverySource';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoverySourceProviderModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoverySourceProviderModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'discoverySourceProvider';
        request.generatedServiceName = 'DefaultDiscoverySourceProviderService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DiscoverySourceProviderModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscoverySourceProviderModel');
