...
/**
 * @generated
 * @module generated/service/DefaultCmsSlotDefinitionService
 * @description Generated service for schema `cmsSlotDefinition` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsSlotDefinitionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsSlotDefinitionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsSlotDefinition';
        request.generatedServiceName = 'DefaultCmsSlotDefinitionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsSlotDefinitionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsSlotDefinitionModel');
