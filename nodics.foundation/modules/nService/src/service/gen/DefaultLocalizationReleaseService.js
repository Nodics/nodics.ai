...
/**
 * @generated
 * @module generated/service/DefaultLocalizationReleaseService
 * @description Generated service for schema `localizationRelease` owned by module `localizationCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).LocalizationReleaseModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).LocalizationReleaseModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'localizationRelease';
        request.generatedServiceName = 'DefaultLocalizationReleaseService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.LocalizationReleaseModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.LocalizationReleaseModel');
