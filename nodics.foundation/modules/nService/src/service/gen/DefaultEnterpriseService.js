...
/**
 * @generated
 * @module generated/service/DefaultEnterpriseService
 * @description Generated service for schema `enterprise` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
 * @schema enterprise
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EnterpriseModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EnterpriseModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'enterprise';
        request.generatedServiceName = 'DefaultEnterpriseService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EnterpriseModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EnterpriseModel');
