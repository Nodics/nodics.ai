...
/**
 * @generated
 * @module generated/service/DefaultCronJobService
 * @description Generated service for schema `cronJob` owned by module `cronjob`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cronjob
 * @schema cronJob
 * @model CronJobModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CronJobModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CronJobModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cronJob';
        request.generatedServiceName = 'DefaultCronJobService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CronJobModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CronJobModel');
