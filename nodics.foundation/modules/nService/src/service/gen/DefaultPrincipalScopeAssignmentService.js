...
/**
 * @generated
 * @module generated/service/DefaultPrincipalScopeAssignmentService
 * @description Generated service for schema `principalScopeAssignment` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'profile';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PrincipalScopeAssignmentModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PrincipalScopeAssignmentModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'principalScopeAssignment';
        request.generatedServiceName = 'DefaultPrincipalScopeAssignmentService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PrincipalScopeAssignmentModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PrincipalScopeAssignmentModel');
