...
/**
 * @generated
 * @module generated/service/DefaultSearchService
 * @description Generated service for schema `search` owned by module `search`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner search
 * @schema search
 * @model SearchModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).SearchModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).SearchModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'search';
        request.generatedServiceName = 'DefaultSearchService';
