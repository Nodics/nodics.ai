...
/**
 * @generated
 * @module generated/service/DefaultCouponService
 * @description Generated service for schema `coupon` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
 * @schema coupon
 * @model CouponModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CouponModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CouponModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'coupon';
        request.generatedServiceName = 'DefaultCouponService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CouponModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CouponModel');
