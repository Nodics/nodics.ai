...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewVersionService
 * @description Generated service for schema `customerReviewVersion` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewVersionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewVersionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewVersion';
        request.generatedServiceName = 'DefaultCustomerReviewVersionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewVersionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewVersionModel');
