...
/**
 * @generated
 * @module generated/service/DefaultCmsComponentTypeGroupService
 * @description Generated service for schema `cmsComponentTypeGroup` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsComponentTypeGroupModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsComponentTypeGroupModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsComponentTypeGroup';
        request.generatedServiceName = 'DefaultCmsComponentTypeGroupService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsComponentTypeGroupModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsComponentTypeGroupModel');
