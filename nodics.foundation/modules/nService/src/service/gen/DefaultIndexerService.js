...
/**
 * @generated
 * @module generated/service/DefaultIndexerService
 * @description Generated service for schema `indexer` owned by module `search`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner search
 * @schema indexer
 * @model IndexerModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).IndexerModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).IndexerModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'indexer';
        request.generatedServiceName = 'DefaultIndexerService';
