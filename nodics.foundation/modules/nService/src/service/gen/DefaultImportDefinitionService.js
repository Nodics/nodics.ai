...
/**
 * @generated
 * @module generated/service/DefaultImportDefinitionService
 * @description Generated service for schema `importDefinition` owned by module `import`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner import
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ImportDefinitionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ImportDefinitionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'importDefinition';
        request.generatedServiceName = 'DefaultImportDefinitionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ImportDefinitionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ImportDefinitionModel');
