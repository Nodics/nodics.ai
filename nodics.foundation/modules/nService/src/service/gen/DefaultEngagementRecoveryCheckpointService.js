...
/**
 * @generated
 * @module generated/service/DefaultEngagementRecoveryCheckpointService
 * @description Generated service for schema `engagementRecoveryCheckpoint` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementRecoveryCheckpointModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementRecoveryCheckpointModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementRecoveryCheckpoint';
        request.generatedServiceName = 'DefaultEngagementRecoveryCheckpointService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementRecoveryCheckpointModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementRecoveryCheckpointModel');
