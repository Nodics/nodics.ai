...
/**
 * @generated
 * @module generated/service/DefaultCmsPageTemplateService
 * @description Generated service for schema `cmsPageTemplate` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPageTemplateModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPageTemplateModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsPageTemplate';
        request.generatedServiceName = 'DefaultCmsPageTemplateService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsPageTemplateModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsPageTemplateModel');
