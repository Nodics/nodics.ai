...
/**
 * @generated
 * @module generated/service/DefaultTestimonialConsentService
 * @description Generated service for schema `testimonialConsent` owned by module `testimonial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner testimonial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TestimonialConsentModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TestimonialConsentModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'testimonialConsent';
        request.generatedServiceName = 'DefaultTestimonialConsentService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.TestimonialConsentModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.TestimonialConsentModel');
