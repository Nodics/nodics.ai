...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewRequestService
 * @description Generated service for schema `customerReviewRequest` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewRequestModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewRequestModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewRequest';
        request.generatedServiceName = 'DefaultCustomerReviewRequestService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewRequestModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewRequestModel');
