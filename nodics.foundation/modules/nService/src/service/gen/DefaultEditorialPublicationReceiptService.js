...
/**
 * @generated
 * @module generated/service/DefaultEditorialPublicationReceiptService
 * @description Generated service for schema `editorialPublicationReceipt` owned by module `editorial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner editorial
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'editorial';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialPublicationReceiptModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialPublicationReceiptModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'editorialPublicationReceipt';
        request.generatedServiceName = 'DefaultEditorialPublicationReceiptService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EditorialPublicationReceiptModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EditorialPublicationReceiptModel');
