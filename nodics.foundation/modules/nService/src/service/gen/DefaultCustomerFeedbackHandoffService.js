...
/**
 * @generated
 * @module generated/service/DefaultCustomerFeedbackHandoffService
 * @description Generated service for schema `customerFeedbackHandoff` owned by module `customerFeedback`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackHandoffModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackHandoffModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerFeedbackHandoff';
        request.generatedServiceName = 'DefaultCustomerFeedbackHandoffService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerFeedbackHandoffModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerFeedbackHandoffModel');
