 ...
 * @description Generated service for schema `customer` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
 * @schema customer
 * @model CustomerModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customer';
        request.generatedServiceName = 'DefaultCustomerService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerModel');
