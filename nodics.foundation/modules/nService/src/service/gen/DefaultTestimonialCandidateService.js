...
/**
 * @generated
 * @module generated/service/DefaultTestimonialCandidateService
 * @description Generated service for schema `testimonialCandidate` owned by module `testimonial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner testimonial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TestimonialCandidateModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TestimonialCandidateModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'testimonialCandidate';
        request.generatedServiceName = 'DefaultTestimonialCandidateService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.TestimonialCandidateModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.TestimonialCandidateModel');
