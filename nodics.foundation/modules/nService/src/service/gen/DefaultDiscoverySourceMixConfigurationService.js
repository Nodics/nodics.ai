...
/**
 * @generated
 * @module generated/service/DefaultDiscoverySourceMixConfigurationService
 * @description Generated service for schema `discoverySourceMixConfiguration` owned by module `discoveryConfig`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoverySourceMixConfigurationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoverySourceMixConfigurationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'discoverySourceMixConfiguration';
        request.generatedServiceName = 'DefaultDiscoverySourceMixConfigurationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DiscoverySourceMixConfigurationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscoverySourceMixConfigurationModel');
