...
/**
 * @generated
 * @module generated/service/DefaultDiscoveryPublicationPolicyService
 * @description Generated service for schema `discoveryPublicationPolicy` owned by module `discoveryConfig`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryPublicationPolicyModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryPublicationPolicyModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'discoveryPublicationPolicy';
        request.generatedServiceName = 'DefaultDiscoveryPublicationPolicyService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DiscoveryPublicationPolicyModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscoveryPublicationPolicyModel');
