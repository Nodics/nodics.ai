...
/**
 * @generated
 * @module generated/service/DefaultContactCorrespondenceService
 * @description Generated service for schema `contactCorrespondence` owned by module `contactSubmission`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactCorrespondenceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactCorrespondenceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'contactCorrespondence';
        request.generatedServiceName = 'DefaultContactCorrespondenceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ContactCorrespondenceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ContactCorrespondenceModel');
