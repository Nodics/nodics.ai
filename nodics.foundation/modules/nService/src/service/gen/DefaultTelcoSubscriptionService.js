...
/**
 * @generated
 * @module generated/service/DefaultTelcoSubscriptionService
 * @description Generated service for schema `telcoSubscription` owned by module `telcoSubscription`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TelcoSubscriptionModel;
