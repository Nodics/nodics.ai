...
/**
 * @generated
 * @module generated/service/DefaultOrderLifecycleRequestService
 * @description Generated service for schema `orderLifecycleRequest` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderLifecycleRequestModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderLifecycleRequestModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'orderLifecycleRequest';
        request.generatedServiceName = 'DefaultOrderLifecycleRequestService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.OrderLifecycleRequestModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.OrderLifecycleRequestModel');
