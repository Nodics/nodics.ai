...
/**
 * @generated
 * @module generated/service/DefaultCategoryService
 * @description Generated service for schema `category` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
 * @schema category
 * @model CategoryModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CategoryModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CategoryModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'category';
        request.generatedServiceName = 'DefaultCategoryService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CategoryModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CategoryModel');
