...
/**
 * @generated
 * @module generated/service/DefaultOrderReversalCalculationService
 * @description Generated service for schema `orderReversalCalculation` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'order';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderReversalCalculationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderReversalCalculationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'orderReversalCalculation';
        request.generatedServiceName = 'DefaultOrderReversalCalculationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.OrderReversalCalculationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.OrderReversalCalculationModel');
