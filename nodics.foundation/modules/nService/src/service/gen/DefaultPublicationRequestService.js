...
/**
 * @generated
 * @module generated/service/DefaultPublicationRequestService
 * @description Generated service for schema `publicationRequest` owned by module `publish`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner publish
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PublicationRequestModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PublicationRequestModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'publicationRequest';
        request.generatedServiceName = 'DefaultPublicationRequestService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PublicationRequestModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PublicationRequestModel');
