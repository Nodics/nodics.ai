...
/**
 * @generated
 * @module generated/service/DefaultDataInstallationService
 * @description Generated service for schema `dataInstallation` owned by module `import`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner import
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'import';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DataInstallationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DataInstallationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'dataInstallation';
        request.generatedServiceName = 'DefaultDataInstallationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DataInstallationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DataInstallationModel');
