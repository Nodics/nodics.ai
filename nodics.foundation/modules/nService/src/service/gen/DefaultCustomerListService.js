...
/**
 * @generated
 * @module generated/service/DefaultCustomerListService
 * @description Generated service for schema `customerList` owned by module `customerList`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner customerList
 * @schema customerList
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerListModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerListModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerList';
        request.generatedServiceName = 'DefaultCustomerListService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerListModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerListModel');
