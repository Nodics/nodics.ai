...
/**
 * @generated
 * @module generated/service/DefaultCmsTypeCode2RendererService
 * @description Generated service for schema `cmsTypeCode2Renderer` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsTypeCode2RendererModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsTypeCode2RendererModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsTypeCode2Renderer';
        request.generatedServiceName = 'DefaultCmsTypeCode2RendererService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsTypeCode2RendererModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsTypeCode2RendererModel');
