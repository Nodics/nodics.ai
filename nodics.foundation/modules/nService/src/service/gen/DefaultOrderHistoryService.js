...
/**
 * @generated
 * @module generated/service/DefaultOrderHistoryService
 * @description Generated service for schema `orderHistory` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
 * @schema orderHistory
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderHistoryModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderHistoryModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'orderHistory';
        request.generatedServiceName = 'DefaultOrderHistoryService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.OrderHistoryModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.OrderHistoryModel');
