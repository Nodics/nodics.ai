...
/**
 * @generated
 * @module generated/service/DefaultCmsComponentMediaService
 * @description Generated service for schema `cmsComponentMedia` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsComponentMediaModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsComponentMediaModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsComponentMedia';
        request.generatedServiceName = 'DefaultCmsComponentMediaService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsComponentMediaModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsComponentMediaModel');
