...
/**
 * @generated
 * @module generated/service/DefaultCmsPageService
 * @description Generated service for schema `cmsPage` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
 * @schema cmsPage
 * @model CmsPageModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPageModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPageModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsPage';
        request.generatedServiceName = 'DefaultCmsPageService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsPageModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsPageModel');
