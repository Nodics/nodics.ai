...
/**
 * @generated
 * @module generated/service/DefaultCategoryLocalizationService
 * @description Generated service for schema `categoryLocalization` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CategoryLocalizationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CategoryLocalizationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'categoryLocalization';
        request.generatedServiceName = 'DefaultCategoryLocalizationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CategoryLocalizationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CategoryLocalizationModel');
