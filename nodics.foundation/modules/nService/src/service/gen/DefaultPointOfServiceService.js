...
/**
 * @generated
 * @module generated/service/DefaultPointOfServiceService
 * @description Generated service for schema `pointOfService` owned by module `store`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner store
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'store';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PointOfServiceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PointOfServiceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'pointOfService';
        request.generatedServiceName = 'DefaultPointOfServiceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PointOfServiceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PointOfServiceModel');
