...
module.exports = {
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PaymentTransactionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'paymentTransaction';
        request.generatedServiceName = 'DefaultPaymentTransactionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PaymentTransactionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PaymentTransactionModel');
