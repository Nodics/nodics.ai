...
/**
 * @generated
 * @module generated/service/DefaultCmsRestrictionService
 * @description Generated service for schema `cmsRestriction` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsRestrictionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsRestrictionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsRestriction';
        request.generatedServiceName = 'DefaultCmsRestrictionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsRestrictionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsRestrictionModel');
