...
/**
 * @generated
 * @module generated/service/DefaultEngagementAutomationEvaluationService
 * @description Generated service for schema `engagementAutomationEvaluation` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementAutomationEvaluationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementAutomationEvaluationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementAutomationEvaluation';
        request.generatedServiceName = 'DefaultEngagementAutomationEvaluationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementAutomationEvaluationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementAutomationEvaluationModel');
