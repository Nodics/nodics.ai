...
/**
 * @generated
 * @module generated/service/DefaultUserStateService
 * @description Generated service for schema `userState` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
 * @schema userState
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).UserStateModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).UserStateModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'userState';
        request.generatedServiceName = 'DefaultUserStateService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.UserStateModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.UserStateModel');
