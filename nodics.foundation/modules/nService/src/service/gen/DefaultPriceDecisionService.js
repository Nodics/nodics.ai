...
/**
 * @generated
 * @module generated/service/DefaultPriceDecisionService
 * @description Generated service for schema `priceDecision` owned by module `pricing`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner pricing
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'pricing';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PriceDecisionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PriceDecisionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'priceDecision';
        request.generatedServiceName = 'DefaultPriceDecisionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PriceDecisionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PriceDecisionModel');
