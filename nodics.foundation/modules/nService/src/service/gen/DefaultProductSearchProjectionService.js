...
/**
 * @generated
 * @module generated/service/DefaultProductSearchProjectionService
 * @description Generated service for schema `productSearchProjection` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductSearchProjectionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductSearchProjectionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'productSearchProjection';
        request.generatedServiceName = 'DefaultProductSearchProjectionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ProductSearchProjectionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ProductSearchProjectionModel');
