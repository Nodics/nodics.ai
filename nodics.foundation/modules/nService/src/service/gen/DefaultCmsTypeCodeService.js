...
/**
 * @generated
 * @module generated/service/DefaultCmsTypeCodeService
 * @description Generated service for schema `cmsTypeCode` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
 * @schema cmsTypeCode
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsTypeCodeModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsTypeCodeModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsTypeCode';
        request.generatedServiceName = 'DefaultCmsTypeCodeService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsTypeCodeModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsTypeCodeModel');
