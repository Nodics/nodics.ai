...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewSyndicationService
 * @description Generated service for schema `customerReviewSyndication` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewSyndicationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewSyndicationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewSyndication';
        request.generatedServiceName = 'DefaultCustomerReviewSyndicationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewSyndicationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewSyndicationModel');
