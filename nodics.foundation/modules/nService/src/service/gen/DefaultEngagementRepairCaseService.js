...
/**
 * @generated
 * @module generated/service/DefaultEngagementRepairCaseService
 * @description Generated service for schema `engagementRepairCase` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementRepairCaseModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementRepairCaseModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementRepairCase';
        request.generatedServiceName = 'DefaultEngagementRepairCaseService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementRepairCaseModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementRepairCaseModel');
