...
/**
 * @generated
 * @module generated/service/DefaultLocalizationOnlinePointerService
 * @description Generated service for schema `localizationOnlinePointer` owned by module `localizationCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'localizationCore';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).LocalizationOnlinePointerModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).LocalizationOnlinePointerModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'localizationOnlinePointer';
        request.generatedServiceName = 'DefaultLocalizationOnlinePointerService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.LocalizationOnlinePointerModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.LocalizationOnlinePointerModel');
