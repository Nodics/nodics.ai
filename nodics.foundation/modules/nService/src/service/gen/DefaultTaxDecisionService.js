...
/**
 * @generated
 * @module generated/service/DefaultTaxDecisionService
 * @description Generated service for schema `taxDecision` owned by module `tax`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner tax
 * @schema taxDecision
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'tax';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TaxDecisionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TaxDecisionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'taxDecision';
        request.generatedServiceName = 'DefaultTaxDecisionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.TaxDecisionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.TaxDecisionModel');
