...
/**
 * @generated
 * @module generated/service/DefaultAddressService
 * @description Generated service for schema `address` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
 * @schema address
 * @model AddressModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).AddressModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).AddressModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'address';
        request.generatedServiceName = 'DefaultAddressService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.AddressModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.AddressModel');
