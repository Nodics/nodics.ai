...
/**
 * @generated
 * @module generated/service/DefaultCmsPageRouteService
 * @description Generated service for schema `cmsPageRoute` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
 * @schema cmsPageRoute
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPageRouteModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPageRouteModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsPageRoute';
        request.generatedServiceName = 'DefaultCmsPageRouteService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsPageRouteModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsPageRouteModel');
