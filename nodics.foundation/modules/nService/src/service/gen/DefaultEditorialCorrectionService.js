...
/**
 * @generated
 * @module generated/service/DefaultEditorialCorrectionService
 * @description Generated service for schema `editorialCorrection` owned by module `editorial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner editorial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialCorrectionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialCorrectionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'editorialCorrection';
        request.generatedServiceName = 'DefaultEditorialCorrectionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EditorialCorrectionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EditorialCorrectionModel');
