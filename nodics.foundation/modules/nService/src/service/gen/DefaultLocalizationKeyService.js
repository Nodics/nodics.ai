...
/**
 * @generated
 * @module generated/service/DefaultLocalizationKeyService
 * @description Generated service for schema `localizationKey` owned by module `localizationCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).LocalizationKeyModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).LocalizationKeyModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'localizationKey';
        request.generatedServiceName = 'DefaultLocalizationKeyService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.LocalizationKeyModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.LocalizationKeyModel');
