...
/**
 * @generated
 * @module generated/service/DefaultCustomerFeedbackFollowUpService
 * @description Generated service for schema `customerFeedbackFollowUp` owned by module `customerFeedback`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackFollowUpModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackFollowUpModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerFeedbackFollowUp';
        request.generatedServiceName = 'DefaultCustomerFeedbackFollowUpService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerFeedbackFollowUpModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerFeedbackFollowUpModel');
