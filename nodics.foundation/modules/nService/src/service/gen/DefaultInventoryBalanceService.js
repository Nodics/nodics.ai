...
/**
 * @generated
 * @module generated/service/DefaultInventoryBalanceService
 * @description Generated service for schema `inventoryBalance` owned by module `inventory`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner inventory
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).InventoryBalanceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).InventoryBalanceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'inventoryBalance';
        request.generatedServiceName = 'DefaultInventoryBalanceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.InventoryBalanceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.InventoryBalanceModel');
