...
/**
 * @generated
 * @module generated/service/DefaultEngagementFormDefinitionService
 * @description Generated service for schema `engagementFormDefinition` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementFormDefinitionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementFormDefinitionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementFormDefinition';
        request.generatedServiceName = 'DefaultEngagementFormDefinitionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementFormDefinitionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementFormDefinitionModel');
