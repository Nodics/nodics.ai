...
/**
 * @generated
 * @module generated/service/DefaultEngagementBatchRunService
 * @description Generated service for schema `engagementBatchRun` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementBatchRunModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementBatchRunModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementBatchRun';
        request.generatedServiceName = 'DefaultEngagementBatchRunService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementBatchRunModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementBatchRunModel');
