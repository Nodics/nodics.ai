...
/**
 * @generated
 * @module generated/service/DefaultEngagementAssignmentService
 * @description Generated service for schema `engagementAssignment` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementAssignmentModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementAssignmentModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementAssignment';
        request.generatedServiceName = 'DefaultEngagementAssignmentService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementAssignmentModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementAssignmentModel');
