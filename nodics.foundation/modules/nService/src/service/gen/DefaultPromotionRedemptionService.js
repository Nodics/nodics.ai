...
/**
 * @generated
 * @module generated/service/DefaultPromotionRedemptionService
 * @description Generated service for schema `promotionRedemption` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PromotionRedemptionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PromotionRedemptionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'promotionRedemption';
        request.generatedServiceName = 'DefaultPromotionRedemptionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PromotionRedemptionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PromotionRedemptionModel');
