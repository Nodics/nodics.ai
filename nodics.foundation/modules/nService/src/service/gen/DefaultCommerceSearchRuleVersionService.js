...
/**
 * @generated
 * @module generated/service/DefaultCommerceSearchRuleVersionService
 * @description Generated service for schema `commerceSearchRuleVersion` owned by module `commerceSearchCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceSearchRuleVersionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceSearchRuleVersionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commerceSearchRuleVersion';
        request.generatedServiceName = 'DefaultCommerceSearchRuleVersionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommerceSearchRuleVersionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommerceSearchRuleVersionModel');
