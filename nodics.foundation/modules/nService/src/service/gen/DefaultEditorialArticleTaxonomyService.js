...
/**
 * @generated
 * @module generated/service/DefaultEditorialArticleTaxonomyService
 * @description Generated service for schema `editorialArticleTaxonomy` owned by module `editorial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner editorial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialArticleTaxonomyModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialArticleTaxonomyModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'editorialArticleTaxonomy';
        request.generatedServiceName = 'DefaultEditorialArticleTaxonomyService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EditorialArticleTaxonomyModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EditorialArticleTaxonomyModel');
