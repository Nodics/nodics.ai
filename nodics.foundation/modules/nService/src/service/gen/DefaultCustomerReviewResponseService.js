...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewResponseService
 * @description Generated service for schema `customerReviewResponse` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewResponseModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewResponseModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewResponse';
        request.generatedServiceName = 'DefaultCustomerReviewResponseService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewResponseModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewResponseModel');
