...
/**
 * @generated
 * @module generated/service/DefaultProductLocalizationService
 * @description Generated service for schema `productLocalization` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductLocalizationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductLocalizationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'productLocalization';
        request.generatedServiceName = 'DefaultProductLocalizationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ProductLocalizationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ProductLocalizationModel');
