...
/**
 * @generated
 * @module generated/service/DefaultCustomerListEntryService
 * @description Generated service for schema `customerListEntry` owned by module `customerList`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner customerList
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'customerList';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerListEntryModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerListEntryModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerListEntry';
        request.generatedServiceName = 'DefaultCustomerListEntryService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerListEntryModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerListEntryModel');
