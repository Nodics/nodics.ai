...
/**
 * @generated
 * @module generated/service/DefaultTestimonialProjectionService
 * @description Generated service for schema `testimonialProjection` owned by module `testimonial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner testimonial
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'testimonial';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TestimonialProjectionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TestimonialProjectionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'testimonialProjection';
        request.generatedServiceName = 'DefaultTestimonialProjectionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.TestimonialProjectionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.TestimonialProjectionModel');
