...
/**
 * @generated
 * @module generated/service/DefaultCommerceCompatibilityRecordService
 * @description Generated service for schema `commerceCompatibilityRecord` owned by module `checkoutCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner checkoutCore
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceCompatibilityRecordModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceCompatibilityRecordModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commerceCompatibilityRecord';
        request.generatedServiceName = 'DefaultCommerceCompatibilityRecordService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommerceCompatibilityRecordModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommerceCompatibilityRecordModel');
