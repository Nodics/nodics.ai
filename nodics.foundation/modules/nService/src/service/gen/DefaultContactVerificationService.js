...
/**
 * @generated
 * @module generated/service/DefaultContactVerificationService
 * @description Generated service for schema `contactVerification` owned by module `contactSubmission`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactVerificationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactVerificationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'contactVerification';
        request.generatedServiceName = 'DefaultContactVerificationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ContactVerificationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ContactVerificationModel');
