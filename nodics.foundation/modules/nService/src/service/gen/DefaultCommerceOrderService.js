...
/**
 * @generated
 * @module generated/service/DefaultCommerceOrderService
 * @description Generated service for schema `commerceOrder` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceOrderModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceOrderModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commerceOrder';
        request.generatedServiceName = 'DefaultCommerceOrderService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommerceOrderModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommerceOrderModel');
