...
/**
 * @generated
 * @module generated/service/DefaultTrackingEventService
 * @description Generated service for schema `trackingEvent` owned by module `fulfillmentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TrackingEventModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TrackingEventModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'trackingEvent';
        request.generatedServiceName = 'DefaultTrackingEventService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.TrackingEventModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.TrackingEventModel');
