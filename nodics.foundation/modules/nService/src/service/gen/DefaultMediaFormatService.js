...
/**
 * @generated
 * @module generated/service/DefaultMediaFormatService
 * @description Generated service for schema `mediaFormat` owned by module `media`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner media
 * @schema mediaFormat
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaFormatModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaFormatModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'mediaFormat';
        request.generatedServiceName = 'DefaultMediaFormatService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.MediaFormatModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.MediaFormatModel');
