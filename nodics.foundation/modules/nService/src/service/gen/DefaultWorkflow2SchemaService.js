...
/**
 * @generated
 * @module generated/service/DefaultWorkflow2SchemaService
 * @description Generated service for schema `workflow2Schema` owned by module `system`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner system
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).Workflow2SchemaModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).Workflow2SchemaModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'workflow2Schema';
        request.generatedServiceName = 'DefaultWorkflow2SchemaService';
