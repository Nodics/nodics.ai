...
/**
 * @generated
 * @module generated/service/DefaultConsignmentService
 * @description Generated service for schema `consignment` owned by module `fulfillmentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ConsignmentModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ConsignmentModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'consignment';
        request.generatedServiceName = 'DefaultConsignmentService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ConsignmentModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ConsignmentModel');
