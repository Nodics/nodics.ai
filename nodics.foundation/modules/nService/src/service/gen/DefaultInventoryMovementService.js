...
/**
 * @generated
 * @module generated/service/DefaultInventoryMovementService
 * @description Generated service for schema `inventoryMovement` owned by module `inventory`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner inventory
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).InventoryMovementModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).InventoryMovementModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'inventoryMovement';
        request.generatedServiceName = 'DefaultInventoryMovementService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.InventoryMovementModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.InventoryMovementModel');
