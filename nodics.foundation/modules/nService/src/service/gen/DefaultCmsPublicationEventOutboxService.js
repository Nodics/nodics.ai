...
/**
 * @generated
 * @module generated/service/DefaultCmsPublicationEventOutboxService
 * @description Generated service for schema `cmsPublicationEventOutbox` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPublicationEventOutboxModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPublicationEventOutboxModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsPublicationEventOutbox';
        request.generatedServiceName = 'DefaultCmsPublicationEventOutboxService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsPublicationEventOutboxModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsPublicationEventOutboxModel');
