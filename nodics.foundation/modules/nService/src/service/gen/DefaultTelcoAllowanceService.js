...
/**
 * @generated
 * @module generated/service/DefaultTelcoAllowanceService
 * @description Generated service for schema `telcoAllowance` owned by module `telcoCatalog`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner telcoCatalog
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TelcoAllowanceModel;
