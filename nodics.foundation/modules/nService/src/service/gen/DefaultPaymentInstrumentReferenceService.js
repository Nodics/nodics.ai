...
/**
 * @generated
 * @module generated/service/DefaultPaymentInstrumentReferenceService
 * @description Generated service for schema `paymentInstrumentReference` owned by module `paymentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner paymentCore
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PaymentInstrumentReferenceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PaymentInstrumentReferenceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'paymentInstrumentReference';
        request.generatedServiceName = 'DefaultPaymentInstrumentReferenceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PaymentInstrumentReferenceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PaymentInstrumentReferenceModel');
