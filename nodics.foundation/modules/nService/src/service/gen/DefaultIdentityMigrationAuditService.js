...
/**
 * @generated
 * @module generated/service/DefaultIdentityMigrationAuditService
 * @description Generated service for schema `identityMigrationAudit` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).IdentityMigrationAuditModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).IdentityMigrationAuditModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'identityMigrationAudit';
        request.generatedServiceName = 'DefaultIdentityMigrationAuditService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.IdentityMigrationAuditModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.IdentityMigrationAuditModel');
