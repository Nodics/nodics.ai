...
/**
 * @generated
 * @module generated/service/DefaultEngagementAutomationDecisionService
 * @description Generated service for schema `engagementAutomationDecision` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementAutomationDecisionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementAutomationDecisionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementAutomationDecision';
        request.generatedServiceName = 'DefaultEngagementAutomationDecisionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementAutomationDecisionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementAutomationDecisionModel');
