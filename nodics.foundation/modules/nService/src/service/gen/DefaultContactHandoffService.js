...
/**
 * @generated
 * @module generated/service/DefaultContactHandoffService
 * @description Generated service for schema `contactHandoff` owned by module `contactSubmission`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactHandoffModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ContactHandoffModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'contactHandoff';
        request.generatedServiceName = 'DefaultContactHandoffService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ContactHandoffModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ContactHandoffModel');
