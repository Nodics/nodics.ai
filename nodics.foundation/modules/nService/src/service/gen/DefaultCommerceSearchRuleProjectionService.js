...
/**
 * @generated
 * @module generated/service/DefaultCommerceSearchRuleProjectionService
 * @description Generated service for schema `commerceSearchRuleProjection` owned by module `commerceSearchCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'commerceSearchCore';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceSearchRuleProjectionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceSearchRuleProjectionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commerceSearchRuleProjection';
        request.generatedServiceName = 'DefaultCommerceSearchRuleProjectionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommerceSearchRuleProjectionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommerceSearchRuleProjectionModel');
