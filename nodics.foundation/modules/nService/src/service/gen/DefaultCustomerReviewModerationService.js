...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewModerationService
 * @description Generated service for schema `customerReviewModeration` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewModerationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewModerationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewModeration';
        request.generatedServiceName = 'DefaultCustomerReviewModerationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewModerationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewModerationModel');
