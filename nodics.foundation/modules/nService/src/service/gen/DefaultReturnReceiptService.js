...
/**
 * @generated
 * @module generated/service/DefaultReturnReceiptService
 * @description Generated service for schema `returnReceipt` owned by module `fulfillmentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ReturnReceiptModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ReturnReceiptModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'returnReceipt';
        request.generatedServiceName = 'DefaultReturnReceiptService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ReturnReceiptModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ReturnReceiptModel');
