...
/**
 * @generated
 * @module generated/service/DefaultConfigurationService
 * @description Generated service for schema `configuration` owned by module `system`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner system
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'system';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ConfigurationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ConfigurationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'configuration';
        request.generatedServiceName = 'DefaultConfigurationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ConfigurationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ConfigurationModel');
