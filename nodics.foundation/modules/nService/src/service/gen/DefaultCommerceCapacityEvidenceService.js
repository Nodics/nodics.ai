...
/**
 * @generated
 * @module generated/service/DefaultCommerceCapacityEvidenceService
 * @description Generated service for schema `commerceCapacityEvidence` owned by module `checkoutCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner checkoutCore
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceCapacityEvidenceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceCapacityEvidenceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commerceCapacityEvidence';
        request.generatedServiceName = 'DefaultCommerceCapacityEvidenceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommerceCapacityEvidenceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommerceCapacityEvidenceModel');
