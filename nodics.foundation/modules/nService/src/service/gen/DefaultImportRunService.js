...
/**
 * @generated
 * @module generated/service/DefaultImportRunService
 * @description Generated service for schema `importRun` owned by module `import`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner import
 * @schema importRun
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ImportRunModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ImportRunModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'importRun';
        request.generatedServiceName = 'DefaultImportRunService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ImportRunModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ImportRunModel');
