...
/**
 * @generated
 * @module generated/service/DefaultCmsNavigationNodeService
 * @description Generated service for schema `cmsNavigationNode` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsNavigationNodeModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsNavigationNodeModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsNavigationNode';
        request.generatedServiceName = 'DefaultCmsNavigationNodeService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsNavigationNodeModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsNavigationNodeModel');
