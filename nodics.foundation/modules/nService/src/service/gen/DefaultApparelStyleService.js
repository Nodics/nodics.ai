...
/**
 * @generated
 * @module generated/service/DefaultApparelStyleService
 * @description Generated service for schema `apparelStyle` owned by module `apparelProduct`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ApparelStyleModel;
