...
/**
 * @generated
 * @module generated/service/DefaultCommsSuppressionService
 * @description Generated service for schema `commsSuppression` owned by module `commsSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner commsSchema
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsSuppressionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsSuppressionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commsSuppression';
        request.generatedServiceName = 'DefaultCommsSuppressionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommsSuppressionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommsSuppressionModel');
