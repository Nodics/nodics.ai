...
/**
 * @generated
 * @module generated/service/DefaultDiscoveryRankingProfileService
 * @description Generated service for schema `discoveryRankingProfile` owned by module `discoveryConfig`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryRankingProfileModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryRankingProfileModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'discoveryRankingProfile';
        request.generatedServiceName = 'DefaultDiscoveryRankingProfileService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DiscoveryRankingProfileModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscoveryRankingProfileModel');
