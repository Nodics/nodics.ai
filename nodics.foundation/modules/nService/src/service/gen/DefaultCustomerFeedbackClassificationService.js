...
/**
 * @generated
 * @module generated/service/DefaultCustomerFeedbackClassificationService
 * @description Generated service for schema `customerFeedbackClassification` owned by module `customerFeedback`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackClassificationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackClassificationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerFeedbackClassification';
        request.generatedServiceName = 'DefaultCustomerFeedbackClassificationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerFeedbackClassificationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerFeedbackClassificationModel');
