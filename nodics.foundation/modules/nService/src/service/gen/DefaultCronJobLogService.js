...
/**
 * @generated
 * @module generated/service/DefaultCronJobLogService
 * @description Generated service for schema `cronJobLog` owned by module `cronjob`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cronjob
 * @schema cronJobLog
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'cronjob';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CronJobLogModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CronJobLogModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cronJobLog';
        request.generatedServiceName = 'DefaultCronJobLogService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CronJobLogModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CronJobLogModel');
