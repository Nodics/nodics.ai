...
/**
 * @generated
 * @module generated/service/DefaultCartEntryService
 * @description Generated service for schema `cartEntry` owned by module `cart`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cart
 * @schema cartEntry
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CartEntryModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CartEntryModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cartEntry';
        request.generatedServiceName = 'DefaultCartEntryService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CartEntryModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CartEntryModel');
