...
/**
 * @generated
 * @module generated/service/DefaultTelcoNumberIntentService
 * @description Generated service for schema `telcoNumberIntent` owned by module `telcoSubscription`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'telcoSubscription';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TelcoNumberIntentModel;
