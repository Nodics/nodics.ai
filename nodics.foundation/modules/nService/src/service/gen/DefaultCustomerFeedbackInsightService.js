...
/**
 * @generated
 * @module generated/service/DefaultCustomerFeedbackInsightService
 * @description Generated service for schema `customerFeedbackInsight` owned by module `customerFeedback`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'customerFeedback';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackInsightModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackInsightModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerFeedbackInsight';
        request.generatedServiceName = 'DefaultCustomerFeedbackInsightService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerFeedbackInsightModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerFeedbackInsightModel');
