...
/**
 * @generated
 * @module generated/service/DefaultBackofficeContractSnapshotService
 * @description Generated service for schema `backofficeContractSnapshot` owned by module `backoffice`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner backoffice
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).BackofficeContractSnapshotModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).BackofficeContractSnapshotModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'backofficeContractSnapshot';
        request.generatedServiceName = 'DefaultBackofficeContractSnapshotService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.BackofficeContractSnapshotModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.BackofficeContractSnapshotModel');
