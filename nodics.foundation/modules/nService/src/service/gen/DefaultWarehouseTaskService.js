...
/**
 * @generated
 * @module generated/service/DefaultWarehouseTaskService
 * @description Generated service for schema `warehouseTask` owned by module `fulfillmentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).WarehouseTaskModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).WarehouseTaskModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'warehouseTask';
        request.generatedServiceName = 'DefaultWarehouseTaskService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.WarehouseTaskModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.WarehouseTaskModel');
