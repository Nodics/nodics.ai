...
/**
 * @generated
 * @module generated/service/DefaultProductVariantService
 * @description Generated service for schema `productVariant` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductVariantModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductVariantModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'productVariant';
        request.generatedServiceName = 'DefaultProductVariantService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ProductVariantModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ProductVariantModel');
