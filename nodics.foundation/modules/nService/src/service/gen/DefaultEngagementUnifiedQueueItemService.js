...
/**
 * @generated
 * @module generated/service/DefaultEngagementUnifiedQueueItemService
 * @description Generated service for schema `engagementUnifiedQueueItem` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementUnifiedQueueItemModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementUnifiedQueueItemModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementUnifiedQueueItem';
        request.generatedServiceName = 'DefaultEngagementUnifiedQueueItemService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementUnifiedQueueItemModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementUnifiedQueueItemModel');
