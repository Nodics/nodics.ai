...
/**
 * @generated
 * @module generated/service/DefaultCommsVerificationChallengeService
 * @description Generated service for schema `commsVerificationChallenge` owned by module `commsSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner commsSchema
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'commsSchema';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsVerificationChallengeModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsVerificationChallengeModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commsVerificationChallenge';
        request.generatedServiceName = 'DefaultCommsVerificationChallengeService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommsVerificationChallengeModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommsVerificationChallengeModel');
