...
/**
 * @generated
 * @module generated/service/DefaultEditorialArticleLocalizationService
 * @description Generated service for schema `editorialArticleLocalization` owned by module `editorial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner editorial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialArticleLocalizationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialArticleLocalizationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'editorialArticleLocalization';
        request.generatedServiceName = 'DefaultEditorialArticleLocalizationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EditorialArticleLocalizationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EditorialArticleLocalizationModel');
