...
/**
 * @generated
 * @module generated/service/DefaultOrderLifecycleCheckpointService
 * @description Generated service for schema `orderLifecycleCheckpoint` owned by module `order`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner order
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderLifecycleCheckpointModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).OrderLifecycleCheckpointModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'orderLifecycleCheckpoint';
        request.generatedServiceName = 'DefaultOrderLifecycleCheckpointService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.OrderLifecycleCheckpointModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.OrderLifecycleCheckpointModel');
