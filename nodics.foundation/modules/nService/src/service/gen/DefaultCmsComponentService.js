...
/**
 * @generated
 * @module generated/service/DefaultCmsComponentService
 * @description Generated service for schema `cmsComponent` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
 * @schema cmsComponent
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsComponentModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsComponentModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsComponent';
        request.generatedServiceName = 'DefaultCmsComponentService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsComponentModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsComponentModel');
