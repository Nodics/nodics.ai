...
/**
 * @generated
 * @module generated/service/DefaultProductPublicationService
 * @description Generated service for schema `productPublication` owned by module `product`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner product
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductPublicationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProductPublicationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'productPublication';
        request.generatedServiceName = 'DefaultProductPublicationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ProductPublicationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ProductPublicationModel');
