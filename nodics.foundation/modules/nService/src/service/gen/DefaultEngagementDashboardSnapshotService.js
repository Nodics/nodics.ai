...
/**
 * @generated
 * @module generated/service/DefaultEngagementDashboardSnapshotService
 * @description Generated service for schema `engagementDashboardSnapshot` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementDashboardSnapshotModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementDashboardSnapshotModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementDashboardSnapshot';
        request.generatedServiceName = 'DefaultEngagementDashboardSnapshotService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementDashboardSnapshotModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementDashboardSnapshotModel');
