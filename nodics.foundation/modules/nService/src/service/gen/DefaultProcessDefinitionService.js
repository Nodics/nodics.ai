...
module.exports = {
    ...
    safeSearch: function (request) {
        ...
        request.generatedServiceName = 'DefaultProcessDefinitionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ProcessDefinitionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ProcessDefinitionModel');
