...
/**
 * @generated
 * @module generated/service/DefaultInventoryReservationService
 * @description Generated service for schema `inventoryReservation` owned by module `inventory`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner inventory
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'inventory';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).InventoryReservationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).InventoryReservationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'inventoryReservation';
        request.generatedServiceName = 'DefaultInventoryReservationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.InventoryReservationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.InventoryReservationModel');
