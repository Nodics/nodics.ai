...
/**
 * @generated
 * @module generated/service/DefaultCommsInboxMessageService
 * @description Generated service for schema `commsInboxMessage` owned by module `commsSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner commsSchema
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsInboxMessageModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsInboxMessageModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commsInboxMessage';
        request.generatedServiceName = 'DefaultCommsInboxMessageService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommsInboxMessageModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommsInboxMessageModel');
