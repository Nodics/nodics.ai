...
/**
 * @generated
 * @module generated/service/DefaultEngagementSubmissionService
 * @description Generated service for schema `engagementSubmission` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementSubmissionModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementSubmissionModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementSubmission';
        request.generatedServiceName = 'DefaultEngagementSubmissionService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementSubmissionModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementSubmissionModel');
