...
/**
 * @generated
 * @module generated/service/DefaultEngagementPublicationReferenceService
 * @description Generated service for schema `engagementPublicationReference` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'engagementCore';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementPublicationReferenceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementPublicationReferenceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementPublicationReference';
        request.generatedServiceName = 'DefaultEngagementPublicationReferenceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementPublicationReferenceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementPublicationReferenceModel');
