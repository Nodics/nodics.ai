...
/**
 * @generated
 * @module generated/service/DefaultMediaReferenceService
 * @description Generated service for schema `mediaReference` owned by module `media`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner media
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'media';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaReferenceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaReferenceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'mediaReference';
        request.generatedServiceName = 'DefaultMediaReferenceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.MediaReferenceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.MediaReferenceModel');
