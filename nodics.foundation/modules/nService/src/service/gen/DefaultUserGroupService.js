...
/**
 * @generated
 * @module generated/service/DefaultUserGroupService
 * @description Generated service for schema `userGroup` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
 * @schema userGroup
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).UserGroupModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).UserGroupModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'userGroup';
        request.generatedServiceName = 'DefaultUserGroupService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.UserGroupModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.UserGroupModel');
