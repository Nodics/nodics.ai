...
/**
 * @generated
 * @module generated/service/DefaultMediaSetService
 * @description Generated service for schema `mediaSet` owned by module `media`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner media
 * @schema mediaSet
 * @model MediaSetModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaSetModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaSetModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'mediaSet';
        request.generatedServiceName = 'DefaultMediaSetService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.MediaSetModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.MediaSetModel');
