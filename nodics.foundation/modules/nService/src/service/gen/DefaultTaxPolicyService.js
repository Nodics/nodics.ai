...
/**
 * @generated
 * @module generated/service/DefaultTaxPolicyService
 * @description Generated service for schema `taxPolicy` owned by module `tax`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner tax
 * @schema taxPolicy
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TaxPolicyModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TaxPolicyModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'taxPolicy';
        request.generatedServiceName = 'DefaultTaxPolicyService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.TaxPolicyModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.TaxPolicyModel');
