 ...
 * @description Generated service for schema `processInstance` owned by module `flowSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner flowSchema
