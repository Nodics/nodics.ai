...
/**
 * @generated
 * @module generated/service/DefaultProcessInstanceService
 * @description Generated service for schema `processInstance` owned by module `workflow`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner workflow
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProcessInstanceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ProcessInstanceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'processInstance';
        request.generatedServiceName = 'DefaultProcessInstanceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ProcessInstanceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ProcessInstanceModel');
