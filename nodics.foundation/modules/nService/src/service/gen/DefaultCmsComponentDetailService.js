...
/**
 * @generated
 * @module generated/service/DefaultCmsComponentDetailService
 * @description Generated service for schema `cmsComponentDetail` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsComponentDetailModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsComponentDetailModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsComponentDetail';
        request.generatedServiceName = 'DefaultCmsComponentDetailService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsComponentDetailModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsComponentDetailModel');
