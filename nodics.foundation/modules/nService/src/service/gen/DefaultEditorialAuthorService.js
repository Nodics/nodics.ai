...
/**
 * @generated
 * @module generated/service/DefaultEditorialAuthorService
 * @description Generated service for schema `editorialAuthor` owned by module `editorial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner editorial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialAuthorModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialAuthorModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'editorialAuthor';
        request.generatedServiceName = 'DefaultEditorialAuthorService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EditorialAuthorModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EditorialAuthorModel');
