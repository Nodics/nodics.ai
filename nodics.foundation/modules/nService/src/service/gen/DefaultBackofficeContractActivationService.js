...
/**
 * @generated
 * @module generated/service/DefaultBackofficeContractActivationService
 * @description Generated service for schema `backofficeContractActivation` owned by module `backoffice`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner backoffice
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).BackofficeContractActivationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).BackofficeContractActivationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'backofficeContractActivation';
        request.generatedServiceName = 'DefaultBackofficeContractActivationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.BackofficeContractActivationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.BackofficeContractActivationModel');
