...
/**
 * @generated
 * @module generated/service/DefaultDiscoveryIndexConfigurationService
 * @description Generated service for schema `discoveryIndexConfiguration` owned by module `discoveryConfig`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryIndexConfigurationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).DiscoveryIndexConfigurationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'discoveryIndexConfiguration';
        request.generatedServiceName = 'DefaultDiscoveryIndexConfigurationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DiscoveryIndexConfigurationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscoveryIndexConfigurationModel');
