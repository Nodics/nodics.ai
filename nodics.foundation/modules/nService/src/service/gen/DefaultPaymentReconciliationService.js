...
/**
 * @generated
 * @module generated/service/DefaultPaymentReconciliationService
 * @description Generated service for schema `paymentReconciliation` owned by module `paymentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner paymentCore
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PaymentReconciliationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PaymentReconciliationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'paymentReconciliation';
        request.generatedServiceName = 'DefaultPaymentReconciliationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PaymentReconciliationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PaymentReconciliationModel');
