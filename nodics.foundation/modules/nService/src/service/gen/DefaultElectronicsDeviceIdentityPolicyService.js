...
/**
 * @generated
 * @module generated/service/DefaultElectronicsDeviceIdentityPolicyService
 * @description Generated service for schema `electronicsDeviceIdentityPolicy` owned by module `electronicsProduct`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ElectronicsDeviceIdentityPolicyModel;
