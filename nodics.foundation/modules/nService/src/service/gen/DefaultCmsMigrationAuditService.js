...
/**
 * @generated
 * @module generated/service/DefaultCmsMigrationAuditService
 * @description Generated service for schema `cmsMigrationAudit` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsMigrationAuditModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsMigrationAuditModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsMigrationAudit';
        request.generatedServiceName = 'DefaultCmsMigrationAuditService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsMigrationAuditModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsMigrationAuditModel');
