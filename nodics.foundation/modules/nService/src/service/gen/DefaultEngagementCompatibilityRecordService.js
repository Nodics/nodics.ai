...
/**
 * @generated
 * @module generated/service/DefaultEngagementCompatibilityRecordService
 * @description Generated service for schema `engagementCompatibilityRecord` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementCompatibilityRecordModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementCompatibilityRecordModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementCompatibilityRecord';
        request.generatedServiceName = 'DefaultEngagementCompatibilityRecordService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementCompatibilityRecordModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementCompatibilityRecordModel');
