...
module.exports = {
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.DiscoveryFieldMappingModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.DiscoveryFieldMappingModel');
