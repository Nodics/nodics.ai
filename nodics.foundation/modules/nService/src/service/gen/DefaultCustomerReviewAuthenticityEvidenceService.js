...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewAuthenticityEvidenceService
 * @description Generated service for schema `customerReviewAuthenticityEvidence` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewAuthenticityEvidenceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewAuthenticityEvidenceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewAuthenticityEvidence';
        request.generatedServiceName = 'DefaultCustomerReviewAuthenticityEvidenceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewAuthenticityEvidenceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewAuthenticityEvidenceModel');
