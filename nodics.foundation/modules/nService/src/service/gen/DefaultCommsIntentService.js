...
/**
 * @generated
 * @module generated/service/DefaultCommsIntentService
 * @description Generated service for schema `commsIntent` owned by module `commsSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner commsSchema
 * @schema commsIntent
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsIntentModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsIntentModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commsIntent';
        request.generatedServiceName = 'DefaultCommsIntentService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommsIntentModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommsIntentModel');
