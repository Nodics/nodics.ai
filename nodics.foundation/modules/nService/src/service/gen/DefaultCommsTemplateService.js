...
/**
 * @generated
 * @module generated/service/DefaultCommsTemplateService
 * @description Generated service for schema `commsTemplate` owned by module `commsSchema`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner commsSchema
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsTemplateModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommsTemplateModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commsTemplate';
        request.generatedServiceName = 'DefaultCommsTemplateService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommsTemplateModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommsTemplateModel');
