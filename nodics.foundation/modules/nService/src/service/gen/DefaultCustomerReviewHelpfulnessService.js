...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewHelpfulnessService
 * @description Generated service for schema `customerReviewHelpfulness` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewHelpfulnessModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewHelpfulnessModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewHelpfulness';
        request.generatedServiceName = 'DefaultCustomerReviewHelpfulnessService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewHelpfulnessModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewHelpfulnessModel');
