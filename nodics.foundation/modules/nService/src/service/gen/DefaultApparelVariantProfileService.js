...
/**
 * @generated
 * @module generated/service/DefaultApparelVariantProfileService
 * @description Generated service for schema `apparelVariantProfile` owned by module `apparelProduct`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'apparelProduct';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ApparelVariantProfileModel;
