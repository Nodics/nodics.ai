...
/**
 * @generated
 * @module generated/service/DefaultMediaService
 * @description Generated service for schema `media` owned by module `media`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner media
 * @schema media
 * @model MediaModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'media';
        request.generatedServiceName = 'DefaultMediaService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.MediaModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.MediaModel');
