...
/**
 * @generated
 * @module generated/service/DefaultTelcoPlanOfferingService
 * @description Generated service for schema `telcoPlanOffering` owned by module `telcoCatalog`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner telcoCatalog
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'telcoCatalog';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TelcoPlanOfferingModel;
