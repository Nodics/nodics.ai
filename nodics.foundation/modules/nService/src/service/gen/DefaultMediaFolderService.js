...
/**
 * @generated
 * @module generated/service/DefaultMediaFolderService
 * @description Generated service for schema `mediaFolder` owned by module `media`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner media
 * @schema mediaFolder
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaFolderModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaFolderModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'mediaFolder';
        request.generatedServiceName = 'DefaultMediaFolderService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.MediaFolderModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.MediaFolderModel');
