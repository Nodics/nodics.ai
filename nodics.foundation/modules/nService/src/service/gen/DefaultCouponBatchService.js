...
/**
 * @generated
 * @module generated/service/DefaultCouponBatchService
 * @description Generated service for schema `couponBatch` owned by module `promotion`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner promotion
 * @schema couponBatch
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CouponBatchModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CouponBatchModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'couponBatch';
        request.generatedServiceName = 'DefaultCouponBatchService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CouponBatchModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CouponBatchModel');
