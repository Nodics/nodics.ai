...
/**
 * @generated
 * @module generated/service/DefaultLocalizationValueService
 * @description Generated service for schema `localizationValue` owned by module `localizationCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).LocalizationValueModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).LocalizationValueModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'localizationValue';
        request.generatedServiceName = 'DefaultLocalizationValueService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.LocalizationValueModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.LocalizationValueModel');
