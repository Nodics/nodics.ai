...
/**
 * @generated
 * @module generated/service/DefaultEditorialTaxonomyTermService
 * @description Generated service for schema `editorialTaxonomyTerm` owned by module `editorial`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner editorial
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialTaxonomyTermModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EditorialTaxonomyTermModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'editorialTaxonomyTerm';
        request.generatedServiceName = 'DefaultEditorialTaxonomyTermService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EditorialTaxonomyTermModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EditorialTaxonomyTermModel');
