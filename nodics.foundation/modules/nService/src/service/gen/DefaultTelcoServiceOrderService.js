...
/**
 * @generated
 * @module generated/service/DefaultTelcoServiceOrderService
 * @description Generated service for schema `telcoServiceOrder` owned by module `telcoProvisioning`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'telcoProvisioning';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TelcoServiceOrderModel;
