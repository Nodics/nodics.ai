...
/**
 * @generated
 * @module generated/service/DefaultPriceBookService
 * @description Generated service for schema `priceBook` owned by module `pricing`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner pricing
 * @schema priceBook
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PriceBookModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PriceBookModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'priceBook';
        request.generatedServiceName = 'DefaultPriceBookService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PriceBookModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PriceBookModel');
