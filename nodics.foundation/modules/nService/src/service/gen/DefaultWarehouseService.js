...
/**
 * @generated
 * @module generated/service/DefaultWarehouseService
 * @description Generated service for schema `warehouse` owned by module `inventory`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner inventory
 * @schema warehouse
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).WarehouseModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).WarehouseModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'warehouse';
        request.generatedServiceName = 'DefaultWarehouseService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.WarehouseModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.WarehouseModel');
