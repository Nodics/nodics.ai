...
/**
 * @generated
 * @module generated/service/DefaultCmsRestrictionTypeService
 * @description Generated service for schema `cmsRestrictionType` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsRestrictionTypeModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsRestrictionTypeModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsRestrictionType';
        request.generatedServiceName = 'DefaultCmsRestrictionTypeService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsRestrictionTypeModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsRestrictionTypeModel');
