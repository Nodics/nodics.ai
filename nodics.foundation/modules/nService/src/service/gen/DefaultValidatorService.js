...
/**
 * @generated
 * @module generated/service/DefaultValidatorService
 * @description Generated service for schema `validator` owned by module `validator`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner validator
 * @schema validator
...
module.exports = {
    ...
    get: function (request) {
        let moduleName = request.moduleName || 'validator';
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ValidatorModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ValidatorModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'validator';
        request.generatedServiceName = 'DefaultValidatorService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ValidatorModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ValidatorModel');
