...
/**
 * @generated
 * @module generated/service/DefaultEventListenerService
 * @description Generated service for schema `eventListener` owned by module `system`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner system
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EventListenerModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EventListenerModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'eventListener';
        request.generatedServiceName = 'DefaultEventListenerService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EventListenerModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EventListenerModel');
