...
/**
 * @generated
 * @module generated/service/DefaultInterceptorService
 * @description Generated service for schema `interceptor` owned by module `system`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner system
 * @schema interceptor
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).InterceptorModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).InterceptorModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'interceptor';
        request.generatedServiceName = 'DefaultInterceptorService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.InterceptorModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.InterceptorModel');
