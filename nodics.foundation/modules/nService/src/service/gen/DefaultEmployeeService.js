...
/**
 * @generated
 * @module generated/service/DefaultEmployeeService
 * @description Generated service for schema `employee` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
 * @schema employee
 * @model EmployeeModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EmployeeModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EmployeeModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'employee';
        request.generatedServiceName = 'DefaultEmployeeService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EmployeeModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EmployeeModel');
