...
/**
 * @generated
 * @module generated/service/DefaultFulfillmentReturnService
 * @description Generated service for schema `fulfillmentReturn` owned by module `fulfillmentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).FulfillmentReturnModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).FulfillmentReturnModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'fulfillmentReturn';
        request.generatedServiceName = 'DefaultFulfillmentReturnService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.FulfillmentReturnModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.FulfillmentReturnModel');
