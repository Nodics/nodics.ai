...
/**
 * @generated
 * @module generated/service/DefaultEngagementDeliveryAttemptService
 * @description Generated service for schema `engagementDeliveryAttempt` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementDeliveryAttemptModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementDeliveryAttemptModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementDeliveryAttempt';
        request.generatedServiceName = 'DefaultEngagementDeliveryAttemptService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementDeliveryAttemptModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementDeliveryAttemptModel');
