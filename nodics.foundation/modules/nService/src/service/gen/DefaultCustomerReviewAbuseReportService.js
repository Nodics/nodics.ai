...
/**
 * @generated
 * @module generated/service/DefaultCustomerReviewAbuseReportService
 * @description Generated service for schema `customerReviewAbuseReport` owned by module `customerReview`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewAbuseReportModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerReviewAbuseReportModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerReviewAbuseReport';
        request.generatedServiceName = 'DefaultCustomerReviewAbuseReportService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerReviewAbuseReportModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerReviewAbuseReportModel');
