...
/**
 * @generated
 * @module generated/service/DefaultShipmentService
 * @description Generated service for schema `shipment` owned by module `fulfillmentCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ShipmentModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ShipmentModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'shipment';
        request.generatedServiceName = 'DefaultShipmentService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.ShipmentModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.ShipmentModel');
