...
/**
 * @generated
 * @module generated/service/DefaultCmsPublicationManifestService
 * @description Generated service for schema `cmsPublicationManifest` owned by module `cms`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner cms
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPublicationManifestModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CmsPublicationManifestModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'cmsPublicationManifest';
        request.generatedServiceName = 'DefaultCmsPublicationManifestService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CmsPublicationManifestModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CmsPublicationManifestModel');
