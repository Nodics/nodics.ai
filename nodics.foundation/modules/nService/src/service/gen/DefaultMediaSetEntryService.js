...
/**
 * @generated
 * @module generated/service/DefaultMediaSetEntryService
 * @description Generated service for schema `mediaSetEntry` owned by module `media`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner media
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaSetEntryModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).MediaSetEntryModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'mediaSetEntry';
        request.generatedServiceName = 'DefaultMediaSetEntryService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.MediaSetEntryModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.MediaSetEntryModel');
