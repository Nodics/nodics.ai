...
/**
 * @generated
 * @module generated/service/DefaultEngagementExportEvidenceService
 * @description Generated service for schema `engagementExportEvidence` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementExportEvidenceModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementExportEvidenceModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementExportEvidence';
        request.generatedServiceName = 'DefaultEngagementExportEvidenceService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementExportEvidenceModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementExportEvidenceModel');
