...
/**
 * @generated
 * @module generated/service/DefaultCommerceMigrationRecordService
 * @description Generated service for schema `commerceMigrationRecord` owned by module `checkoutCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner checkoutCore
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceMigrationRecordModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CommerceMigrationRecordModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'commerceMigrationRecord';
        request.generatedServiceName = 'DefaultCommerceMigrationRecordService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CommerceMigrationRecordModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CommerceMigrationRecordModel');
