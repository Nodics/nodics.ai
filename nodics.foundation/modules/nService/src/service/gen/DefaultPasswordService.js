...
/**
 * @generated
 * @module generated/service/DefaultPasswordService
 * @description Generated service for schema `password` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
 * @schema password
 * @model PasswordModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PasswordModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).PasswordModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'password';
        request.generatedServiceName = 'DefaultPasswordService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.PasswordModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.PasswordModel');
