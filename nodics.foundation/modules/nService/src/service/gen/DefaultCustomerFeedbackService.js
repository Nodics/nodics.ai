...
/**
 * @generated
 * @module generated/service/DefaultCustomerFeedbackService
 * @description Generated service for schema `customerFeedback` owned by module `customerFeedback`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).CustomerFeedbackModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'customerFeedback';
        request.generatedServiceName = 'DefaultCustomerFeedbackService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.CustomerFeedbackModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.CustomerFeedbackModel');
