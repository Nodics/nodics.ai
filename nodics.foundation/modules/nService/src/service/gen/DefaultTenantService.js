...
/**
 * @generated
 * @module generated/service/DefaultTenantService
 * @description Generated service for schema `tenant` owned by module `profile`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
 * @owner profile
 * @schema tenant
 * @model TenantModel
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TenantModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).TenantModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'tenant';
        request.generatedServiceName = 'DefaultTenantService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.TenantModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.TenantModel');
