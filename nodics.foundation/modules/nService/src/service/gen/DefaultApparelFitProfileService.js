...
/**
 * @generated
 * @module generated/service/DefaultApparelFitProfileService
 * @description Generated service for schema `apparelFitProfile` owned by module `apparelProduct`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).ApparelFitProfileModel;
