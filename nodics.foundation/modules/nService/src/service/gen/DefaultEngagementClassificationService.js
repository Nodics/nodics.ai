...
/**
 * @generated
 * @module generated/service/DefaultEngagementClassificationService
 * @description Generated service for schema `engagementClassification` owned by module `engagementCore`. This file is recreated by clean/build from the effective schema and common service template.
 * @layer service
...
module.exports = {
    ...
    get: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementClassificationModel;
    ...
    safeSearch: function (request) {
        ...
        request.schemaModel = NODICS.getModels(moduleName, request.tenant).EngagementClassificationModel;
        request.moduleName = moduleName;
        request.schemaName = request.schemaName || 'engagementClassification';
        request.generatedServiceName = 'DefaultEngagementClassificationService';
    ...
    remove: function (request) {
        ...
        request.schemaModel = models.EngagementClassificationModel;
        request.moduleName = moduleName;
        if (!request.schemaModel && SERVICE.DefaultLocalResetProviderService &&
            ...
            let error = new Error('Local reset skipped unavailable generated schema model: ' + moduleName + '.EngagementClassificationModel');
