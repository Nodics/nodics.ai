 ...
 * @layer service
 * @owner nCache/cache
 * @override Project modules may replace this policy service or override `cache.cacheability` properties to tune cache safety without changing Nodics foundation code.
 */
