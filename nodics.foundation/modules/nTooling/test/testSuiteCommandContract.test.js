...
assert(configuredSuites.tooling.some(step => step.node === 'nodics.foundation/modules/nTooling/test/testSuiteCommandContract.test.js'),
...
try {
    ...
    testSuiteCommandService.runSuite(context, {
        composed: [
            ...
            { node: 'nodics.foundation/modules/nTooling/test/sample.test.js', args: ['--dry-run'] },
    ...
    assert(spawned[2].args[0].endsWith('nodics.foundation/modules/nTooling/test/sample.test.js'),
