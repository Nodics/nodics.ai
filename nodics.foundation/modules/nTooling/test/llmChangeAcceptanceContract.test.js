...
requireClauses('modules/nSetup/llm/nodics-principles.md', [
...
requireClauses('modules/nSetup/llm/prompts/base-nodics-assistant-prompt.md', [
    ...
    'contracts/customer-project-mode-contract.md',
    'partners cannot edit framework or',
    'contribution/request and release channel',
    'modules/nSetup/llm/contracts/nodics-principles.md',
...
requireClauses('modules/nSetup/llm/contracts/human-maintainability-contract.md', [
    '# Human Maintainability Contract',
...
requireClauses('modules/nSetup/llm/contracts/nodics-expert-decision-contract.md', [
    '# Nodics Expert LLM Decision Contract',
...
requireClauses('modules/nSetup/llm/prompts/README.md', [
...
requireClauses('modules/nSetup/llm/prompts/review-prompt.md', [
...
requireClauses('modules/nSetup/llm/prompts/refactor-prompt.md', [
...
requireClauses('modules/nSetup/llm/prompts/testing-prompt.md', [
...
requireClauses('modules/nSetup/llm/prompts/schema-change-prompt.md', [
...
requireClauses('modules/nSetup/llm/prompts/runtime-governance-prompt.md', [
...
requireClauses('modules/nSetup/llm/standards/module-standard.md', [
...
requireClauses('modules/nSetup/llm/contracts/integration-governance-contract.md', [
...
requireClauses('modules/nSetup/llm/contracts/developer-implementation-contract.md', [
...
requireClauses('modules/nSetup/llm/contracts/module-structure-contract.md', [
...
requireClauses('modules/nSetup/llm/ai-enablement-index.md', [
    ...
    'separate contribution/request',
    'explicitly authorized Nodics task',
...
requireClauses('modules/nSetup/llm/standards/nodics-structure-matrix.md', [
