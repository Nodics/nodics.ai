...
try {
    ...
    createModule(projectHome, 'documentationOwner', 'documentationOwner', 'capability', ['configuration', 'documentation', 'llm']);
    write(path.join(projectHome, 'documentationOwner/docs/catalogue.json'), '{"documents":[]}\n');
    const documentationOwnerReport = structureComplianceQualityService.collectReport({
        rootDir: projectHome,
        includeInfo: false
    });
