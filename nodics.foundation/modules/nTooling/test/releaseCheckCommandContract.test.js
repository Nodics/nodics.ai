...
assert(generatedSuite.some(step => step.node === 'nodics.foundation/modules/nTest/test/generatedTestRunnerLifecycleContract.test.js'),
    'Generated suite must prove missing generated artifacts fail instead of passing');
assert(generatedSuite.findIndex(step => step.node === 'nodics.foundation/modules/nTest/test/generatedTestRunnerLifecycleContract.test.js')
