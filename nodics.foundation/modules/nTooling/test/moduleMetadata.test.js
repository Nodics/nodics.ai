...
const modernizedDescriptions = {
    ...
    'nodics.foundation/modules/nTest': ['Nodics testing module', 'suite reporting', 'report ownership'],
    'nodics.foundation/modules/nTooling': ['Non-runtime Nodics development', 'quality', 'command tooling']
};
