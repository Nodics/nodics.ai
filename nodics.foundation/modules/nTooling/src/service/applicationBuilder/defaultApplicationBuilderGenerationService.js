...
module.exports = {
    ...
    renderFile: function (relativePath, solution, plan, catalogue) {
        ...
        if (relativePath === 'package.json') {
            return JSON.stringify({ name: projectCode, version: '0.0.1', private: true,
                scripts: {
        ...
        if (relativePath === 'backend/package.json' || relativePath === 'storefront/package.json') {
            ...
            return JSON.stringify({ name: projectCode + '-' + area, version: '0.0.1', private: true,
    ...
    generate: function (plan, solution, catalogue, configuredRoot, options = {}) {
        ...
        try {
            ...
            const lock = {
                ...
                templates: [{ code: 'builder.minimal', version: '0.1.0',
                ...
                dataPacks: solution.data.packs.slice().sort().map(code => ({ code: code, version: '0.0.1',
