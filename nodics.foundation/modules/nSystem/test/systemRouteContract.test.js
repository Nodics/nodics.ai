...
const expectedRoutes = [
    ...
    { key: '/internal/content-packs/:packCode', method: 'GET', controller: 'DefaultContentPackController', operation: 'getStatus', secured: true, permissionConfig: 'authSecurity.internalToken.routePermission' },
    { key: '/internal/content-packs/:packCode/imports', method: 'POST', controller: 'DefaultContentPackController', operation: 'importPack', secured: true, permissionConfig: 'authSecurity.internalToken.routePermission' },
    ...
    { key: '/config/runtime/schema', method: 'GET', controller: 'DefaultConfigurationController', operation: 'listRuntimeConfigurationSchemas', secured: true, permission: 'runtime.config.schema.view' },
    { key: '/config/runtime/schema/:schemaCode', method: 'GET', controller: 'DefaultConfigurationController', operation: 'getRuntimeConfigurationSchema', secured: true, permission: 'runtime.config.schema.view' },
    { key: '/config/runtime/schema/:schemaCode/effective', method: 'GET', controller: 'DefaultConfigurationController', operation: 'getRuntimeConfigurationEffectiveValues', secured: true, permission: 'runtime.config.effective.view' },
    { key: '/config/runtime/schema/:schemaCode/validate', method: 'POST', controller: 'DefaultConfigurationController', operation: 'validateRuntimeConfigurationUpdate', secured: true, permission: 'runtime.config.validate' },
    { key: '/config/runtime/schema/:schemaCode', method: 'POST', controller: 'DefaultConfigurationController', operation: 'saveRuntimeConfigurationUpdate', secured: true, permission: 'runtime.config.update' },
