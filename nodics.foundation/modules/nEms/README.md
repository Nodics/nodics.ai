...
node nodics.foundation/modules/nEms/emsClient/test/activeEmsPublisher.test.js
node nodics.foundation/modules/nEms/kafka/test/kafkaPublishCapabilityBehavior.test.js
