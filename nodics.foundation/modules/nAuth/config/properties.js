...
module.exports = {
  ...
  identityGovernance: {
    ...
    permissionCatalog: [
      ...
      "media.publication.artifact.manage",
      "media.folder.policy.manage",
      "media.format.policy.manage",
      "media.set.manage",
      "media.reference.lifecycle.manage",
    ...
    migration: {
      ...
      groupTargets: {
        commerceMerchantUserGroup: {
          parentGroups: ["axisOperationalUserGroup"],
          permissions: [
            "commerce.backoffice.view",
            "commerce.coupon.pos.redeem",
            "profile.scope.read",
