...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultEngagementDashboardSnapshotService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultEngagementDashboardSnapshotService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultEngagementDashboardSnapshotService.deleteImpact(request);
    },
