...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultContactRequestService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultContactRequestService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultContactRequestService.deleteImpact(request);
    },
