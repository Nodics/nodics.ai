...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultEventListenerService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultEventListenerService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultEventListenerService.deleteImpact(request);
    },
