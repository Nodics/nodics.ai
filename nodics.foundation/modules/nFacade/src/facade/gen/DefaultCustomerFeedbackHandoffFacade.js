...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultCustomerFeedbackHandoffService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultCustomerFeedbackHandoffService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultCustomerFeedbackHandoffService.deleteImpact(request);
    },
