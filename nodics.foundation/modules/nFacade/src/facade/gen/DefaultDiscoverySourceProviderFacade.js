...
/**
 * @generated
 * @module generated/facade/DefaultDiscoverySourceProviderFacade
 * @description Generated facade for schema `discoverySourceProvider` owned by module `discoverySource`. This file is recreated by clean/build from the effective schema and common facade template.
 * @layer facade
...
module.exports = {
    ...
    get: function (request) {
        return SERVICE.DefaultDiscoverySourceProviderService.get(request);
    },
    safeSearch: function (request) {
        return SERVICE.DefaultDiscoverySourceProviderService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultDiscoverySourceProviderService.capabilities(request);
    },
    getById: function (id, tenant) {
        return SERVICE.DefaultDiscoverySourceProviderService.getById(id, tenant);
    },
    getByCode: function (code, tenant) {
        return SERVICE.DefaultDiscoverySourceProviderService.getByCode(code, tenant);
    },
    save: function (request) {
        return SERVICE.DefaultDiscoverySourceProviderService.save(request);
    },
    saveAll: function (request) {
        return SERVICE.DefaultDiscoverySourceProviderService.saveAll(request);
    },
    remove: function (request) {
        return SERVICE.DefaultDiscoverySourceProviderService.remove(request);
    },
    deleteImpact: function (request) {
        return SERVICE.DefaultDiscoverySourceProviderService.deleteImpact(request);
    },
