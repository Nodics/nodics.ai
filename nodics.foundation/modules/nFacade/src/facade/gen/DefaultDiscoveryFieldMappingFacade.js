...
/**
 * @generated
 * @module generated/facade/DefaultDiscoveryFieldMappingFacade
 * @description Generated facade for schema `discoveryFieldMapping` owned by module `discoveryMapping`. This file is recreated by clean/build from the effective schema and common facade template.
 * @layer facade
...
module.exports = {
    ...
    get: function (request) {
        return SERVICE.DefaultDiscoveryFieldMappingService.get(request);
    },
    safeSearch: function (request) {
        return SERVICE.DefaultDiscoveryFieldMappingService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultDiscoveryFieldMappingService.capabilities(request);
    },
    getById: function (id, tenant) {
        return SERVICE.DefaultDiscoveryFieldMappingService.getById(id, tenant);
    },
    getByCode: function (code, tenant) {
        return SERVICE.DefaultDiscoveryFieldMappingService.getByCode(code, tenant);
    },
    save: function (request) {
        return SERVICE.DefaultDiscoveryFieldMappingService.save(request);
    },
    saveAll: function (request) {
        return SERVICE.DefaultDiscoveryFieldMappingService.saveAll(request);
    },
    remove: function (request) {
        return SERVICE.DefaultDiscoveryFieldMappingService.remove(request);
    },
    deleteImpact: function (request) {
        return SERVICE.DefaultDiscoveryFieldMappingService.deleteImpact(request);
    },
