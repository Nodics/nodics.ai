...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultCartService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultCartService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultCartService.deleteImpact(request);
    },
