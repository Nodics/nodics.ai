...
/**
 * @generated
 * @module generated/facade/DefaultInventoryMovementFacade
 * @description Generated facade for schema `inventoryMovement` owned by module `inventory`. This file is recreated by clean/build from the effective schema and common facade template.
 * @layer facade
 * @owner inventory
...
module.exports = {
    ...
    getByCode: function (code, tenant) {
        return SERVICE.DefaultInventoryMovementService.getByCode(code, tenant);
    },
    save: function (request) {
        return SERVICE.DefaultInventoryMovementService.save(request);
    },
    saveAll: function (request) {
        return SERVICE.DefaultInventoryMovementService.saveAll(request);
    },
