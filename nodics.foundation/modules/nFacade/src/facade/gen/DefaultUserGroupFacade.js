...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultUserGroupService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultUserGroupService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultUserGroupService.deleteImpact(request);
    },
