...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultEngagementDeliveryAttemptService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultEngagementDeliveryAttemptService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultEngagementDeliveryAttemptService.deleteImpact(request);
    },
