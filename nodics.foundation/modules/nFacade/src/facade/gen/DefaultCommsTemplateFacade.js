...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultCommsTemplateService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultCommsTemplateService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultCommsTemplateService.deleteImpact(request);
    },
