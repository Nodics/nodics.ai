...
/**
 * @generated
 * @module generated/facade/DefaultInventoryReservationFacade
 * @description Generated facade for schema `inventoryReservation` owned by module `inventory`. This file is recreated by clean/build from the effective schema and common facade template.
 * @layer facade
 * @owner inventory
...
module.exports = {
    ...
    getByCode: function (code, tenant) {
        return SERVICE.DefaultInventoryReservationService.getByCode(code, tenant);
    },
    save: function (request) {
        return SERVICE.DefaultInventoryReservationService.save(request);
    },
    saveAll: function (request) {
        return SERVICE.DefaultInventoryReservationService.saveAll(request);
    },
