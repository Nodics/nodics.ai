...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultCustomerReviewProjectionService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultCustomerReviewProjectionService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultCustomerReviewProjectionService.deleteImpact(request);
    },
