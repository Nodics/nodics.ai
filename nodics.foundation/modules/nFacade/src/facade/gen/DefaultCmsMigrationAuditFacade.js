...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultCmsMigrationAuditService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultCmsMigrationAuditService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultCmsMigrationAuditService.deleteImpact(request);
    },
