...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultEditorialArticleTaxonomyService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultEditorialArticleTaxonomyService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultEditorialArticleTaxonomyService.deleteImpact(request);
    },
