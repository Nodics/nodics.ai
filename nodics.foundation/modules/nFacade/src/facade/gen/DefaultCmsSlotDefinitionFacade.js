...
/**
 * @generated
 * @module generated/facade/DefaultCmsSlotDefinitionFacade
 * @description Generated facade for schema `cmsSlotDefinition` owned by module `cms`. This file is recreated by clean/build from the effective schema and common facade template.
 * @layer facade
 * @owner cms
...
module.exports = {
    ...
    getByCode: function (code, tenant) {
        return SERVICE.DefaultCmsSlotDefinitionService.getByCode(code, tenant);
    },
    save: function (request) {
        return SERVICE.DefaultCmsSlotDefinitionService.save(request);
    },
    saveAll: function (request) {
        return SERVICE.DefaultCmsSlotDefinitionService.saveAll(request);
    },
