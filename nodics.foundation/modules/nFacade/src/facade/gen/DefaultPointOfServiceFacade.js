...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultPointOfServiceService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultPointOfServiceService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultPointOfServiceService.deleteImpact(request);
    },
