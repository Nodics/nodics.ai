...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultProductSearchProjectionService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultProductSearchProjectionService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultProductSearchProjectionService.deleteImpact(request);
    },
