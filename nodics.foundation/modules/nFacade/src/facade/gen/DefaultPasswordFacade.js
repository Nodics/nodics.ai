...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultPasswordService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultPasswordService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultPasswordService.deleteImpact(request);
    },
