...
module.exports = {
    ...
    safeSearch: function (request) {
        return SERVICE.DefaultCmsComponentLocalizationService.safeSearch(request);
    },
    capabilities: function (request) {
        return SERVICE.DefaultCmsComponentLocalizationService.capabilities(request);
    },
    ...
    deleteImpact: function (request) {
        return SERVICE.DefaultCmsComponentLocalizationService.deleteImpact(request);
    },
