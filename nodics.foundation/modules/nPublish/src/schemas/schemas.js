        ...
        publicationRequest: {
            ...
            definition: {
                ...
                state: {
                    ...
                    required: true,
                    default: 'STAGED',
                    description: 'Governed generic publication state',
                },
                revision: {
                    type: 'int',
                    required: true,
                ...
                auditTrail: {
                    ...
                    default: [],
                    description:
                        'Authoritative immutable transition journal updated atomically with lifecycle state',
                },
                dependencies: {
                    type: 'array',
                    required: false,
                    description: 'Bounded adapter-resolved dependency identities',
                },
                mediaCodes: {
                    type: 'array',
                    required: false,
                    description:
                        'Additional media identities that must move with the governed publication even when they are not directly present in the root content graph',
                },
                validation: {
                    type: 'object',
                    required: false,
                    description: 'Sanitized domain validation result',
                },
                workflowRef: {
                    type: 'string',
                    required: false,
                    description: 'Existing workflow authority reference',
                },
                previousOnlineVersion: {
                    type: 'string',
                    required: false,
                    description: 'Rollback target captured before activation',
                },
                recoveryFromState: {
                    type: 'string',
                    required: false,
                    description: 'Terminal state that initiated the current governed recovery attempt',
                },
                requestedBy: {
                    type: 'string',
                    required: false,
        ...
        publicationAudit: {
            ...
            definition: {
                ...
                fromState: {
                    type: 'string',
                    required: false,
                    description: 'Stores the from state value used by this record.',
                },
                toState: {
                    type: 'string',
                    required: true,
                    description: 'Stores the to state value used by this record.',
                },
                revision: {
                    type: 'int',
                    required: true,
                ...
                actor: {
                    type: 'string',
                    required: false,
                    description: 'Stores the actor value used by this record.',
                },
                reason: {
                    type: 'string',
                    required: false,
                ...
                details: {
                    ...
                    required: false,
                    description:
                        'Sanitized projection of authoritative transition evidence without content payloads or secrets',
                },
                correlationId: {
                    type: 'string',
                    required: false,
