...
module.exports = {
    ...
    doRefresh: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doRefresh(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doRefresh(request);
        }
    },
    doCheckHealth: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doCheckHealth(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doCheckHealth(request);
        }
    },
    doExists: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doExists(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doExists(request);
        }
    },
    doGet: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doGet(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doGet(request);
        }
    },
    doSearch: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doSearch(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doSearch(request);
        }
    },
    doSave: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doSave(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doSave(request);
        }
    },
    doBulk: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doBulk(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doBulk(request);
        }
    },
    doRemove: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doRemove(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doRemove(request);
        }
    },
    doRemoveByQuery: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doRemoveByQuery(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doRemoveByQuery(request);
        }
    },
    doGetSchema: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doGetSchema(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doGetSchema(request);
        }
    },
    doUpdateSchema: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doUpdateSchema(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doUpdateSchema(request);
        }
    },
    doRemoveIndex: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doRemoveIndex(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doRemoveIndex(request);
        }
    },
    doIndexing: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultContactHandoffFacade.doIndexing(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultContactHandoffFacade.doIndexing(request);
        }
    }
};