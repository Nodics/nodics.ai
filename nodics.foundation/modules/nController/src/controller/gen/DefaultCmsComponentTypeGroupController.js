...
module.exports = {
    ...
    doRefresh: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doRefresh(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doRefresh(request);
        }
    },
    doCheckHealth: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doCheckHealth(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doCheckHealth(request);
        }
    },
    doExists: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doExists(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doExists(request);
        }
    },
    doGet: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doGet(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doGet(request);
        }
    },
    doSearch: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doSearch(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doSearch(request);
        }
    },
    doSave: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doSave(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doSave(request);
        }
    },
    doBulk: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doBulk(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doBulk(request);
        }
    },
    doRemove: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doRemove(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doRemove(request);
        }
    },
    doRemoveByQuery: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doRemoveByQuery(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doRemoveByQuery(request);
        }
    },
    doGetSchema: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doGetSchema(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doGetSchema(request);
        }
    },
    doUpdateSchema: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doUpdateSchema(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doUpdateSchema(request);
        }
    },
    doRemoveIndex: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doRemoveIndex(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doRemoveIndex(request);
        }
    },
    doIndexing: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCmsComponentTypeGroupFacade.doIndexing(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCmsComponentTypeGroupFacade.doIndexing(request);
        }
    }
};