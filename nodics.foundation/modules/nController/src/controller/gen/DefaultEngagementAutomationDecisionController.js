...
module.exports = {
    ...
    doRefresh: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doRefresh(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doRefresh(request);
        }
    },
    doCheckHealth: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doCheckHealth(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doCheckHealth(request);
        }
    },
    doExists: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doExists(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doExists(request);
        }
    },
    doGet: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doGet(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doGet(request);
        }
    },
    doSearch: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doSearch(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doSearch(request);
        }
    },
    doSave: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doSave(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doSave(request);
        }
    },
    doBulk: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doBulk(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doBulk(request);
        }
    },
    doRemove: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doRemove(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doRemove(request);
        }
    },
    doRemoveByQuery: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doRemoveByQuery(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doRemoveByQuery(request);
        }
    },
    doGetSchema: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doGetSchema(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doGetSchema(request);
        }
    },
    doUpdateSchema: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doUpdateSchema(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doUpdateSchema(request);
        }
    },
    doRemoveIndex: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doRemoveIndex(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doRemoveIndex(request);
        }
    },
    doIndexing: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultEngagementAutomationDecisionFacade.doIndexing(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultEngagementAutomationDecisionFacade.doIndexing(request);
        }
    }
};