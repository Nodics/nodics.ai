...
module.exports = {
    ...
    doRefresh: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doRefresh(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doRefresh(request);
        }
    },
    doCheckHealth: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doCheckHealth(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doCheckHealth(request);
        }
    },
    doExists: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doExists(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doExists(request);
        }
    },
    doGet: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doGet(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doGet(request);
        }
    },
    doSearch: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doSearch(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doSearch(request);
        }
    },
    doSave: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doSave(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doSave(request);
        }
    },
    doBulk: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doBulk(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doBulk(request);
        }
    },
    doRemove: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doRemove(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doRemove(request);
        }
    },
    doRemoveByQuery: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doRemoveByQuery(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doRemoveByQuery(request);
        }
    },
    doGetSchema: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doGetSchema(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doGetSchema(request);
        }
    },
    doUpdateSchema: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doUpdateSchema(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doUpdateSchema(request);
        }
    },
    doRemoveIndex: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doRemoveIndex(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doRemoveIndex(request);
        }
    },
    doIndexing: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultCheckoutCheckpointFacade.doIndexing(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultCheckoutCheckpointFacade.doIndexing(request);
        }
    }
};