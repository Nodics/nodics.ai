...
module.exports = {
    ...
    doRefresh: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doRefresh(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doRefresh(request);
        }
    },
    doCheckHealth: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doCheckHealth(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doCheckHealth(request);
        }
    },
    doExists: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doExists(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doExists(request);
        }
    },
    doGet: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doGet(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doGet(request);
        }
    },
    doSearch: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doSearch(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doSearch(request);
        }
    },
    doSave: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doSave(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doSave(request);
        }
    },
    doBulk: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doBulk(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doBulk(request);
        }
    },
    doRemove: function (request, callback) {
        ...
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doRemove(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doRemove(request);
        }
    },
    doRemoveByQuery: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doRemoveByQuery(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doRemoveByQuery(request);
        }
    },
    doGetSchema: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doGetSchema(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doGetSchema(request);
        }
    },
    doUpdateSchema: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doUpdateSchema(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doUpdateSchema(request);
        }
    },
    doRemoveIndex: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doRemoveIndex(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doRemoveIndex(request);
        }
    },
    doIndexing: function (request, callback) {
        ...
        request = _.merge(request, request.httpRequest.body || {});
        if (callback) {
            FACADE.DefaultSalesChannelFacade.doIndexing(request).then(success => {
                callback(null, success);
            }).catch(error => {
                callback(error);
            });
        } else {
            return FACADE.DefaultSalesChannelFacade.doIndexing(request);
        }
    }
};