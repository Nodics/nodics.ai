...
module.exports = {
    ...
    activateRouters: function (moduleRouter, moduleObject, moduleName, routers) {
        ...
        if (!UTILS.isBlank(routers.common)) {
            _.each(routers.common, function (group, groupName) {
                if (groupName !== 'options' && _self.isCommonRouterGroupEnabled(group, moduleName)) {
    ...
    /** Returns whether one common router group is intentionally exposed by the current module. */
    isCommonRouterGroupEnabled: function (group, moduleName) {
