...
`nodics.foundation` is the reusable platform foundation underneath a Nodics
...
They should not add customer-specific behavior directly to `nodics.foundation`.

`nodics.foundation` composes the core Nodics capability modules and coordinates their
...
`nodics.foundation` is a group module. It should coordinate framework capability modules, not own project behavior directly.
