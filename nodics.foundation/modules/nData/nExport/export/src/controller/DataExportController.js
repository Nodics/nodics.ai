...
/**
 * @module nodics.foundation/modules/nData/nExport/export/src/controller/DataExportController
 * @description Exposes request handlers for nExport data export orchestration operations.
 * @layer controller
 * @owner nExport
 * @override Project modules may override export orchestration through later active modules while preserving media-owned generated-file delivery.
 */
module.exports = {
