...
/**
 * @module nodics.foundation/modules/nData/nImport/import/test/profileTenantLocalFileImportContract
...
async function prepareLocalImport() {
    let rootPath = path.join(process.cwd(), 'nodics.platform', 'modules', 'profile', 'data', 'sample-v001', 'tenant');
    let request = {
        inputPath: {
            rootPath: rootPath
        },
