...
assert.strictEqual(routes.dataReleases.initializationProfiles.key, '/initialization-profiles');
assert.strictEqual(routes.dataReleases.initializationProfiles.permission, 'import.release.view');
assert.deepStrictEqual(routes.dataReleases.initializationProfiles.permissions, ['import.core.run']);
assert.strictEqual(routes.dataReleases.initializationProfile.key, '/initialization-profiles/:profileCode');
assert.strictEqual(routes.dataReleases.initializationProfile.permission, 'import.release.view');
assert.deepStrictEqual(routes.dataReleases.initializationProfile.permissions, ['import.core.run']);
assert.strictEqual(routes.dataReleases.validateInitializationProfile.key, '/initialization-profiles/:profileCode/validate');
assert.strictEqual(routes.dataReleases.validateInitializationProfile.permission, 'import.release.validate');
assert.deepStrictEqual(routes.dataReleases.validateInitializationProfile.permissions, ['import.core.run']);
assert.strictEqual(routes.dataReleases.installInitializationProfile.key, '/initialization-profiles/:profileCode/install');
assert.strictEqual(routes.dataReleases.installInitializationProfile.permission, 'import.core.run');
