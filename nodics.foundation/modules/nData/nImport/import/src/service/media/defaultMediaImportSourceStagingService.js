...
/**
 * @module nodics.foundation/modules/nData/nImport/import/src/service/media/defaultMediaImportSourceStagingService
 * @description Stages media-owned import files into nImport-owned run workspaces.
 * @layer service
 * @owner import
 * @override Later import definition services may call this staging primitive while preserving media storage authority and nImport execution authority.
 */
module.exports = {
