# Nodics Foundation Agent Contract

- Start from `../AGENTS.md` for repository-wide framework boundaries, then use
  this file for Foundation-specific behavior.
- Required Reading Order: read root `README.md`, root `AGENTS.md`, this Foundation
...
- Runtime modules in this repository provide reusable framework behavior to
  product runtimes; product business behavior remains outside Foundation.
