...
module.exports = {
    /** Hashes a challenge secret with its per-record salt. */ hash: function (secret, salt) { return crypto.createHash('sha256').update(String(salt) + ':' + String(secret)).digest('hex'); },
