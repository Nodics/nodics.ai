...
/** @module commsCore/data/sample-v001/communication/commsSampleTemplateVersionData @description Provides optional versioned sample Communication template bodies. @layer data @owner commsCore */
module.exports = {
    record0: {
