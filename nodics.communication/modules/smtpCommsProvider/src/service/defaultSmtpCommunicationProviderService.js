...
'use strict';
/** @module smtpCommsProvider/src/service/defaultSmtpCommunicationProviderService @description Sends email through an injected sandbox HTTP transport without exposing credentials or content in returned evidence. @layer service @owner smtpCommsProvider */
module.exports = {
    code: 'smtp-sandbox',
