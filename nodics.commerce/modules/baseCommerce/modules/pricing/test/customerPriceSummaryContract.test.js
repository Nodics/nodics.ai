...
const books = [
    { code: 'retailUsd', tenant: 'default', currency: 'USD', status: 'ACTIVE' },
    { code: 'otherUsd', tenant: 'other', currency: 'USD', status: 'ACTIVE' }
];
const rows = [
    { code: 'dressBase', tenant: 'default', priceBookCode: 'retailUsd', productCode: 'agoraDress', unitAmount: '129.00', currency: 'USD', minQuantity: '1' },
    { code: 'dressBulk', tenant: 'default', priceBookCode: 'retailUsd', productCode: 'agoraDress', unitAmount: '119.00', currency: 'USD', minQuantity: '5' },
    { code: 'otherTenantDress', tenant: 'other', priceBookCode: 'otherUsd', productCode: 'agoraDress', unitAmount: '1.00', currency: 'USD', minQuantity: '1' }
];
let bookRequests;
let rowRequests;
