...
module.exports = {
    ...
    getCapability: function () { let d=SERVICE.DefaultBackofficeCapabilityDefinitionService; return d.capability({ capabilityId:'commerce-pricing',displayName:'Prices',category:'commerce',icon:'commerce',navigation:[d.workbench({id:'prices',parentId:'catalog-and-products',parentModuleName:'product',label:'Prices',route:'/commerce/catalog/prices',moduleName:'pricing',schemaName:'priceRow',order:130,permission:'commerce.pricing.read',summary:'Inspect exact price rows and replayable Pricing decisions.',presentation:{defaultColumns:['code','priceBookCode','productCode','unitAmount','currency','minQuantity','validFrom','validTo','revision']}})]}); }
};
