...
module.exports = {
    ...
    getCapability: function () {
        ...
        return d.capability({ capabilityId: 'commerce-search', displayName: 'Commerce Search', category: 'commerce', icon: 'search', navigation: [
            d.workbench({ id: 'commerce-search', parentId: 'catalog-and-products', parentModuleName: 'product', label: 'Commerce Search', route: '/commerce/search', moduleName: 'commerceSearchCore', schemaName: 'commerceSearchRule', order: 150, permission: 'commerce.search.read', summary: 'Manage business search ranking rules for product discovery.', presentation: { defaultColumns: ['code', 'name', 'storeCode', 'locale', 'scopeType', 'status', 'priority', 'revision'] } }),
