...
/** @module shoppingList/src/facade/defaultShoppingListCustomerFacade @description Enforces customer ownership context for wishlist and compare APIs. @layer facade @owner shoppingList */
module.exports = {
    /**
     ...
     * @override Later-loaded modules may replace this member through the standard merge contract.
     */
    read: function (request) { return Promise.resolve().then(() => SERVICE.DefaultShoppingListOperationService.read(this.applyContext(request))); },
    /**
     ...
     * @override Later-loaded modules may replace this member through the standard merge contract.
     */
    addEntry: function (request) { return Promise.resolve().then(() => SERVICE.DefaultShoppingListOperationService.addEntry(this.applyContext(request))); },
    /**
     ...
     * @override Later-loaded modules may replace this member through the standard merge contract.
     */
    removeEntry: function (request) { return Promise.resolve().then(() => SERVICE.DefaultShoppingListOperationService.removeEntry(this.applyContext(request))); },
    /**
     ...
     * @override Later-loaded modules may replace this member through the standard merge contract.
     */
    clear: function (request) { return Promise.resolve().then(() => SERVICE.DefaultShoppingListOperationService.clear(this.applyContext(request))); }
};
