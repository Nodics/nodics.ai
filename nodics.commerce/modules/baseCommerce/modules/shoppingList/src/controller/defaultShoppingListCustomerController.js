...
/** @module shoppingList/src/controller/defaultShoppingListCustomerController @description Maps Shopping List HTTP inputs to the secured facade. @layer controller @owner shoppingList */
module.exports = {
    /**
    ...
    invoke: function (operation, request, callback) {
        const promise = FACADE.DefaultShoppingListCustomerFacade[operation](this.applyHttp(request)).then(data => ({ data }));
