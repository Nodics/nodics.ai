...
/** @module product/data/sample-v001/sampleProductLocalizationData @description English and Arabic content for one Product identity. @layer data @owner product @override Projects supply later catalogue releases. */
module.exports = {
    record0: {
