...
/**
 * @module product/controller/defaultProductDiscoveryApiController
...
module.exports = {
    ...
    list: function (request, callback) {
        ...
        let operation = FACADE.DefaultProductDiscoveryApiFacade.list(request).then(data => ({ data: data }));
    ...
    detail: function (request, callback) {
        ...
        request.query = Object.assign({}, request.query || {}, http.query || {});
        let operation = FACADE.DefaultProductDiscoveryApiFacade.detail(request).then(data => ({ data: data }));
        if (!callback) return operation;
        operation.then(success => callback(null, success)).catch(error => callback(error));
    }
};
