...
module.exports = {
    ...
    getCapability: function () {
        ...
        let item = (id, parentId, label, route, schemaName, order, summary, presentation, featureState) => definitions.workbench({
            ...
            group: id === 'catalog-and-products' ? { id: 'products-merchandising', label: 'Products and Merchandising', order: 500 } : undefined
        });
        ...
        return definitions.capability({ capabilityId: 'commerce-product', displayName: 'Catalog & Products', category: 'commerce', icon: 'commerce', navigation: [
            item('catalog-and-products', undefined, 'Product Workspace', '/commerce/catalog', 'product', 500, 'Review all products, create products, attention states, review readiness, publishing readiness, published products, and archived products.', { defaultColumns: ['code', 'name', 'status', 'catalogVersion', 'revision'] }),
            ...
            node('categories-classification', 'Categories and Classification', 520, 'Manage categories, assignments, classification, attributes, groups, variant definitions, units, and allowed values.'),
            node('catalogs-assortments', 'Catalogs and Assortments', 530, 'Manage product catalogs, versions, assortments, categories, assignments, stores, channels, and previews.'),
            ...
            node('product-readiness', 'Product Readiness', 560, 'Review completeness, missing category/price/tax/media/localization/assortment/search/publication readiness.'),
            item('products', 'product-information', 'Products', '/commerce/catalog/products', 'product', 511, 'Manage product identity, variants, categories, and staged publication.', { defaultColumns: ['code', 'name', 'status', 'catalogVersion', 'revision'] }),
