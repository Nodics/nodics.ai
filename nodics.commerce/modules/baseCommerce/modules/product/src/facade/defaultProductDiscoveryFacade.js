...
/**
 * @module product/facade/defaultProductDiscoveryFacade
...
module.exports = {
    ...
    list: function (request) {
        return Promise.resolve().then(() => SERVICE.DefaultProductDiscoveryService.list(this.applyContext(request)));
    },
    ...
    detail: function (request) {
        return Promise.resolve().then(() => SERVICE.DefaultProductDiscoveryService.detail(this.applyContext(request)));
    }
};
