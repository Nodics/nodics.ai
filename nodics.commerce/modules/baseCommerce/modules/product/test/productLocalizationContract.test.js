...
const sampleProductLocalizations = require('../data/sample/data/product/sampleProductLocalizationData');
const sampleCategories = require('../data/sample/data/product/sampleCategoryData');
const sampleCategoryLocalizations = require('../data/sample/data/product/sampleCategoryLocalizationData');
const sampleVariants = require('../data/sample/data/product/sampleProductVariantData');
const sampleVariantLocalizations = require('../data/sample/data/product/sampleProductVariantLocalizationData');
const sampleHeader = require('../data/sample/headers/product/sampleProductLocalizationDataHeader');
