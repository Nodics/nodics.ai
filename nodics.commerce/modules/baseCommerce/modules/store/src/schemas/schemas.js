...
module.exports = { store: {
    store: Object.assign({ super: 'base', model: true, schemaPolicies: ['tenantOwned'], service: { enabled: true }, router: { enabled: false }, cache: { enabled: false }, event: { enabled: false }, search: { enabled: false } }, { definition: { code: { type: 'string', required: true }, tenant: { type: 'string', required: true }, name: { type: 'string', required: true }, status: { type: 'string', required: true, enum: ['ACTIVE', 'INACTIVE'] }, defaultCurrency: { type: 'string', required: true }, defaultLocale: { type: 'string', required: true }, timezone: { type: 'string', required: true }, enterpriseRef: { type: 'object', required: false }, primaryLocationRef: { type: 'object', required: false }, revision: { type: 'int', required: true } } }),
    salesChannel: Object.assign({ super: 'base', model: true, schemaPolicies: ['tenantOwned'], service: { enabled: true }, router: { enabled: false }, cache: { enabled: false }, event: { enabled: false }, search: { enabled: false } }, { definition: { code: { type: 'string', required: true }, tenant: { type: 'string', required: true }, storeCode: { type: 'string', required: true }, name: { type: 'string', required: true }, channelType: { type: 'string', required: true, enum: ['WEB', 'MOBILE', 'MARKETPLACE', 'POS'] }, status: { type: 'string', required: true, enum: ['ACTIVE', 'INACTIVE'] }, enterpriseRef: { type: 'object', required: false }, locationRef: { type: 'object', required: false }, revision: { type: 'int', required: true } } }),
    pointOfService: Object.assign({ super: 'base', model: true, schemaPolicies: ['tenantOwned'], service: { enabled: true }, router: { enabled: false }, cache: { enabled: false }, event: { enabled: false }, search: { enabled: false } }, { definition: { code: { type: 'string', required: true }, tenant: { type: 'string', required: true }, storeCode: { type: 'string', required: true }, name: { type: 'string', required: true }, status: { type: 'string', required: true, enum: ['ACTIVE', 'INACTIVE'] }, timezone: { type: 'string', required: true }, operatorEnterpriseRef: { type: 'object', required: false }, locationRef: { type: 'object', required: true }, revision: { type: 'int', required: true } } })
} };
