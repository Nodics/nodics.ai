...
module.exports = {
    ...
    getCapability: function () { let d = SERVICE.DefaultBackofficeCapabilityDefinitionService; return d.capability({ capabilityId: 'commerce-store', displayName: 'Stores & Channels', category: 'commerce', icon: 'commerce', navigation: [d.workbench({ id: 'stores', parentId: 'catalog-and-products', parentModuleName: 'product', label: 'Stores & Channels', route: '/commerce/catalog/stores', moduleName: 'store', schemaName: 'store', order: 110, permission: 'commerce.store.read', summary: 'Review tenant selling contexts, channels, locale, currency, and activation.', presentation: { defaultColumns: ['code', 'name', 'status', 'defaultCurrency', 'defaultLocale', 'timezone', 'revision'] } })] }); }
};
