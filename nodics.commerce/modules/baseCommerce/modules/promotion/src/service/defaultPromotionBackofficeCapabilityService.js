        ...
        return d.capability({
            ...
            navigation: [
                ...
                d.workbench({
                    ...
                    lifecycleActions: [
                        { id: 'promotion-save-draft', label: 'Save draft', intent: 'UPDATE', permission: 'commerce.promotion.manage', ownerModule: 'promotion', handlerAction: 'saveDraft', operationRoute: '/promotions/drafts/:promotionCode', httpMethod: 'PATCH', inputFields: [promotionCodeInput], featureState: 'ACTIVE', order: 10 },
                        { id: 'promotion-submit', label: 'Submit promotion', intent: 'SUBMIT', permission: 'commerce.promotion.manage', ownerModule: 'promotion', handlerAction: 'submitPromotion', operationRoute: '/promotions/:promotionCode/submit', httpMethod: 'POST', inputFields: [promotionCodeInput, { name: 'conflictCheck', label: 'Conflict check', type: 'SELECT', required: true, options: ['PASSED', 'NOT_RUN', 'FAILED'], defaultValue: 'PASSED', maximumLength: 32 }], targetStatuses: ['DRAFT'], featureState: 'ACTIVE', order: 20 },
                        { id: 'promotion-approve', label: 'Approve promotion', intent: 'APPROVE', permission: 'commerce.promotion.approve', ownerModule: 'promotion', handlerAction: 'approvePromotion', operationRoute: '/promotions/:promotionCode/approve', httpMethod: 'POST', inputFields: [promotionCodeInput, { name: 'checklist', label: 'Approval checklist JSON', type: 'JSON', required: false, defaultValue: '["eligibility reviewed","budget reviewed","coupon policy reviewed"]', maximumLength: 1000 }], targetStatuses: ['SUBMITTED'], featureState: 'ACTIVE', order: 30 },
                        { id: 'promotion-schedule', label: 'Schedule promotion', intent: 'ACTIVATE', permission: 'commerce.promotion.manage', ownerModule: 'promotion', handlerAction: 'schedulePromotion', operationRoute: '/promotions/:promotionCode/schedule', httpMethod: 'POST', inputFields: [promotionCodeInput, { name: 'validFrom', label: 'Valid from', type: 'TEXT', required: true, valueFromRecord: 'validFrom', maximumLength: 40 }, { name: 'validTo', label: 'Valid to', type: 'TEXT', required: true, valueFromRecord: 'validTo', maximumLength: 40 }], targetStatuses: ['APPROVED'], featureState: 'ACTIVE', order: 40 },
                        { id: 'promotion-suspend', label: 'Suspend promotion', intent: 'CANCEL', permission: 'commerce.promotion.manage', ownerModule: 'promotion', handlerAction: 'suspendPromotion', operationRoute: '/promotions/:promotionCode/suspend', httpMethod: 'POST', inputFields: [promotionCodeInput, { name: 'reasonCode', label: 'Reason', type: 'MULTILINE', required: false, maximumLength: 512 }], targetStatuses: ['SCHEDULED', 'ACTIVE'], featureState: 'ACTIVE', order: 50 },
                        { id: 'promotion-archive', label: 'Archive promotion', intent: 'OTHER', permission: 'commerce.promotion.manage', ownerModule: 'promotion', handlerAction: 'archivePromotion', operationRoute: '/promotions/:promotionCode/archive', httpMethod: 'POST', inputFields: [promotionCodeInput, { name: 'reasonCode', label: 'Reason', type: 'MULTILINE', required: false, maximumLength: 512 }], targetStatuses: ['DRAFT', 'SUSPENDED'], featureState: 'ACTIVE', order: 60 },
                        { id: 'promotion-create-coupon-batch', label: 'Create coupon batch', intent: 'CREATE', permission: 'commerce.promotion.manage', ownerModule: 'promotion', handlerAction: 'createCouponBatch', operationRoute: '/promotions/:promotionCode/coupon-batches', httpMethod: 'POST', inputFields: [promotionCodeInput, batchCodeInput, { name: 'couponCodes', label: 'Coupon codes JSON', type: 'JSON', required: true, defaultValue: '["PROMO10A","PROMO10B"]', maximumLength: 4000 }, { name: 'maxUses', label: 'Max uses', type: 'TEXT', required: false, defaultValue: '1', maximumLength: 12 }], featureState: 'ACTIVE', order: 70 },
                        { id: 'promotion-reserve-coupon-batch', label: 'Reserve coupon batch', intent: 'EXECUTE', permission: 'commerce.promotion.manage', ownerModule: 'promotion', handlerAction: 'reserveCouponBatch', operationRoute: '/promotions/coupon-batches/:batchCode/reserve', httpMethod: 'POST', inputFields: [batchCodeInput, { name: 'reservedFor', label: 'Reserved for', type: 'TEXT', required: false, maximumLength: 128 }], featureState: 'ACTIVE', order: 80 },
                        { id: 'promotion-release-coupon-batch', label: 'Release coupon batch', intent: 'EXECUTE', permission: 'commerce.promotion.manage', ownerModule: 'promotion', handlerAction: 'releaseCouponBatch', operationRoute: '/promotions/coupon-batches/:batchCode/release', httpMethod: 'POST', inputFields: [batchCodeInput], featureState: 'ACTIVE', order: 90 },
                        { id: 'promotion-budget-ledger', label: 'Budget ledger', intent: 'VALIDATE', permission: 'commerce.promotion.read', ownerModule: 'promotion', handlerAction: 'budgetLedger', operationRoute: '/promotions/:promotionCode/budget-ledger', httpMethod: 'GET', inputFields: [promotionCodeInput], featureState: 'ACTIVE', order: 100 },
                        { id: 'promotion-analytics', label: 'Analytics', intent: 'VALIDATE', permission: 'commerce.promotion.read', ownerModule: 'promotion', handlerAction: 'analytics', operationRoute: '/promotions/:promotionCode/analytics', httpMethod: 'GET', inputFields: [promotionCodeInput], featureState: 'ACTIVE', order: 110 }
                    ]
                }),
                d.workbench({
                    id: 'discount-rules',
