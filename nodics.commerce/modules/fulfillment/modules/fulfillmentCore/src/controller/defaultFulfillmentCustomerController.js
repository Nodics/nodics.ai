...
'use strict';
/** @module fulfillmentCore/src/controller/defaultFulfillmentCustomerController @description Maps customer-safe Fulfillment policy requests. @layer controller @owner fulfillmentCore */
module.exports = {
    ...
    invoke: function (operation, request, callback) {
        const promise = Promise.resolve(SERVICE.DefaultFulfillmentOperationService[operation](request)).then(data => ({ data }));
