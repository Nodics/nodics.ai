...
'use strict';
/** @module fulfillmentCore/src/service/defaultFulfillmentCustomerApiService @description Publishes customer-safe Fulfillment delivery and return method policy from layered configuration. @layer service @owner fulfillmentCore */
module.exports = {
