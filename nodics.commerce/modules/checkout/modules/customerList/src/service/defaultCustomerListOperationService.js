...
/** @module customerList/src/service/defaultCustomerListOperationService @description Owns customer-list wishlist and compare-list operations across caller contexts. @layer service @owner customerList */
module.exports = {
