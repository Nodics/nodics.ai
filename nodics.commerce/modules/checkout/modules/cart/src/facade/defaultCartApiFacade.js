...
module.exports = {
    ...
    create: function (request) { return Promise.resolve().then(() => SERVICE.DefaultCartApiService.create(this.applyContext(request))); },
    /** Reads a cart. @param {Object} request Nodics request. @returns {Promise<Object>} Cart response. */
    read: function (request) { return Promise.resolve().then(() => SERVICE.DefaultCartApiService.read(this.applyContext(request))); },
    /** Adds a cart entry. @param {Object} request Nodics request. @returns {Promise<Object>} Cart response. */
    addEntry: function (request) { return Promise.resolve().then(() => SERVICE.DefaultCartApiService.addEntry(this.applyContext(request))); },
    /** Updates a cart entry. @param {Object} request Nodics request. @returns {Promise<Object>} Cart response. */
    updateEntry: function (request) { return Promise.resolve().then(() => SERVICE.DefaultCartApiService.updateEntry(this.applyContext(request))); },
    /** Removes a cart entry. @param {Object} request Nodics request. @returns {Promise<Object>} Cart response. */
    removeEntry: function (request) { return Promise.resolve().then(() => SERVICE.DefaultCartApiService.removeEntry(this.applyContext(request))); },
    /** Calculates a cart. @param {Object} request Nodics request. @returns {Promise<Object>} Cart response. */
    calculate: function (request) { return Promise.resolve().then(() => SERVICE.DefaultCartApiService.calculate(this.applyContext(request))); }
};
