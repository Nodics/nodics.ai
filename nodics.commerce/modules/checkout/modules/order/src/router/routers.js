...
module.exports = { order: {
    customer: {
        read: { secured: true, authTokenTypes: ['access'], accessGroups: ['customerUserGroup'], permission: 'commerce.order.own.read', apiExposure: 'commerceCustomer', key: '/customer/orders/:orderCode', method: 'GET', controller: 'DefaultOrderCustomerController', operation: 'read' },
        listOwnOrders: { secured: true, authTokenTypes: ['access'], accessGroups: ['customerUserGroup'], permission: 'commerce.order.own.read', apiExposure: 'commerceCustomer', key: '/customer/orders', method: 'GET', controller: 'DefaultOrderCustomerController', operation: 'listOwn' },
