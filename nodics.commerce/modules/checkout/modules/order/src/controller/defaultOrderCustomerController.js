...
'use strict';
/** @module order/src/controller/defaultOrderCustomerController @description Maps customer Order read inputs to Order-owned facade operations. @layer controller @owner order */
module.exports = {
    ...
    invoke: function (operation, request, callback) {
        const promise = FACADE.DefaultOrderCustomerFacade[operation](this.applyHttp(request)).then(data => ({ data }));
