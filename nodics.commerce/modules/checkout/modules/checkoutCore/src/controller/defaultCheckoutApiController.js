...
'use strict';
/** @module checkoutCore/src/controller/defaultCheckoutApiController @description Maps bounded placement input to Checkout facade. @layer controller @owner checkoutCore */
module.exports = { place: function (request, callback) {
    ...
    const promise = FACADE.DefaultCheckoutApiFacade.place(request).then(data => ({ data }));
