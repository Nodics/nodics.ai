...
| Checkout customer | Login and provide customer details | Customer lookup and support | Profile, Checkout | Authenticated live placement required | Customer self-registration/public signup decision |
