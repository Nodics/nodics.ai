...
const identityService = require(path.join(repositoryRoot,
    'nodics.foundation/modules/nAuth/src/service/identity/defaultIdentityGovernanceService'));
...
const schemaAccessHandler = require(path.join(repositoryRoot,
    'nodics.foundation/modules/nDatabase/database/src/service/schema/defaultSchemaAccessHandlerService'));
