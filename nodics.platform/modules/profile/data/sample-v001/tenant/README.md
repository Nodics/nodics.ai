...
It is intentionally kept under `nodics.platform/modules/profile/data/sample-v001` instead of
`nodics.platform/modules/profile/data/init-v001` because tenant bootstrap data is security-sensitive.
...
```text
nodics.platform/modules/profile/data/sample-v001/tenant/
  headers/
