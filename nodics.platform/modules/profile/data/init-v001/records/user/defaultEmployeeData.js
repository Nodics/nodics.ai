...
/**
 * @module nodics.platform/modules/profile/data/init-v001/records/user/defaultEmployeeData
...
module.exports = {
  ...
  record4: {
    ...
    principalType: "human",
    userGroups: ["documentationAuthorUserGroup"],
    addresses: ["defaultEmployeeAddress"],
    contacts: ["defaultEmployeeContact"],
  },
  record5: {
    ...
    principalType: "human",
    userGroups: ["axisViewerUserGroup"],
    addresses: ["defaultEmployeeAddress"],
    contacts: ["defaultEmployeeContact"],
  },
};
