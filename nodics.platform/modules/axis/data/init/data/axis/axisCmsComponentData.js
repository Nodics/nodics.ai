...
/**
 * @module axis/data/init/data/axis/axisCmsComponentData
...
module.exports = withAxisOwnership({
    ...
    record26: {
        code: 'axisPlatformDashboardSummaryComponent', typeCode: 'axisPlatformSummaryComponentType',
        accessMode: 'AUTHENTICATED',
        properties: {
    ...
    record27: {
        code: 'axisPlatformInitializeComponent', typeCode: 'axisPlatformInitializeComponentType',
        accessMode: 'AUTHENTICATED',
        properties: {
    ...
    record28: {
        code: 'axisRuntimeModulesRegistryComponent', typeCode: 'axisRuntimeModulesRegistryComponentType',
        accessMode: 'AUTHENTICATED',
        properties: {
