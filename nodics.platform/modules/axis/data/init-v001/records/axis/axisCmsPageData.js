...
/**
 * @module axis/data/init-v001/records/axis/axisCmsPageData
...
module.exports = withAxisOwnership({
    ...
    record7: {
        code: 'axisPlatformDashboardPage', name: 'Platform Dashboard', cmsSite: ['axisCmsSite'],
        typeCode: 'axisPlatformPageType', template: 'axisPlatformPageTemplate', renderer: 'axis.page.platform',
        cmsComponents: [
            { target: 'axisPlatformDashboardSummaryComponent', slot: 'content', index: 10, active: true }
        ],
        active: true
    },
    record8: {
        code: 'axisPlatformInitializePage', name: 'Platform Initialize', cmsSite: ['axisCmsSite'],
        typeCode: 'axisPlatformPageType', template: 'axisPlatformPageTemplate', renderer: 'axis.page.platform',
        cmsComponents: [
            { target: 'axisPlatformInitializeComponent', slot: 'content', index: 10, active: true }
        ],
        active: true
    },
    record9: {
        code: 'axisRuntimeModulesRegistryPage', name: 'Runtime Modules Registry', cmsSite: ['axisCmsSite'],
        typeCode: 'axisPlatformPageType', template: 'axisPlatformPageTemplate', renderer: 'axis.page.platform',
        cmsComponents: [
            { target: 'axisRuntimeModulesRegistryComponent', slot: 'content', index: 10, active: true }
        ],
        active: true
    }
});
