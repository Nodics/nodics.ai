...
/**
 * @module axis/data/init-v001/records/axis/axisCmsSlotData
...
module.exports = withAxisOwnership({
    ...
    record17: { code: 'axisPlatformContentSlot', template: 'axisPlatformPageTemplate', name: 'content',
        minItems: 1, maxItems: 1, allowedComponentTypes: ['axisPlatformSummaryComponentType',
            'axisPlatformInitializeComponentType', 'axisRuntimeModulesRegistryComponentType'], active: true }
});
