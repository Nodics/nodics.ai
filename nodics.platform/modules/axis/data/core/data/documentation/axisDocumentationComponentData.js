  ...
  "record6": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "Author or extend project documentation in that project's canonical structured source, for example `nodics.kickoff/data/core/source/documentation`, and generate its committed `data/core` content pack with `data/manifest.json` with `manifestSection: documentation`. Register the pack through the Nodics-owned documentation contribution contract; Axis discovers and renders the resulting navigation and article blocks."
        },
        {
          "kind": "paragraph",
