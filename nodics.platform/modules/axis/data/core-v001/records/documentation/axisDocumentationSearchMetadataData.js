...
/** @description Generated Nodics Axis documentation search metadata. */
module.exports = {
  "record0": {
    "code": "axisDocsSearchproductaxisdocumentationproduct",
    "product": "axisDocumentationProduct",
    "targetType": "PRODUCT",
    "targetCode": "axisDocumentationProduct",
    "title": "Nodics Axis Documentation",
    "summary": "Business and developer documentation for the Axis BackOffice application, managed through the shared documentation content catalog.",
    "searchText": "Nodics Axis Documentation Business and developer documentation for the Axis BackOffice application, managed through the shared documentation content catalog.",
    "keywords": [
      "axis",
      "documentation",
      "backoffice"
  ...
  "record1": {
    "code": "axisDocsSearchnavigationaxisdocumentationnavigationmetadata",
    "product": "axisDocumentationProduct",
    "targetType": "NAVIGATION",
    "targetCode": "axisDocumentationNavigationMetadata",
    "title": "Nodics Axis Documentation Navigation",
    "summary": "Search setup, architecture, features, security, and troubleshooting",
    "searchText": "Nodics Axis Documentation Navigation Search Nodics Axis documentation Search setup, architecture, features, security, and troubleshooting",
    "keywords": [
      "navigation",
      "hierarchy",
      "expandable",
  ...
  "record2": {
    "code": "axisDocsSearchnodeaxisdocsnoderoot",
    "product": "axisDocumentationProduct",
    "targetType": "NODE",
    "targetCode": "axisDocsNodeRoot",
    "title": "Nodics Axis Documentation",
    "summary": "Root Axis documentation node for application overview, management, rendering, setup, operations, and extension topics.",
    "searchText": "Nodics Axis Documentation Root Axis documentation node for application overview, management, rendering, setup, operations, and extension topics. axis documentation backoffice",
    "keywords": [
      "axis",
      "documentation",
      "backoffice"
  ...
  "record3": {
    "code": "axisDocsSearchnodeaxisdocsnodesecdiscoveraxis",
    "product": "axisDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Discover Axis Business and architecture introduction to Nodics Axis, its purpose, boundaries, documentation ownership, and repository responsibilities. discover-axis Discover Axis",
    "keywords": [
      "discover-axis",
      "Discover Axis"
    ],
  ...
  "record4": {
    "code": "axisDocsSearchnodeaxisdocsnodesecbuildandoperateaxis",
    "product": "axisDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Build and Operate Axis Technology, shell, renderer, documentation, CMS delivery, and operational rules for building and running Axis safely. build-and-operate-axis Build and Operate Axis",
    "keywords": [
  ...
  "record5": {
    "code": "axisDocsSearchnodeaxisdocsnodesecaxiscapabilities",
    "product": "axisDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Axis Capabilities Axis user-facing workspaces, dashboards, actions, recovery behavior, and backend-owned capability contracts. axis-capabilities Axis Capabilities",
    "keywords": [
      "axis-capabilities",
      "Axis Capabilities"
    ],
  ...
  "record6": {
    "code": "axisDocsSearchnodeaxisdocsnodeseccontributetoaxis",
    "product": "axisDocumentationProduct",
    "targetType": "NODE",
    ...
    "searchText": "Contribute to Axis Contribution, implementation, quality, documentation, and governance rules for adding or changing Axis behavior. contribute-to-axis Contribute to Axis",
    "keywords": [
      "contribute-to-axis",
      "Contribute to Axis"
    ],
  ...
  "record25": {
    ...
    "searchText": "Nodics Axis Documentation Documentation landing content for Axis setup, navigation, content operations, schema tools, publishing, security, and safe extension journeys.",
    "keywords": [
      "PRODUCT",
      "axisDocumentationProduct",
  ...
  "record26": {
    ...
    "searchText": "Nodics Axis Documentation Navigation Expandable and searchable Axis documentation navigation generated from backend-owned content-catalog metadata.",
    "keywords": [
      "NAVIGATION",
      "axisDocumentationNavigationMetadata",
      "Nodics Axis Documentation Navigation"
    ],
    "facets": {
  ...
  "record27": {
    ...
    "title": "Discover Axis",
    "summary": "Business and architecture introduction to Nodics Axis, its purpose, boundaries, documentation ownership, and repository responsibilities.",
    "searchText": "Discover Axis Business and architecture introduction to Nodics Axis, its purpose, boundaries, documentation ownership, and repository responsibilities.",
    "keywords": [
      "SECTION",
      "axisDocsNodeSecdiscoverAxis",
      "Discover Axis"
    ],
    "facets": {
      "ownerType": "SECTION",
  ...
  "record28": {
    ...
    "title": "Build and Operate Axis",
    "summary": "Technology, shell, renderer, documentation, CMS delivery, and operational rules for building and running Axis safely.",
    "searchText": "Build and Operate Axis Technology, shell, renderer, documentation, CMS delivery, and operational rules for building and running Axis safely.",
    "keywords": [
      "SECTION",
      "axisDocsNodeSecbuildAndOperateAxis",
      "Build and Operate Axis"
    ],
    "facets": {
      "ownerType": "SECTION",
  ...
  "record29": {
    ...
    "title": "Axis Capabilities",
    "summary": "Axis user-facing workspaces, dashboards, actions, recovery behavior, and backend-owned capability contracts.",
    "searchText": "Axis Capabilities Axis user-facing workspaces, dashboards, actions, recovery behavior, and backend-owned capability contracts.",
    "keywords": [
      "SECTION",
      "axisDocsNodeSecaxisCapabilities",
      "Axis Capabilities"
    ],
    "facets": {
      "ownerType": "SECTION",
  ...
  "record30": {
    ...
    "title": "Contribute to Axis",
    "summary": "Contribution, implementation, quality, documentation, and governance rules for adding or changing Axis behavior.",
    "searchText": "Contribute to Axis Contribution, implementation, quality, documentation, and governance rules for adding or changing Axis behavior.",
    "keywords": [
      "SECTION",
      "axisDocsNodeSeccontributeToAxis",
      "Contribute to Axis"
    ],
    "facets": {
      "ownerType": "SECTION",
