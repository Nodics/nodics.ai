...
module.exports = {
      ...
      "items": [
        {
          ...
          "groupTitle": "Axis Overview and Architecture",
          "groupOrder": 10,
          "order": 10,
          "parentId": "discover-axis.axis-overview-and-architecture",
          "hierarchyPath": [
            "Nodics Axis Documentation",
            "Discover Axis",
        ...
        },
        {
          ...
          "groupTitle": "Axis Build and Runtime",
          "groupOrder": 30,
          "order": 30,
          "parentId": "build-and-operate-axis.axis-build-and-runtime",
          "hierarchyPath": [
            "Nodics Axis Documentation",
        ...
        },
        {
          ...
          "groupTitle": "Axis Workspaces and Operations",
          "groupOrder": 70,
          "order": 70,
          "parentId": "axis-capabilities.axis-workspaces-and-operations",
          "hierarchyPath": [
            "Nodics Axis Documentation",
            "Axis Capabilities",
        ...
        },
        {
          ...
          "groupTitle": "Axis Contribution and Governance",
          "groupOrder": 120,
          "order": 120,
          "parentId": "contribute-to-axis.axis-contribution-and-governance",
          "hierarchyPath": [
            "Nodics Axis Documentation",
            "Contribute to Axis",
  ...
  "record1": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/project-overview.md",
        "README.md"
      ],
      "visualRequirements": [
        "architecture-diagram",
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "Canonical user and contributor documentation is authored in the backend-owned Platform `axis` module under `docs` and deterministically generated into this module's committed CMS import release under `data/core-v001`. The Axis frontend repository owns only executable browser renderers and static recovery behavior; it must not own backend-importable CMS data."
        },
        {
          "kind": "paragraph",
      ...
      "source": {
        ...
        "module": "axis",
        "owner": "nodics.platform/modules/axis",
  ...
  "record2": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/architecture-and-ownership.md",
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "For beginners, every Axis screen should be read in two layers: the visible workspace helps an employee act, while the backend module named by the workspace remains the source of truth. A business user can trust that the same permission, workflow, publication, and validation rules apply whether a record is opened from a dashboard, a generated workbench, a CMS-composed page, or a deep link. Developers should therefore find the owning backend capability before changing a route, renderer, action, or client."
        },
        {
          "kind": "heading",
          "level": 2,
        ...
        },
        {
          ...
          "items": [
            ...
            "store service credentials, cronjob credentials, database credentials, or module secrets;",
        ...
        {
          "kind": "paragraph",
          "text": "Axis solves this by discovering what the project has enabled. If the project has Profile, WCMS, Media, and Process, Axis shows the authorized pages for those capabilities. If Commerce is not registered, Commerce pages are not shown. If a user does not have a permission, the menu and direct route must not become a back door. The backend still rejects the request."
        },
        {
          "kind": "paragraph",
  ...
  "record3": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/frontend-technology-stack.md",
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "For beginners, the stack can be read as a layered browser workspace: React renders the employee experience, TypeScript protects the contracts, Vite builds the deployable assets, TanStack Query coordinates backend-owned server state, and MUI plus Nodics tokens keep controls accessible and consistent. Business users experience this as one predictable Axis application; developers and operators use the same layers to decide where a problem belongs when a screen, contract, build, or runtime connection behaves unexpectedly."
        },
        {
          "kind": "table",
          "headers": [
  ...
  "record4": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/design-system-and-shell.md",
        "docs/design-system-and-shell.md"
      ],
      "visualRequirements": [
        "table"
      ],
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              ...
              "Let employees enter or recover access safely",
              "Render CMS-composed forms, responsive layout, and safe errors",
              "Profile owns credentials, browser session, recovery contract, and revocation"
            ],
            [
              "Navigation rail",
              "Help employees find authorized capabilities",
              "Render backend-published groups, hierarchy, search, favourites, and recents",
              "BackOffice owns permission-filtered navigation and module availability"
            ],
            [
              "Workspace header",
              "Keep current context visible without wasting workspace space",
              "Render title, help actions, context popup, mode controls, and status",
              "Owning modules provide business labels, help targets, and runtime context"
            ],
            [
              "CMS renderer surface",
              "Let backend content compose governed Axis pages",
              "Validate logical renderer keys and execute only compiled Axis renderers",
              "WCMS owns page, template, component, route, locale, channel, and access data"
            ],
            [
              "Operational panels",
              "Present tables, details, actions, failures, and confirmations",
              "Keep interaction accessible, responsive, localized, and bounded",
              "Owning modules enforce validation, authorization, lifecycle, and persistence"
            ]
          ]
        },
        {
          "kind": "paragraph",
          "text": "For beginners, the design system is more than colors and spacing. It is the contract that makes every Axis screen feel like the same governed workplace: buttons behave consistently, forms recover predictably, navigation stays permission-aware, and long business labels or translated content do not break the page."
        },
        {
          "kind": "paragraph",
          "text": "Developers use the design system as the implementation contract for shell layout, renderer composition, token usage, focus handling, density, and responsive behavior. A new page should compose these existing primitives before adding another local visual rule."
        },
        {
          "kind": "paragraph",
          "text": "An operator benefits from the same consistency during support: the shell keeps environment context, loading states, unavailable states, and recovery actions recognizable across every capability."
        },
        {
          "kind": "heading",
          "level": 2,
        ...
        {
          "kind": "paragraph",
          "text": "After authentication, Axis consumes the authorized BackOffice `catalogue`, `availability`, and client-safe module leases. It does not define a second functional menu authority. The System Workspace entry, its Dashboard child, and module-owned navigation entries are published by backend bootstrap metadata. Axis renders those entries in the shell and uses an explicitly supplied backend business group first, retaining the legacy category mapping only as a safe fallback for older compatible contributions:"
        },
        {
          "kind": "unordered-list",
          "items": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Keep recovery routes such as login, lock-screen, and direct `/dashboard` restoration safe. Every displayed functional destination, including Dashboard, must come from authenticated bootstrap.",
  ...
  "record5": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/cms-delivery-and-renderers.md",
        "docs/cms-delivery-and-renderers.md"
      ],
      "visualRequirements": [
        "comparison-table",
        "command-example"
        ...
        },
        {
          ...
          "rows": [
            [
              ...
              "Site, route, page, template, component tree, labels, and safe content",
              "Responsive rendering, focus behavior, empty states, and visual consistency",
              "Publication workflow, approval, access mode, locale, channel, and lifecycle"
            ],
            [
              "Developer extension",
              "Logical renderer keys and typed component properties",
              "Compiled React renderer, registry mapping, parser, tests, and fallbacks",
              "API destinations, schema contracts, validation rules, and permissions"
            ],
            [
              "Operator safety",
              "Published content version and route availability",
              "Bounded loading, cache isolation, retry, and safe failure presentation",
              "Staged-to-Online activation, rollback, authentication, and audit evidence"
            ],
            [
              "Beginner understanding",
              "Navigation and article content that explain the journey",
              "A predictable browser surface that does not execute CMS code",
              "Business decisions, data writes, and process state transitions"
            ]
          ]
        },
        {
  ...
  "record6": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/documentation-content.md",
        "docs/documentation-content.md"
      ],
      "visualRequirements": [
        "table",
        "command-example"
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              "Framework documentation",
              "Business users, developers, operators, and partners",
              "Searchable CMS article navigation and page body",
              "`nodics.docs` content pack installed through nImport and published through WCMS"
            ],
            [
              "API reference",
              "Developers and integration teams",
              "Searchable OpenAPI text catalogue with module grouping",
              "System-generated OpenAPI contracts exposed by the active backend"
            ],
            [
              "Axis documentation",
              "Axis contributors, operators, and implementation teams",
              "Platform-owned CMS article pack for Axis behavior and contribution rules",
              "Platform Axis module authored docs and generated content-pack data"
            ],
            [
              "Customer project documentation",
              "Customer teams and project partners",
              "Project documentation product returned by BackOffice bootstrap",
              "Customer project repository and its own documentation content pack"
            ]
          ]
        },
        {
          ...
          "items": [
            "**Framework** renders the canonical `nodics.docs` content pack through CMS.",
            "**Swaggers** renders the active System-owned OpenAPI contract in an Axis-owned, searchable reference and links to the backend's standalone interactive Swagger UI. API descriptions are not copied into a content catalog. Swagger/OpenAPI availability follows runtime contract discovery, not CMS documentation publication readiness.",
        ...
        {
          "kind": "paragraph",
          "text": "The documentation publication center is the operational home for the whole documentation lifecycle. It should show each publishable documentation source as a compact row with Staged state, Online state, next action, refresh, and expandable evidence. When approval is pending and the authenticated employee has permission, Axis may render approve and reject actions inline instead of sending the user to a separate Process page. The backend still owns workflow, permission, publication, and audit decisions. After approval, rejection, update, or publication, Axis must refresh the documentation source model and left navigation without requiring a manual browser refresh."
        },
        {
          "kind": "paragraph",
        ...
        {
          "kind": "paragraph",
          "text": "Canonical authored pages live under `docs` in the Platform `axis` module. The committed records under `data/core-v001` are deterministic generated projections, not an independent documentation authority. Run `npm run docs:generate` after changing implemented Axis documentation content, then run `npm run docs:check` and `npm run validate`. The migration register must preserve the disposition, destination, headings, and detail evidence for every README or legacy docs source before those transitional files are reduced or retired."
        },
        {
          "kind": "paragraph",
          "text": "The content-pack generator is scoped with the content source at `scripts/generate-documentation-content.mjs`. It remains tooling, not configuration: `config` is reserved for declarative runtime values and must not contain executable generators."
        },
        {
          "kind": "paragraph",
          "text": "`docs/catalogue.json` is the only authored Axis documentation release-version authority. Generation copies that version into CMS records, the migration register, and the immutable release manifest. Contributors must increment it before generating changed content and must not repair generated version projections by hand."
        },
        {
          "kind": "paragraph",
        ...
        {
          "kind": "paragraph",
          "text": "Author or extend project documentation in that project's canonical structured source, for example `nodics.kickoff/docs`, and generate its committed `data/core-v001` content pack with `data/manifest.json` with `manifestSection: documentation`. Register the pack through the Nodics-owned documentation contribution contract; Axis discovers and renders the resulting navigation and article blocks."
        },
        {
          "kind": "paragraph",
  ...
  "record7": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/employee-login.md",
        "docs/employee-login.md"
      ],
      "visualRequirements": [
        "troubleshooting-matrix",
        "command-example"
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              "Public bootstrap",
              "Find the correct employee login experience for the deployed project",
              "Read public config and request safe discovery data",
              "BackOffice publishes public Profile and CMS connection metadata"
            ],
            [
              "Login",
              "Verify an employee can enter the Back Office",
              "Render CMS-composed form and send credentials directly to Profile",
              "Profile authenticates, issues tokens, sets browser-session cookies, and owns CSRF"
            ],
            [
              "Secured bootstrap",
              "Show only authorized capabilities",
              "Hold access token in memory and request authorized navigation",
              "BackOffice filters modules, permissions, availability, and Axis policy"
            ],
            [
              "Screen lock",
              "Hide protected workspace during idle periods",
              "Store only a bounded lock marker and ask for password again",
              "Profile re-verifies the employee and rotates session state"
            ],
            [
              "Logout",
              "End the browser session honestly",
              "Clear memory only after backend revocation succeeds",
              "Profile revokes refresh state and expires session cookies"
            ]
          ]
        },
        {
          "kind": "paragraph",
          "text": "For beginners, the safest mental model is that Axis never owns a password and never becomes the identity system. It collects employee input, sends it to Profile, and then uses BackOffice to discover only the capabilities that the authenticated employee may see."
        },
        {
          "kind": "paragraph",
          "text": "Developers should keep login, recovery, lock, restore, and logout changes on the correct side of the boundary: Axis renders and validates browser-safe interaction, while Profile and BackOffice own authentication, session restoration, authorization, policy, and revocation."
        },
        {
          "kind": "paragraph",
          "text": "An operator should use the visible login, restore, lock, and logout states to separate browser configuration issues from Profile authentication, BackOffice authorization, CMS delivery, or session-revocation failures."
        },
        {
          "kind": "heading",
          "level": 2,
        ...
        },
        {
          ...
          "items": [
            ...
            "Axis constructs its shell from the authenticated BackOffice bootstrap navigation, including the backend-owned Dashboard entry and authorized module-owned navigation.",
  ...
  "record8": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/assistant-frontend.md",
        "docs/assistant-frontend.md"
      ],
      "visualRequirements": [
        "troubleshooting-matrix",
        "command-example"
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              "Conversation access",
              "Employees see only conversations they are allowed to use",
              "Render history, selection, messages, and composer state",
              "Assistant backend owns ownership, permissions, persistence, and audit"
            ],
            [
              "Provider neutrality",
              "Business policy can choose a provider without browser changes",
              "Call only the Nodics Assistant endpoint advertised by BackOffice",
              "Backend owns provider selection, credentials, tools, token limits, and governance"
            ],
            [
              "Streaming answer",
              "User sees progress without losing control",
              "Parse bounded SSE events, render text smoothly, and support cancellation",
              "Backend emits ordered events and terminal state"
            ],
            [
              "Runtime mutation",
              "High-impact changes need governed confirmation",
              "Present confirmation, approval, rejection, execution, or handoff UI",
              "Backend owns validation, approval rules, tool execution, Workflow handoff, and rollback evidence"
            ]
          ]
        },
        {
          "kind": "paragraph",
          "text": "For beginners, the Assistant page is a governed employee workspace, not a direct chat widget wired to an external AI provider. Axis presents messages, progress, history, and confirmation choices; the backend decides what the Assistant is allowed to know, do, store, approve, reject, or hand off."
        },
        {
          "kind": "paragraph",
          "text": "Developers extend the Assistant experience by adding typed Axis renderers, clients, parsers, and presentation tests for backend-published contracts. They must not place provider credentials, prompt policy, tool execution, mutation approval, or audit decisions in the browser."
        },
        {
          "kind": "heading",
          "level": 2,
  ...
  "record9": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/schema-workbench.md",
        "docs/schema-workbench.md"
      ],
      "visualRequirements": [
        "troubleshooting-matrix",
        "command-example"
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              "Schema discovery",
              "Let an employee find editable business data safely",
              "Lists authorized data types with search, favourites, recents, and route-scoped views",
              "Owning modules publish schema descriptors, permissions, labels, relationships, and limits"
            ],
            [
              "Record browsing",
              "Support operational review without exporting data first",
              "Renders generated tables, filters, sorting, paging, and details",
              "Generated CRUD services execute queries and enforce tenant/security rules"
            ],
            [
              "Record mutation",
              "Let authorized users create, update, delete, or run lifecycle actions",
              "Presents typed forms, impact previews, confirmations, and safe errors",
              "Owning modules validate, persist, execute business logic, and audit"
            ],
            [
              "Extension and reuse",
              "Avoid one-off workbench widgets for each domain",
              "Reuses generic query builders, relationship selectors, and record renderers",
              "Backend contracts define fields, operators, actions, relationships, and constraints"
            ]
          ]
        },
        {
          "kind": "paragraph",
          "text": "For beginners, Schema Workbench is the generic business-data workbench. It lets an authorized employee browse or maintain records published by backend schemas, but the browser does not invent fields, relationships, permissions, or validation. Developers extend the owning schema and service contracts first, then let Axis render those published capabilities."
        },
        {
          "kind": "paragraph",
          "text": "An operator uses Schema Workbench to inspect whether the authorized data surface is usable for the current enterprise, tenant, module, and route context. They should look for unavailable descriptors, rejected actions, validation errors, conflicts, and backend correlation identifiers before treating a UI symptom as a frontend fault."
        },
        {
          "kind": "heading",
          "level": 2,
  ...
  "record11": {
    ...
    "properties": {
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "Developers use Module Health to connect a visible Axis problem back to the backend capability that owns it. If a CMS page will not load, a developer can check whether the CMS capability is authorized, reachable, stale, degraded, or unavailable before changing a renderer. If an import screen looks empty, the same view can show whether Import, Media, System, or the owning schema module is registered and observable."
        },
        {
          "kind": "heading",
          "level": 2,
        ...
        {
          "kind": "paragraph",
          "text": "Suppose Process automation was added to a customer project. processServer starts and reports itself, but the business administrator has not registered the Process functional module yet."
        },
        {
          "kind": "paragraph",
        ...
        },
        {
          ...
          "items": [
            "Module Registry can show Process as available to register.",
            "Module Health can show the runtime observation as live evidence.",
            "Process and cronjob operation pages remain hidden or unavailable until the module is registered, active, and authorized.",
            "Axis does not silently activate Process because a runtime was observed."
          ]
        },
        {
          "kind": "paragraph",
          "text": "Now suppose Process is registered and active, but processServer is stopped."
        },
        {
          "kind": "paragraph",
          "text": "Expected behavior:"
        },
        {
          "kind": "unordered-list",
          "items": [
            "Module Registry still shows Process as registered because registration is persisted project state.",
            "Module Health shows Process as stale, unavailable, or unknown based on backend evidence.",
            "Axis does not remove Process from the registry only because the server is down.",
            "A restart can restore runtime evidence without requiring registration again."
          ]
        },
  ...
  "record12": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/imports-and-exports.md",
        "docs/imports-and-exports.md"
      ],
      "visualRequirements": [
        "troubleshooting-matrix"
      ],
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              "Guided setup",
              "Help administrators initialize required data in the correct order",
              "Display profiles, release state, validation results, and authorized actions",
              "nImport owns release manifests, immutable versions, sequencing, and execution"
            ],
            [
              "File import",
              "Let employees bring governed external files into a target schema",
              "Upload through nMedia, select target model, show validation and run result",
              "nMedia stores files; nImport parses, validates, runs handlers, and writes data"
            ],
            [
              "Export",
              "Generate governed files from authorized schema data",
              "Collect model, filter, purpose, and review choices",
              "Owning modules query data; export services generate artifacts and audit purpose"
            ],
            [
              "History and troubleshooting",
              "Explain what happened after a data operation",
              "Render safe summaries, counts, states, and correlation identifiers",
              "Backend stores execution state, diagnostics, idempotency, rollback, and cleanup evidence"
            ]
          ]
        },
        {
          "kind": "paragraph",
          "text": "For beginners, imports and exports are governed data operations, not file copying. Axis helps a business user choose the destination, review the file or filter, validate the plan, and see the result. The backend owns parsing, schema validation, execution order, generated files, audit, and cleanup."
        },
        {
          "kind": "paragraph",
          "text": "Developers should extend import, export, parser, template, provider, or schema behavior in the owning backend module and expose it through secured contracts. Axis can improve selection, preview, progress, and result presentation, but it must not parse business files or invent another execution authority."
        },
        {
          "kind": "paragraph",
        ...
        {
          "kind": "paragraph",
          "text": "The default **Guided setup** tab presents backend-owned initialization profiles. Each profile shows its semantic destination role, ordered data-type steps, release counts, current state, and the capability enabled after completion. **Validate plan** is side-effect-free. **Validate and initialize** asks nImport to revalidate immutable versions and execute each step in declared order. On retry, current releases are skipped and only pending, updated, or failed releases execute. Initialization, Core, and Sample remain available as advanced administrator workspaces."
        },
        {
          "kind": "paragraph",
          "text": "Axis discovers guided setup profiles from every import-capable runtime connection and merges the backend responses into one operator workspace. A profile belongs to the backend runtime that declares it in `data.dataReleases.initializationProfiles`; Axis must not create hidden data authority, infer release order from the UI, or silently combine unrelated runtimes."
        },
        {
          "kind": "paragraph",
          "text": "Add a guided profile whenever a new runtime capability has required first-time release data, a meaningful install sequence, or a repeatable setup journey that an operator should not assemble manually. The profile must include a friendly label, description, completion message, destination-compatible releases, ordered steps, and validation evidence. A cross-runtime \"full local project\" setup must be exposed as a backend orchestration contract rather than a UI-only shortcut."
        },
        {
          "kind": "paragraph",
  ...
  "record13": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/media-management.md",
        "docs/pages/media-management.md"
      ],
      "visualRequirements": [
        "troubleshooting-matrix"
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              "Media records",
              "What file exists and what is it for?",
              "Search, filter, table, detail, preview, usage link, and safe metadata",
              "nMedia owns media metadata, lifecycle, checksum, provider, and storage identity"
            ],
            [
              "Folders and formats",
              "Where should files go and which formats are allowed?",
              "Policy explanation, editable schema views when authorized, and impact warnings",
              "nMedia owns folder rules, extension policy, MIME policy, size limits, and retention"
            ],
            [
              "Media sets",
              "Which files belong together as one business asset?",
              "Set membership, variant explanation, and relationship presentation",
              "nMedia owns set models, references, format roles, and validation"
            ],
            [
              "Storage and delivery",
              "Who can open a file and how is it served?",
              "Visibility wording, public preview only when allowed, and failure states",
              "nMedia owns provider selection, delivery routes, access policy, and signed/public behavior"
            ]
          ]
        },
        {
  ...
  "record14": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/customer-engagement.md",
        "docs/pages/customer-engagement.md"
      ],
      "visualRequirements": [
        "troubleshooting-matrix"
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              "Contact",
              "Receive, classify, assign, and resolve customer enquiries",
              "Domain landing cards, queue view, detail, and state-aware actions",
              "Engagement owns submissions, correspondence, lifecycle, Process handoff, and audit"
            ],
            [
              "Testimonials",
              "Turn approved customer stories into governed publication candidates",
              "Candidate, consent, editorial, and publication workspaces",
              "Engagement owns consent, editorial versions, eligibility, withdrawal, and publication coordination"
            ],
            [
              "Reviews and ratings",
              "Moderate reviews fairly and preserve evidence",
              "Review queues, response surfaces, appeal evidence, and aggregate views",
              "Engagement owns authenticity, moderation, immutable publication, response lifecycle, and aggregate rebuilds"
            ],
            [
              "Feedback and complaints",
              "Capture issues, escalate, resolve, and learn from trends",
              "Classification, assignment, follow-up, and insight presentation",
              "Engagement owns policy, priority, sentiment evidence, complaint lifecycle, and recovery state"
            ],
            [
              "Governance and automation",
              "Keep sensitive actions reviewable and recoverable",
              "Recommendation and recovery workspaces with safe provider-neutral evidence",
              "Engagement, Process, Communication, and AI governance own execution, providers, approval, and rollback"
            ]
          ]
        },
        {
          "kind": "paragraph",
          "text": "Developers should treat every Engagement workspace as a projection of a backend-owned domain contract. Add lifecycle fields, policies, providers, permissions, projections, or automation in the owning backend capability, then extend Axis with typed clients and CMS renderers that consume those contracts."
        },
        {
          "kind": "paragraph",
  ...
  "record15": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/openapi-reference.md",
        "docs/pages/openapi-reference.md"
      ],
      "visualRequirements": [
        "diagram"
  ...
  "record16": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/feature-delivery-checklist.md",
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              "Business journey",
              "Can an employee complete the real task without learning backend internals?",
              "Journey notes, labels, empty/error states, and role visibility",
              "The screen works technically but business users get lost"
            ],
            [
              "Backend authority",
              "Which Nodics module owns validation, persistence, workflow, and audit?",
              "Contract link, source map, permission model, and rejected shortcut list",
              "Axis becomes a second backend or bypasses tenant/security rules"
            ],
            [
              "Frontend quality",
              "Does the interaction work across keyboard, screen reader, mobile, WebView, and long labels?",
              "Focused component tests, responsive screenshots, and accessibility checks",
              "A shipped feature fails in ordinary enterprise usage"
            ],
            [
              "Operations",
              "Can support teams diagnose unavailable, degraded, stale, or incompatible state?",
              "Runtime states, correlation identifiers, retry rules, and safe messages",
              "Operators see a dead end instead of recoverable evidence"
            ],
            [
              "Documentation",
              "Can a developer or AI tool find the owner, extension point, and verification path?",
              "Permanent docs, source map, examples, common mistakes, and test commands",
              "Later changes duplicate logic or damage the authority boundary"
            ]
          ]
        },
        {
          "kind": "paragraph",
          "text": "For beginners, this checklist is the repeatable delivery path for any Axis capability. Start with the business task, identify the backend owner, design the browser interaction, prove the security and accessibility behavior, then update documentation so the next developer can follow the same boundary."
        },
        {
          "kind": "heading",
          "level": 2,
  ...
  "record17": {
    ...
    "properties": {
      ...
      "sourceEvidence": [
        "docs/catalogue.json",
        "docs/pages/implementation-and-documentation-contract.md",
        "docs/implementation-and-documentation-contract.md"
      ],
      "visualRequirements": [
        "table",
        "command-example"
      ...
      "blocks": [
        ...
        {
          "kind": "paragraph",
          "text": "For beginners, this contract is the first safety rail before changing Axis. It explains how to decide whether a requirement belongs in the browser, backend, CMS content, generated data, or customer project layer. Business users should receive clear journeys and safe operations; developers should receive source ownership, extension points, and tests; operators should receive configuration, availability, recovery, and verification evidence."
        },
        {
          "kind": "heading",
          "level": 2,
        ...
        {
          "kind": "paragraph",
          "text": "Axis workspaces must be designed from the operator's next decision, not from the number of backend endpoints available. If a task naturally belongs to one business journey, keep the user in one clear workspace and expose the next safe action there. Do not force the user through a chain of unrelated pages only to complete one approval, import, registration, or publication decision."
        },
        {
          "kind": "table",
          "headers": [
          ...
          "rows": [
            [
              "One place to finish",
              "Keep related status, evidence, approve/reject, refresh, and detail expansion together when the backend contract allows it.",
              "The owning module decides allowed actions, validation, lifecycle transition, and audit."
            ],
            [
              "Permission-based actions",
              "Show approve, reject, publish, initialize, register, or activate only when the current user has the required permission. Do not block only because the same user requested the action unless the backend policy explicitly requires separation of duties.",
              "Profile, BackOffice, Process, and the target module enforce permissions on every request."
            ],
            [
              "Capability gating",
              "When an application needs another capability, show the missing capability and route the user to Module Registry instead of pretending import success means runtime readiness.",
              "BackOffice Module Registry and the owning modules decide registration, activation, and runtime availability."
            ],
            [
              "Refresh after mutation",
              "After any successful mutation, invalidate the affected query state and redraw navigation, counters, row status, and allowed actions without requiring manual browser refresh.",
              "Backend responses remain the source of truth for the refreshed model."
            ],
            [
              "Compact enterprise layout",
              "Use list rows, expandable detail, stable columns, aligned buttons, and design-system colors for operational dashboards. Avoid decorative cards, large repeated instruction blocks, and labels that compete with primary actions.",
              "CMS may supply labels and help text; Axis owns accessible, responsive presentation."
            ]
          ]
        },
        {
          "kind": "paragraph",
          "text": "The documentation publication center and Setup and Accelerators workspace are reference examples for this rule. Documentation packs can be requested, reviewed, approved, rejected, updated, and opened from the same operational surface when the backend advertises those actions. Application packs can be initialized only after their required functional capabilities are registered and active; otherwise the row must explain the missing capability and guide the user to Module Registry."
        },
        {
          "kind": "heading",
          "level": 2,
        ...
        {
          "kind": "paragraph",
          "text": "Axis documentation that becomes backend CMS records is authored as granular, reviewable pages in `nodics.platform/modules/axis` under `docs`. The deterministic documentation generator creates CMS page, component, navigation, route, search, and immutable manifest data under `data/core-v001` and the documentation section in `data/manifest.json` in the same module."
        },
        {
          "kind": "paragraph",
          "text": "The generator is executable repository tooling and lives beside the authored content at `scripts/generate-documentation-content.mjs`. It must not be placed under `config`, because configuration files remain declarative values only."
        },
        {
          "kind": "paragraph",
