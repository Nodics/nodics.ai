    ...
    backofficeCapabilities: {
        backoffice: {
            ...
            navigation: [
                ...
                { id: 'system-integrations', label: 'Dashboard', route: '/system-integrations', icon: 'operations',
                    order: 90, group: { id: 'system-integrations', label: 'System & Integrations', order: 150 },
                    perspectives: ['operations'], contexts: ['environment', 'tenant', 'enterprise'],
                    help: { summary: 'Review system capabilities, runtime registry status, integration workspaces, and governed operational entry points from one dashboard.', documentationRoute: '/docs/reference/backoffice', documentationFragment: 'system-integrations' },
                ...
                { id: 'registry', label: 'Module Registry', route: '/registry', icon: 'registry',
                    order: 100, group: { id: 'system-integrations', label: 'System & Integrations', order: 150 },
                ...
                { id: 'module-health', label: 'Module Health', route: '/operations/module-health', icon: 'health',
                    order: 110, group: { id: 'system-integrations', label: 'System & Integrations', order: 150 },
                    perspectives: ['operations'], contexts: ['environment', 'tenant'],
                ...
                { id: 'imports-exports', label: 'Imports and Exports', route: '/operations/imports-exports', icon: 'import',
                    order: 120, group: { id: 'system-integrations', label: 'System & Integrations', order: 150 },
                    perspectives: ['operations'], contexts: ['environment', 'tenant', 'enterprise'],
                ...
                { id: 'integrations', label: 'Integrations', route: '/operations/integrations', icon: 'module',
                    order: 130, group: { id: 'system-integrations', label: 'System & Integrations', order: 150 },
                    perspectives: ['operations'], contexts: ['environment', 'tenant'],
                    featureState: 'DISABLED' },
                { id: 'events', label: 'Events', route: '/operations/events', icon: 'module',
                    order: 140, group: { id: 'system-integrations', label: 'System & Integrations', order: 150 },
                    perspectives: ['operations'], contexts: ['environment', 'tenant'],
                    featureState: 'DISABLED' },
                { id: 'audit-trail', label: 'Audit Trail', route: '/operations/audit-trail', icon: 'module',
                    order: 150, group: { id: 'system-integrations', label: 'System & Integrations', order: 150 },
                    perspectives: ['operations'], contexts: ['environment', 'tenant'],
                    featureState: 'DISABLED' },
                { id: 'operational-failures', label: 'Operational Failures', route: '/operations/operational-failures', icon: 'module',
                    order: 160, group: { id: 'system-integrations', label: 'System & Integrations', order: 150 },
                    perspectives: ['operations'], contexts: ['environment', 'tenant'],
                    featureState: 'DISABLED' },
