...
const expected = {
    ...
    'order-lifecycle-operations': ['Manual Purchase Reviews', 'Lifecycle Workspace', 'Cancellations', 'Returns', 'Refund Requests', 'Exchanges and Replacements', 'Appeals and Exceptions', 'Lifecycle Recovery', 'Lifecycle History and Audit'],
