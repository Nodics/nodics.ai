...
const registration = {
  ...
  properties: {
    ...
    functionalModule: {
      type: "object",
      additionalProperties: false,
      required: ["identity", "displayName", "type", "protected"],
      properties: {
        identity: moduleName,
        displayName: { type: "string", minLength: 1, maxLength: 160 },
...
const functionalModuleLifecycleDecision = {
  type: "object",
  additionalProperties: false,
  required: ["project", "expectedRevision", "reason"],
  properties: {
    project: moduleName,
...
const readinessRepairRequest = {
  ...
  properties: {
    ...
    targetIdentifiers: { type: "object" },
    preview: { type: "object" },
    prerequisites: { type: "array", maxItems: 64, items: { type: "object" } },
    batch: { type: "boolean" },
    highImpact: { type: "boolean" },
    operatorNote: { type: "string", maxLength: 1000 },
    environmentPolicy: { type: "string", maxLength: 128 },
    context: { type: "object" },
  },
};
